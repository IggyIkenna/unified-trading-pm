...
the WRONG state. Per `manifest_migration_SUPERSEDED_2026_05_21.md` § C.1, they should be flipped to
...
## [slot-1-main → slot-4] 2026-05-22 — 🔴 GCS WRITE FREEZE — DO NOT WRITE TO ANY BUCKET
...
**Your dispatch items (sports shard granularity / QG step / enumerators / GAP-2.4.D design doc) are all pure code + doc
changes — no GCS I/O. Proceed with those only. If any item requires a live smoke test against GCS, mark it
`[BLOCKED-GCS-FREEZE]` and ping slot-1-main.**
