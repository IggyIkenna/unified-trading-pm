...
| DQ-02 | 2026-05-25 | DeFi `lst_rates` 0 captured / 90 failed + `lending_indices` 0 captured / 105 failed + `perp_funding` 0/58 in `defi-prd`. **Blocks `carry_staked_basis`.** Likely missing-API-key / SM-error. | OPEN — fixable (top priority) |
| DQ-03 | 2026-05-25 | CeFi `ASTER` venue 0% captured (2,196 failed). New perp DEXs low: PACIFICA-SOLANA 16.6%, LIGHTER-ZKSYNC 17.4%, EXTENDED-STARKNET 20%.                                                        | OPEN — adapter                |
| DQ-04 | 2026-05-25 | CeFi venue-attribution bug — Bitfinex instrument symbols (`BTCF0`/`ETHF0`/`AAVEF0`) logged as venues; blank `''` venue + `UNKNOWN`.                                                          | OPEN — parser                 |
| DQ-05 | 2026-05-25 | Daily honest-coverage cron stale since 2026-05-18 (paused during freeze/migration).                                                                                                          | OPEN — restart cron           |
