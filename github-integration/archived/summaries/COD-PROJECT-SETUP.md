...
python setup-cod-project.py --org IggyIkenna --repos execution-service unified-trading-services --apply
```
...
🔍 Step 2: Finding COD issues...
  Searching execution-service...
  Searching unified-trading-services...
  ✓ Found 637 COD issues
    589 need labeling

🏷️  Step 3: Applying 'cod' labels...
  execution-service#1234: COD: Migrate from NautilusTrader to custom engine...
    ✓ Added 'cod' label
  [... 588 more ...]
