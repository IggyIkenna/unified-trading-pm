...
PROJECT_DEFINITIONS = {
    ...
    "execution": {
        ...
        "repos": ["execution-services"],
        "views": [
            {"name": "Work Items", "filter": "repo:execution-services -label:cod"},
            {"name": "Epics Only", "filter": "repo:execution-services label:epic -label:cod"},
            {"name": "In Progress", "filter": "repo:execution-services is:open -label:cod"},
        ],
    },
    "strategy": {
    ...
    "reporting": {
        ...
        "repos": ["client-reporting-service"],
        "views": [
    ...
    "execution-backtest": {
        ...
        "repos": ["execution-services"],
        "views": [
            {"name": "Work Items", "filter": "repo:execution-services label:backtest -label:cod"},
            {"name": "Epics Only", "filter": "repo:execution-services label:backtest label:epic -label:cod"},
            {"name": "In Progress", "filter": "repo:execution-services label:backtest is:open -label:cod"},
        ],
    },
    "strategy-backtest": {
