tackling # Agent Prompt: Unified Libraries Refactor (Quick Copy-Paste)

## Prompt Template

```
Complete subtask for Unified Libraries Refactor issue #[ISSUE_NUMBER] in [REPO_NAME].
...
```
Complete subtask for Unified Libraries Refactor issue #5 in unified-trading-services.
...
```
Complete subtask for Unified Libraries Refactor issue #15 in unified-config-interface.
...
```
Complete subtask for Unified Libraries Refactor issue #1 (infrastructure).
