#!/bin/bash
#
# Copy Project Workflows - Unified Libraries Refactor
#
# Wrapper around utilities/copy-project-workflows.sh with updated label filter
# for UNIFIED-LIBRARIES-REFACTOR instead of "cleanup".
#
...
echo "    This project uses label 'UNIFIED-LIBRARIES-REFACTOR' instead of 'cleanup'"
...
# Additional instructions specific to Unified Libraries Refactor
echo ""
echo "========================================="
echo "Unified Libraries Refactor Specific"
echo "========================================="
echo ""
echo "⭐ CRITICAL: Update Label Filter"
echo ""
echo "When configuring 'Auto-add to project' workflow:"
echo "  - Change label filter from 'cleanup' to 'UNIFIED-LIBRARIES-REFACTOR'"
...
echo "  4. Filters: Label = 'UNIFIED-LIBRARIES-REFACTOR'"
