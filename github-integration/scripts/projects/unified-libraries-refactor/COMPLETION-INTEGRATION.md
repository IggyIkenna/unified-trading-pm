...
**Epic:** Unified Libraries Refactor (Project #6) **Purpose:** Ensure epic learnings are properly integrated into Codex
after completion **When:** After all 51 subtasks complete (100% verified)
...
```bash
mkdir -p 11-project-management/completed-epics/unified-libraries-refactor
```

- [ ] **Create `11-project-management/completed-epics/unified-libraries-refactor/lessons-learned.md`**
  - Completion date
  - Duration (14 days planned vs actual)
  - Team (Ikenna + Harsh)
  - Metrics:
    - Lines of code added
...
- [ ] **Copy epic files to completed-epics:**
  ...
  # Copy files
  cp epics/unified-libraries-refactor-epic.md \
     completed-epics/unified-libraries-refactor/epic.md

  cp epic-breakdowns/epic-unified-libraries-refactor.md \
     completed-epics/unified-libraries-refactor/epic-breakdown.md

  cp ~/.cursor/plans/infrastructure-updates-for-library-refactor.md \
     completed-epics/unified-libraries-refactor/infrastructure-updates.md
  ```
...
- [ ] **Update GitHub Project #6 description:**
  - Mark as complete
  - Add completion date
  - Link to Codex docs:
    ...
    Lessons Learned: unified-trading-codex/11-project-management/completed-epics/unified-libraries-refactor/
    ```
...
8. ✅ GitHub Project #6 closed with docs links
...
- See epic breakdown: `11-project-management/epic-breakdowns/epic-unified-libraries-refactor.md`
- See project scripts: `11-project-management/github-integration/scripts/projects/unified-libraries-refactor/`
