...
#
# Creates comprehensive README documentation for the Unified Libraries Refactor project.
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        -h|--help)
            ...
            echo ""
            echo "Example:"
            echo "  bash 06-generate-project-readme.sh --project 6 > PROJECT_README.md"
            exit 0
            ;;
        *)
...
### Project Label
- \`UNIFIED-LIBRARIES-REFACTOR\` - All issues in this project
...
1. **Auto-add to project** - Issues with \`UNIFIED-LIBRARIES-REFACTOR\` label auto-add
...
gh issue list --label UNIFIED-LIBRARIES-REFACTOR --state all
...
gh pr list --label UNIFIED-LIBRARIES-REFACTOR --state open --search "review:required"
\`\`\`
...
- ✅ Live testing ready by Feb 28, 2026
...
**Scripts:**
- Project setup: \`unified-trading-codex/11-project-management/github-integration/scripts/projects/unified-libraries-refactor/\`
