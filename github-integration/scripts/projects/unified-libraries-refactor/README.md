...
**Project**: GitHub Project #6 (TBD) **Epic**: Unified Libraries Refactor **Issues**: 51 subtasks across 5 repos

---

## Overview

This directory contains scripts to automate GitHub Project setup for the Unified Libraries Refactor epic.

**What this does:**

1. Creates GitHub Project with proper fields and views
2. Creates 4 new library repositories
3. Parses epic breakdown → 51 GitHub issues in appropriate repos
...
```bash
cd unified-trading-codex/11-project-management/github-integration/scripts/projects/unified-libraries-refactor

# Stage 1: Create project
bash 01-create-project.sh --org IggyIkenna
# Output: Project #6 created
...
for repo in unified-trading-library unified-config-interface \
    ...
    gh repo create "IggyIkenna/$repo" --private \
        --description "Part of Unified Libraries Refactor" \
...
bash 03-link-issues-to-project.sh --project 6 --issue-manifest issue-manifest.json
...
bash 06-generate-project-readme.sh --project 6 > PROJECT_README.md
```
...
- Creates GitHub Project "Unified Libraries Refactor"
...
for repo in unified-trading-library unified-config-interface \
    ...
    gh repo create "IggyIkenna/$repo" \
        --private \
        --description "Part of Unified Libraries Refactor - cloud-agnostic $repo" \
        --gitignore Python \
        --license MIT
...
- Parses `epic-unified-libraries-refactor.md`
- Extracts 51 subtasks with metadata
...
📋 Creating issues...
  [Creates 51 issues across 5 repos]
...
- Adds all 51 issues to Project #6
...
```
🔗 Linking 51 issues to Project #6...
  ✅ Added issue #1 to project
  ✅ Added issue #2 to project
  [... 49 more issues]

✅ Linked 51 issues to Project #6
...
- **Critical:** Updates label filter from "cleanup" to "UNIFIED-LIBRARIES-REFACTOR"
...
1. Auto-add to project (label: `UNIFIED-LIBRARIES-REFACTOR`)
...
Project: #6 - Unified Libraries Refactor
  Issues: 51 ✅
  Labels: UNIFIED-LIBRARIES-REFACTOR, P0-P3 ✅
  Workflows: 8 ✅
...
git commit -m "Add Unified Libraries Refactor project README"
```
...
ls -la ../../epic-breakdowns/epic-unified-libraries-refactor.md

# Or use absolute path
python 02-create-issues.py \
    --epic-file "/full/path/to/epic-unified-libraries-refactor.md" \
    --apply
```
...
├── 02-create-issues.py              # Creates 51 issues from epic
...
3. **Track Progress:**
   ```bash
   gh issue list --label UNIFIED-LIBRARIES-REFACTOR --state open
   gh pr list --label UNIFIED-LIBRARIES-REFACTOR --state open
   ```
...
- Checks status of all 51 subtasks from issue manifest
...
```
========================================
Unified Libraries Refactor - Status Report
========================================
...
3. **Give agent the task:**
   ...
   ```
   Complete subtask for Unified Libraries Refactor issue #3 in unified-trading-library.
...
**CRITICAL:** When all 51 subtasks are complete, the epic is NOT done until Codex docs are updated!
...
- **Plan:** `~/.cursor/plans/github_project_setup_cb974903.md`
