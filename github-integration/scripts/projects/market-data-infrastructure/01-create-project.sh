#!/bin/bash
#
# Create GitHub Project for Market Data Infrastructure
#
# Creates a new GitHub Project with appropriate fields for tracking
# the Market Data Infrastructure epic (4 subtasks across 1 repo).
#
# Usage:
...
# Defaults
ORG="${ORG:-IggyIkenna}"
PROJECT_NAME="Market Data Infrastructure"
