# Agent Workflow: Market Data Infrastructure - Local Execution

## Purpose

This document provides instructions for an AI agent to complete a subtask from the Market Data Infrastructure epic,
...
- Epic breakdown file available:
  `unified-trading-codex/11-project-management/epic-breakdowns/epic-market-data-infrastructure.md`
...
| -------------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------- |
| **Epic Overview**          | High-level goals and architecture | `@unified-trading-codex/11-project-management/epics/market-data-infrastructure-epic.md`           |
| **Epic Breakdown**         | All 4 subtasks with details       | `@unified-trading-codex/11-project-management/epic-breakdowns/epic-market-data-infrastructure.md` |
...
cat unified-trading-codex/11-project-management/epic-breakdowns/epic-market-data-infrastructure.md | \
...
name = "[REPO_NAME]"
version = "0.1.0"
description = "Part of Market Data Infrastructure - [description]"
readme = "README.md"
...
Part of the Market Data Infrastructure epic.
...
cat > ${REPO*NAME//-/*}/**init**.py <<'EOF' """[REPO_NAME] - Part of Market Data Infrastructure."""
