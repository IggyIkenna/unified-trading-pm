#!/bin/bash
#
# Copy Project Workflows - Market Data Infrastructure
#
# Wrapper around utilities/copy-project-workflows.sh with updated label filter
# for MARKET-DATA-INFRASTRUCTURE instead of "cleanup".
#
...
echo "    This project uses label 'MARKET-DATA-INFRASTRUCTURE' instead of 'cleanup'"
...
# Additional instructions specific to Market Data Infrastructure
echo ""
echo "========================================="
echo "Market Data Infrastructure Specific"
echo "========================================="
echo ""
echo "⭐ CRITICAL: Update Label Filter"
echo ""
echo "When configuring 'Auto-add to project' workflow:"
echo "  - Change label filter from 'cleanup' to 'MARKET-DATA-INFRASTRUCTURE'"
...
echo "  4. Filters: Label = 'MARKET-DATA-INFRASTRUCTURE'"
