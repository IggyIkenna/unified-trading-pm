tackling # Agent Prompt: Post-Trade and Execution (Quick Copy-Paste)

## Prompt Template

```
Complete subtask for Post-Trade and Execution issue #[ISSUE_NUMBER] in [REPO_NAME].
...
```
Complete subtask for Post-Trade and Execution issue #3 in unified-events-interface.
...
```
Complete subtask for Post-Trade and Execution issue #5 in unified-trading-services.
...
```
Complete subtask for Post-Trade and Execution issue #15 in unified-config-interface.
...
```
Complete subtask for Post-Trade and Execution issue #1 (infrastructure).
