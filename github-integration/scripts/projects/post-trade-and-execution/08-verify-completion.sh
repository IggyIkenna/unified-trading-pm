#!/bin/bash
#
# Verify Post-Trade and Execution Project Completion
#
# Checks status of all 20 subtasks and generates completion report.
#
# Usage:
...
if [ ! -f "$ISSUE_MANIFEST" ]; then
    ...
    echo "  python 02-create-issues.py --org $ORG --epic-file ../../epic-breakdowns/epic-post-trade-and-execution.md --apply"
    exit 1
fi

echo "========================================="
echo "Post-Trade and Execution - Status Report"
echo "========================================="
echo ""
...
if [ $OPEN -eq 0 ] && [ $IN_PROGRESS -eq 0 ] && [ $ERRORS -eq 0 ]; then
    ...
    echo "========================================="
    echo ""
    echo "All 20 subtasks resolved. Post-Trade and Execution is complete!"
    echo ""
    echo "Next steps:"
    ...
    echo ""
    echo "Monitor PRs:"
    echo "  gh pr list --label POST-TRADE-AND-EXECUTION --state open"
    echo ""
