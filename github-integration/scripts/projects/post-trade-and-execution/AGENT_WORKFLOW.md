# Agent Workflow: Post-Trade and Execution - Local Execution

## Purpose

This document provides instructions for an AI agent to complete a subtask from the Post-Trade and Execution epic,
...
- Epic breakdown file available:
  `unified-trading-codex/11-project-management/epic-breakdowns/epic-post-trade-and-execution.md`
...
| -------------------------- | --------------------------------- | ----------------------------------------------------------------------------------------------- |
| **Epic Overview**          | High-level goals and architecture | `@unified-trading-codex/11-project-management/epics/post-trade-and-execution-epic.md`           |
| **Epic Breakdown**         | All 20 subtasks with details      | `@unified-trading-codex/11-project-management/epic-breakdowns/epic-post-trade-and-execution.md` |
...
cat unified-trading-codex/11-project-management/epic-breakdowns/epic-post-trade-and-execution.md | \
...
name = "[REPO_NAME]"
version = "0.1.0"
description = "Part of Post-Trade and Execution - [description]"
readme = "README.md"
...
Part of the Post-Trade and Execution epic.
...
cat > ${REPO*NAME//-/*}/**init**.py <<'EOF' """[REPO_NAME] - Part of Post-Trade and Execution."""
