...
**Project**: GitHub Project #7 (TBD) **Epic**: Post-Trade and Execution **Issues**: 20 subtasks across 4 repos (2 new
services + 1 refactor + 1 UI enhancement)

---

## Overview

This directory contains scripts to automate GitHub Project setup for the Post-Trade and Execution epic.
...
- Creates GitHub Project "Post-Trade and Execution"
...
for repo in unified-events-interface unified-config-interface \
    ...
    gh repo create "IggyIkenna/$repo" \
        --private \
        --description "Part of Post-Trade and Execution - cloud-agnostic $repo" \
        --gitignore Python \
        --license MIT
...
- Parses `epic-post-trade-and-execution.md`
- Extracts 20 subtasks with metadata
...
📋 Creating issues...
  [Creates 20 issues across 4 repos]
...
- Adds all 20 issues to Project #7
...
```
🔗 Linking 20 issues to Project #7...
  ✅ Added issue #1 to project
  ✅ Added issue #2 to project
  [... 49 more issues]

✅ Linked 20 issues to Project #7
...
- **Critical:** Updates label filter from "cleanup" to "POST-TRADE-AND-EXECUTION"
...
1. Auto-add to project (label: `POST-TRADE-AND-EXECUTION`)
...
Project: #6 - Post-Trade and Execution
  Issues: 51 ✅
  Labels: POST-TRADE-AND-EXECUTION, P0-P3 ✅
  Workflows: 8 ✅
...
git commit -m "Add Post-Trade and Execution project README"
```
...
ls -la ../../epic-breakdowns/epic-post-trade-and-execution.md

# Or use absolute path
python 02-create-issues.py \
    --epic-file "/full/path/to/epic-post-trade-and-execution.md" \
    --apply
```
...
├── 02-create-issues.py              # Creates 20 issues from epic
...
3. **Track Progress:**
   ```bash
   gh issue list --label POST-TRADE-AND-EXECUTION --state open
...
- Checks status of all 20 subtasks from issue manifest
...
```
========================================
Post-Trade and Execution - Status Report
========================================
...
**CRITICAL:** When all 20 subtasks are complete, the epic is NOT done until Codex docs are updated!
