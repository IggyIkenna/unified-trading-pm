#!/bin/bash
#
# Create GitHub Project for Post-Trade and Execution
#
# Creates a new GitHub Project with appropriate fields for tracking
# the Post-Trade and Execution epic (20 subtasks across 4 repos).
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        -h|--help)
            ...
            echo "  --name  Project name (default: Post-Trade and Execution)"
            echo ""
            echo "Example:"
