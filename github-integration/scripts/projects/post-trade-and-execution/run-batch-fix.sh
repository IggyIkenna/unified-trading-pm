#!/usr/bin/env bash
#
# Batch execution wrapper for Post-Trade and Execution subtasks
#
...
echo "========================================="
echo "Post-Trade and Execution - Batch Execution"
echo "========================================="
echo ""
echo "Model: $MODEL"
...
if [ -n "$CUSTOM_ISSUES" ]; then
    ...
    if [ ! -f "$ISSUE_MANIFEST" ]; then
        ...
        echo "  cd $SCRIPT_DIR"
        echo "  python 02-create-issues.py --org IggyIkenna --epic-file ../../epic-breakdowns/epic-post-trade-and-execution.md --apply"
        exit 1
    fi
