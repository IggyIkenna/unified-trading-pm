# Post-Trade and Execution - Epic Completion and Codex Integration

**Epic:** Post-Trade and Execution (Project #7) **Purpose:** Ensure epic learnings are properly integrated into Codex
after completion **When:** After all 20 subtasks complete (100% verified)
...
- [ ] **Run completion script:**
  ...
  ```bash
  cd unified-trading-codex/11-project-management/github-integration/scripts/projects/post-trade-and-execution
...
```bash
mkdir -p 11-project-management/completed-epics/post-trade-and-execution
```

- [ ] **Create `11-project-management/completed-epics/post-trade-and-execution/lessons-learned.md`**
  - Completion date
  - Duration (12 days planned vs actual)
  - Team (Ikenna + Harsh)
  - Metrics:
    - Lines of code added
...
- [ ] **Copy epic files to completed-epics:**
  ...
  # Copy files
  cp epics/post-trade-and-execution-epic.md \
     completed-epics/post-trade-and-execution/epic.md

  cp epic-breakdowns/epic-post-trade-and-execution.md \
     completed-epics/post-trade-and-execution/epic-breakdown.md

  cp ~/.cursor/plans/infrastructure-updates-for-library-refactor.md \
     completed-epics/post-trade-and-execution/infrastructure-updates.md
  ```
...
- [ ] **Update GitHub Project #7 description:**
  - Mark as complete
  - Add completion date
  - Link to Codex docs:
    ...
    Lessons Learned: unified-trading-codex/11-project-management/completed-epics/post-trade-and-execution/
    ```
...
8. ✅ GitHub Project #7 closed with docs links
...
- See epic breakdown: `11-project-management/epic-breakdowns/epic-post-trade-and-execution.md`
- See project scripts: `11-project-management/github-integration/scripts/projects/post-trade-and-execution/`
