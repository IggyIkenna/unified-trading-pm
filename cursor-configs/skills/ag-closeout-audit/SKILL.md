...
Before authoring the finalize plan, run
`.venv/bin/python scripts/quality_gates/check_finalize_plan_coverage.py --check-gated <batchN-slug>` — the idempotency
guard added 2026-08-11 (`duplicate_finalize_plans_created_for_one_parent_2026_08_06.md`). Exit 1 ("ALREADY GATED")
means a companion finalize plan already exists for this batch under some other name — use that one instead of
