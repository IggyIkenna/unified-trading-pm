# Terraform: uts-prod-ikenna GCP Project
# Purpose: Isolated Cloud Build + Artifact Registry for production / main branch builds
...
resource "google_artifact_registry_repository" "unified_trading" {
  ...
  location      = var.region
  format        = "DOCKER"
  description   = "Unified trading system Docker images (production / main branch builds)"
