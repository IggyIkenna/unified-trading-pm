...
name: debug-ui
description: >-
  Debug frontend UI errors using the browser MCP. Use when the user invokes
  /debugui, asks to debug a UI, check console errors, or fix something that broke
...
- **URL**: User provides it (e.g. `http://localhost:5183`) or infer from common ports (deployment-ui: 5183, strategy-ui: 5173, etc.)
...
User can say: "Something broke" or "deployment-ui at localhost:5183 - I clicked X and it crashed." One sentence is enough.
