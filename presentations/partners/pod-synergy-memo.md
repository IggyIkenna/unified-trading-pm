...
- **Unified pipeline (batch = live)** — strategy, position, risk, execution all share one code path; the only seam is
  ...
  [`codex/09-strategy/operational/paper-batch-live-reconciliation.md`](../../codex/09-strategy/operational/paper-batch-live-reconciliation.md).
...
| Batch = Live unified pipeline        | [`unified-trading-pm/codex/09-strategy/operational/paper-batch-live-reconciliation.md`](../../codex/09-strategy/operational/paper-batch-live-reconciliation.md)                                                                                                                                                                                            |
