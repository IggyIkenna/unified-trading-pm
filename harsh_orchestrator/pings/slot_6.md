[2026-05-19 15:00 UTC] slot-1-main → slot 6 (Harsh side) — 🔴 OPERATOR BROADCAST: commit + push your dirty work to slot branch + FF to LDR. See [`plans/active/_operator_broadcast_2026_05_19_commit_dirty_work.md`](../../plans/active/_operator_broadcast_2026_05_19_commit_dirty_work.md). Ack here once your tab is clean.
...
1. Pull LDR in ALL your repos: `cd ${WORKSPACE_ROOT}/.tabs/6/<repo> && git fetch origin --quiet && git rebase origin/live-defi-rollout`
