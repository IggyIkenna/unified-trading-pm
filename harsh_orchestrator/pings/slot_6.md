...
`launch-manifest-recon-all-vm.sh` with `--apply-flips` variant). Item lives in `plans/epics/tradfi_master.md` line 326.
Tagged BLOCKED-OPERATOR in `gate_3_phantom_audit_runbook_2026_05_13.md` deferred table.
