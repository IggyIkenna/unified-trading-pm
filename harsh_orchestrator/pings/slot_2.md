...
13. ✅ **deployment-service event sink consolidation** — `codex/05-infrastructure/event-sink-chain.md` written: 3 chains (null-sink orchestrator, PubSub VM heartbeat, GCS tee), ASCII trace diagram, canonical decision tree, known gaps table. PM@(pending). Done.
