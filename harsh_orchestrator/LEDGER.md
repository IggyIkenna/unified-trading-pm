...
| 4 | 🆕 Wave 4: Fix the 17 pre-existing strategy-service test failures (operator direction: don't leave broken tests broken — fix them with the context you have). Resume agenda items 1-4 already shipped (PM@2e6fecf0 — 17-failures explanation, stash-pop, tarball refresh, Script 3 DRY-RUN VMs launched). Wave 4 = repair the 17 failures + close issue doc + item 5 update. | 🟡 NEW (Wave 4) — see § "Wave 4 task briefs — Slot 4" below | strategy-service test repair across 6 files + `issues/classify_blank_reason_fixture_manifest_kwarg_2026_05_13.md` | `tab/hk/4` |
...
| 6 | Wave 3 ✅ DONE — per_agent_worktrees 30/30 (Phase 4.5 P1 + Phase 2 burn-in + Harsh --init flipped) + api_football 13/16 (3 deferred as operator-executable post-cutover). PM@2f710f9a + PM@e67fc4ae. Standing by. | ✅ DONE Wave 3 | `per_agent_worktrees_2026_05_10.md` + `api_football_minimal_flattening_removal_2026_05_07.md` | `tab/hk/6` |
...
| 9 | 🆕 Wave 3: Sports classifier extension P1 (Wave 1 audit re-open) — STARTED 14:05 UTC; **scope narrowed**: slot 9 read `_classify_sports:191` and found all 4 rules ALREADY SHIPPED at commit 3fbc6b3 (Wave 1 audit re-open verified-as-resolved by this finding). Remaining: 11 missing tests (5/16 exist) + Script 3 DRY-RUN | 🟢 IN FLIGHT — slot 9 GREP-THEN-READ correctly applied | `issues/sports_classifier_extension_followup_2026_05_13.md` | `tab/hk/9` |
