...
| 2 | risk_simulations finalisation (82% → 100%; P0 items + P1 stablecoin) | ✅ DONE Wave 2 — D.4 depeg ladder backtest (risk-and-exposure@39c9e12) + Phase 8.A/8.B synthetic-fire suite 32 tests (risk-and-exposure@dbd543c — main rescued via foot-gun #5 intercept; was on slot 2 worktree, not pushed). | `risk_simulations_limits_alerting_2026_05_10.md` | `tab/hk/2` |
