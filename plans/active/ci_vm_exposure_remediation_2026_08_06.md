...
- **context-scout 2026-08-19**: re-verified context_scope (5 entries) unchanged, all resolve on disk — still
  targets the sole remaining open todo (fleet-wide CI concurrency cap).
