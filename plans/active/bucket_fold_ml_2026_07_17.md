...
- **na-eligibility-audit 2026-08-17** [body-hash:2baf3428a150a11f]: KEEP-NA, valid -- The doc's own frontmatter `source` field carries an explicit, dated operator ruling: 'Operator ruling 2026-07-17: author all 5 folds as HUMAN plans.' This governs the whole doc regardless of individual item boundedness, per the NEVER-RE-LITIGATE citation rule (a). Both remaining open items (IAM Group-B join for ml-store-prd, and a time-gated alias-sunset cleanup pending the reader-fallback window closing) are named residuals under that human-plan designation in the doc's own repeatedly-reaffirmed Progress Log (na-eligibility-audit 2026-08-02/08-07, both KEEP-NA).
- **context-scout 2026-08-17**: re-verified context_scope, no change needed (3 entries) -- today's na-eligibility-audit reaffirmed the same 2 open items (IAM Group-B join, alias sunset); existing bucket-isolation-model.md/delete-safety-protocol.md/bucket_naming.py set remains accurate.
- **context-scout 2026-08-19**: re-verified context_scope, no change needed (3 entries) — same 2 open items (IAM Group-B join, alias sunset), existing set remains accurate.
- **na-eligibility-audit 2026-08-21** (cross-cutting tranche): KEEP-NA, valid — reaffirms the chain of prior verdicts (2026-08-02/07/17): explicit dated operator ruling (2026-07-17, 'author all 5 folds as HUMAN plans') governs the whole doc; 2 open items (IAM Group-B join, time-gated alias sunset) unchanged, both named residuals under that human-plan designation.
