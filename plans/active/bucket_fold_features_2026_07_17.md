...
- **na-eligibility-audit 2026-08-17 (cross-cutting tranche, dispatch agt-3931fd)** [body-hash:600af6544abe8169]: KEEP-NA, valid — Explicit dated operator ruling cited in the doc's own frontmatter source: field ('all 5 folds as HUMAN plans', 2026-07-17) governs this doc regardless of how small/bounded the sole remaining 'alias sunset' P3 todo looks in isolation — per the rubric this citation alone settles KEEP_NA_VALID without re-litigating. Ruling/citation: Doc's own frontmatter `source:` field: 'Successor execution plan of bucket_estate_fold_design_2026_07_13 §3 todo 1. Operator ruling 2026-07-17: all 5 folds as HUMAN plans. This is Fold A (features...).' — an explicit dated operator ruling naming this exact doc as one of the 5 HUMAN-plan folds.
