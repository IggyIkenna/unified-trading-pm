...
**⭐ START HERE:** [defi-strategy-testing-quickstart.md](defi-strategy-testing-quickstart.md) — Quick reference + examples for testing any DeFi strategy

**Detailed Plans:**
- [defi-strategy-ui-verification.plan.md](defi-strategy-ui-verification.plan.md) — Phase 1: Verify UI widgets with mocked data
- [defi-strategy-e2e-automation.plan.md](defi-strategy-e2e-automation.plan.md) — Full pipeline: UI verification → test generation → execution → regression protection
...
3. **To create a new plan:** Add it to this INDEX with a one-line description, then update `[plan-placement.mdc](../../.cursor/rules/core/plan-placement.md)`
