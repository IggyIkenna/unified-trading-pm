...
| S&P index options                             | yes                              | ✅ IS availability-index: data present. MTDS availability-index (corrected manifest count-check, 2026-08-09 — `plans/active/issues/tradfi_year_shard_backfill_launcher_missing_source_self_deletes_2026_08_09.md` third finding): 2020-2024 ~94.8-100% covered, 2025 confirmed 0% gap, 2026 73% partial. Manifest-verify still tracked in `instruments_tradfi_g1_g5_gate_execution_2026_07_24.md`. | NOT PROVEN — TradFi is batch-only |
