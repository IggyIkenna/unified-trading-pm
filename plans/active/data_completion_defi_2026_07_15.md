...
- [ ] [DATA] P0. C0 **path + bucket canonicalisation (the foundational migration) — RUN ON A VM (operator-confirmed
      ...
      The C0/**v9** step is a NEW, separate read+rewrite tool —
                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                              covered by C0. mtds@a07cea55; launcher deployment-service@4484802. **Remaining = the C0a–C0f
...
- [ ] [DATA] P1. C8 fill manifest under-enumeration: UAC declares 90 defi venue-keys but manifest enumerated only lst
      ...
      design+build plan gated on an operator/architecture decision (Option A/B in the linked issue doc). This checkbox
      stays unchecked pending that decision. **na-eligibility-audit 2026-08-01: KEEP-NA-STALE (already-duplicated) — the
      operator ruled Option A 2026-07-26
      (`plans/archive/issues/defi_manifest_no_expected_unattempted_seeder_2026_07_26.md`, status: resolved) and the
      seeder design/build is now tracked verbatim in the ACTIVE, `assigned_vm: planning` plan
      `defi_expected_unattempted_seeder_design_2026_07_26.md`. Not reclassified — track completion there; this checkbox
      should be flipped by citation once that plan's todos land, not worked here directly.**
...
- [ ] [DATA] P0. D1 features-onchain-defi is near-empty (3 rows); features-delta-one-defi has NO index → derived
