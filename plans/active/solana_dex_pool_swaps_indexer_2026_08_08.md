...
- **context-scout 2026-08-15**: refreshed context_scope (5 entries) — replaced the dead `build_drift_v2_sig_index.py`
  reference (deleted 2026-07-16, per this doc's own todo-1 finding) with the live `_sig_index_walker.py` it was
  generalized into, and added `_orca_swap_decoder.py` (the shipped ORCA decoder, todo 2).
