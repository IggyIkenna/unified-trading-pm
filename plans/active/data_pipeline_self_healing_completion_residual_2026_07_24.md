...
- **na-eligibility-audit 2026-08-17 (cross-cutting tranche, dispatch agt-3931fd)** [body-hash:54553f2d3ef07332]: KEEP-NA, valid — Extensively pre-audited (8+ prior na-eligibility-audit passes 2026-08-01 through 08-16, all KEEP-NA, mixed doc); fresh read confirms the same 3-item mix still holds: 1 dependency-gated (registry-mode flip pending per-tier wiring confirmation), 1 explicit no-forcing-function stretch item, and 1 currently-firing-daily P1 (DP-WATCHER-006 OOM, last paged 2026-08-16) whose fix APPROACH is operator-ruled (BLK-b06d255a 2026-08-15, verified real via grep of the archived issue doc) but whose implementation is a substantial reader-redesign on live-dispatch-critical-path manifest-divergence-detection machinery.
