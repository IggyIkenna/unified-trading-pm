...
`features_available_at_stamping*\*` (composes with writegate Phase 2.D / Phase 4 slice (b) Phase 5.x available_at cross-family stamping). Full analysis + decision matrix: [`plans/active/issues/f6_df_flow_refactor_blocked_by_available_at_2026_05_08.md`](issues/f6_df_flow_refactor_blocked_by_available_at_2026_05_08.md). F6 deferred-work row stays `status:
...
`unified-trading-pm/plans/active/issues/features_cross_instrument_stray_file_2026_05_08.md` when the operator has
