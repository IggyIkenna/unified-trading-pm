...
- [x] [AGENT] P0. **8A — Carry archetype 1-year replay** using all new sim primitives (Phases 2-7) + Phase 6 dynamic
      ...
      delta + reduced bias evidence. (script-shipped execution-service@`38b3e8a5` (rescued via cherry-pick from tab/hk/4@c5dd45eb after foot-gun #5) — `run_carry_archetype_replay.py`;
...
- [x] [AGENT] P0. **8B — Leveraged-funding-arb 1-year replay** with new sim primitives. Document delta vs old.
      (script-shipped execution-service@`38b3e8a5` (rescued via cherry-pick from tab/hk/4@c5dd45eb after foot-gun #5) — `run_leveraged_funding_arb_replay.py`; `--synthetic` demo passes.
...
- [x] [AGENT] P0. **8C — Tenderly fork live-vs-simulated reconciliation** for 1 day of paper-trade. Per-tick live fill
      vs simulated fill; |delta| should be < 10bps for ≥ 95% of fills. (script-shipped execution-service@`38b3e8a5` (rescued via cherry-pick from tab/hk/4@c5dd45eb after foot-gun #5) —
...
- [x] [AGENT] P0. **8D — Sign-off gate**. Compose script shipped execution-service@`38b3e8a5` (rescued via cherry-pick from tab/hk/4@c5dd45eb after foot-gun #5) —
