...
- **na-eligibility-audit 2026-08-17 (cross-cutting tranche, dispatch agt-3931fd)** [body-hash:0f44e44dea3cbcb3]: KEEP-NA, valid — Operator ruling 2026-08-12 explicitly designated this a 'human plan (not AO-dispatched)' (Progress Log, authoring entry) despite the work itself being executed via bounded /autonomous sessions — not re-litigated here per the never-re-litigate rule. 8 of 9 todos shipped; the sole remaining item (todo 7, transition compat cleanup) is explicitly blocked on a separate, larger, previously-untracked regression discovered 2026-08-13 in a sibling doc (data_status_rollup_ml_service_full_blob_missing_2026_07_26.md) that must resolve first — confirmed pre-existing, not caused by this plan. Ruling/citation: operator ruling 2026-08-12 'full single-pass design ... + human plan (not AO-dispatched)'; todo 7's own text redirects to data_status_rollup_ml_service_full_blob_missing_2026_07_26.md as the doc now owning the root-cause + fix
