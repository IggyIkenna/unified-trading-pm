...
- [x] ✅ [DATA] P1. Register all 6 venues in the instruments catalogue so downstream consumers see a complete universe,
      ...
      data_engineering craft) — DONE.** instruments-service@07b12ddf: new one-off script
      `scripts/expand_defi_lst_vault_catalogue_from_manifest_2026_07_31.py` registers all 6 venues in
