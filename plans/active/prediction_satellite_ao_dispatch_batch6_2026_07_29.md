...
- [ ] [SCRIPT] P1. **Kalshi execution credential reshape + live paper-order verify.** Todo 1: read the existing
      ...
      **Todo 1 DONE 2026-07-31**: both secrets provisioned + verified non-empty and byte-identical to source (evidence
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  **Question**: how should todo 2 be executed?
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  B: ~~Place a real order on the live host as literally instructed~~ — **RULED OUT 2026-08-08 (plan_reconciler,
                                                                                                                                                                                                                                  mirroring `kalshi_execution_credential_secret_name_mismatch_2026_07_26.md`'s "RULED 2026-08-06 (operator): NO —
                                                                                                                                                                                                                                  do not touch the live exchange"** — that ruling's scope note ("does not touch the exchange side at all") was
                                                                                                                                                                                                                                  about the SECRET-RESHAPE decision specifically, but its bottom-line answer (no live-exchange orders) directly
                                                                                                                                                                                                                                  forecloses Option B here too. The choice remaining is between A and C.
