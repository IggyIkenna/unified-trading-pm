...
- [ ] [SCRIPT] P1. DEFERRED-BY-DESIGN. **Phase 5 — canonical-groups backfill, ~24 remaining groups beyond the initial
      ...
      `/plans/archive/2026_08/predictions_other_bucket_and_ui_drilldown_2026_06_20.md` (the `[SCRIPT] P1` "Phase 5" item — full
...
> **2026-08-16 (slot-15, data_engineering)**: full historical Progress Log entries (2026-07-29 → 2026-08-12) moved
> verbatim to
> [`prediction_satellite_ao_dispatch_batch6_2026_07_29_progresslog.md`](/plans/active/prediction_satellite_ao_dispatch_batch6_2026_07_29_progresslog.md)
> — mechanical line-cap split (this doc was 1001 lines, 1 over the 1000-line hard cap; no Todos/Deferred content moved
