...
- [ ] [SCRIPT] P1. DEFERRED-BY-DESIGN. **Phase 5 — canonical-groups backfill, ~24 remaining groups beyond the initial
      ...
      `plans/archive/2026_08/predictions_other_bucket_and_ui_drilldown_2026_06_20.md` (the `[SCRIPT] P1` "Phase 5" item
      — full remaining group list in the source doc). **Done when**: all ~24 groups are registered + backfilled +
