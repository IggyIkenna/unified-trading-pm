...
- [ ] **S3. SUSTAIN — deployment-api integration test coverage uplift to 90%** [deployment-api] — **IN PROGRESS
      ...
      tests). Gap to 90%: ~2800 lines. Next targets: routes/service_status.py (156 missed), routes/builds.py (136
      missed), routes/epics.py (120 missed), service_status_checkers.py (107 missed). Done-def: deployment-api
      coverage ≥90% + QG green. **~10 cal-days**.
