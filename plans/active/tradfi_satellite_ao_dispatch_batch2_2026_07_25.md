...
- [ ] [OPERATOR] P2. **Resolve the still-conflict-gated / operator-gated / too-large candidates below** — the "Deferred
      ...
      `tradfi_mvp_mode_unreachable_dead_gate_2026_07_08.md` design call — **RULED 2026-07-29, see the issue doc; this
      portion of the bundled todo is resolved, the other two sections below are not**), and "Still excluded —
