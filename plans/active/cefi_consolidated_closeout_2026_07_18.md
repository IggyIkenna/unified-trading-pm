...
- [ ] [DATA] P2. **Delete the 149 stale legacy per-leg objects** (listed in
      `plans/audit/results/cefi_todo19_149_residual_objects_2026_07_23.csv`) only AFTER the regenerated bundles are
      verified complete — never before. Then close todo 19 in the source issue doc.
...
> `cefi_4surface_migration_execution_log_2026_07_18.md`, extracted 2026-07-24 per the plan line-cap remediation — this
> section is the discoverability index for everything ELSE still open in cefi.

- **Venue-specific canonicalisation residuals**: `issues/bybit_futures_chain_write_shape_2026_07_13.md`,
  ...
  `issues/mtds_uac_embedded_colon_symbol_validation_regression_2026_07_21.md`,
  `issues/uac_build_instrument_id_colon_strictness_mtds_ripple_2026_07_21.md`,
  `coinbase_bare_name_migration_execution_service_2026_07_10.md`,
  `issues/cefi_future_instrument_type_no_candle_schema_contract_2026_07_21.md`,
  `issues/mdps_derivative_ticker_candle_schema_violation_2026_07_20.md`,
  `candle_canonical_path_migration_execution_2026_07_24.md`.
- **Coverage / backfill / VM ops**: `issues/aster_capture_broken_coverage_and_completeness_2026_07_20.md`,
  `aster_and_cefi_rolling_adv_feature_2026_07_21.md`, `issues/tardis_concurrent_ip_lockout_2026_07_12.md`,
  `issues/mtds_backfill_vm_memory_hang_large_chunk_2026_07_22.md`,
  `issues/mtds_backfill_vm_startup_oom_rc137_2026_07_14.md`,
  `issues/cefi_backfill_per_day_catalogue_reload_2026_07_20.md`,
  ...
  `issues/manifest_v6_batch3_residual_orphaned_work_2026_07_21.md`,
  `issues/mtds_rule11_shard_count_stale_baseline_2026_07_21.md`, `instruments_cefi_g1_g5_gate_execution_2026_07_24.md`.
- **Manifest / data-status / honest-coverage**: `issues/manifest_completeness_full_corpus_map_build_2026_07_20.md`,
  ...
  `issues/canonical_closeout_open_questions_2026_07_18.md`, `issues/estate_orphan_assessment_2026_07_21.md`,
  `issues/phantom_audit_estate_coverage_gap_2026_07_10.md`,
  `issues/features_by_date_root_canonicalisation_2026_07_21.md`,
  ...
  `mdps_features_reduced_artifact_tracker_2026_06_28.md`, `data_pipeline_check_mdps_features_2026_07_20.md`,
  `issues/backfill_smoke_write_path_canonical_audit_2026_07_20.md`,
  `issues/pipeline_e2e_check_vm_name_collision_2026_07_12.md`,
  `issues/fail_hard_canonical_enforcement_design_2026_07_20.md`.
- **Adapters / QG / process**: `issues/breaking_change_differ_blind_to_registry_data_dicts_2026_07_09.md`,
  ...
  `issues/two_agents_slot3_collision_and_yahoo_finance_red_tree_2026_07_15.md`,
  ...
  `issues/group_c_cloud_run_job_failures_triage_2026_07_16.md`, `is_daily_enum_capture_heal_2026_07_07.md`.
- **Cross-AG-touching (cefi + defi/prediction, referenced here for the cefi slice)**:
  `defi_onchain_derivable_values_and_date_drift_2026_06_20.md`,
  `defi_pipeline_e2e_and_coverage_validation_2026_06_20.md`,
  `cefi_deribit_binance_futures_bundle_verification_2026_06_20.md`, `cefi_ml_directional_continuous_live_2026_06_20.md`,
  `issues/dp_catalog_not_running_sports_prediction_2026_07_15.md`,
  `prediction_capture_incident_remediation_2026_07_06.md`, `prediction_cross_venue_arb_and_coverage_2026_07_24.md`,
  `prediction_live_clob_depth_capture_2026_07_24.md`, `prediction_perps_kalshi_polymarket_parked_2026_07_24.md` — see
  the sibling `defi_consolidated_closeout_2026_07_18.md` / `prediction_consolidated_closeout_2026_07_18.md` for their
  primary tracking.
...
## Deferred work after 2026-07-24 ~05:55Z (supersedes all earlier Deferred-work sections in this file — items 1/4/4b/5/6/7/7c below are DONE, see DELTAs above)

| #    | Item                                                                                                   | Kind                                                          | Blocked-on                                                                                                                                                                                                           |
| ---- | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | ~~KRAKEN-SPOT Surface A~~                                                                              | **DONE**                                                      | —                                                                                                                                                                                                                    |
| 2a   | Fleet chain: error-recon + fresh 4-surface reverify                                                    | **DONE**                                                      | —                                                                                                                                                                                                                    |
| 2b   | LATE colliding-venue renames (fresh scope measurement, then per-venue dry-run+apply)                   | Cannot be done yet                                            | Blocked on GCS connectivity degradation (confirmed, measured) — retry once a cheap `gsutil stat` timing check shows normal latency (~3-7s, not ~20s+)                                                                |
...
| 3    | Surface C v2 manifest apply                                                                            | Cannot be done yet                                            | Blocked on the same connectivity degradation AND the chain-drop investigation (3304 lossy PIN_ATOM groups, root cause not yet understood — investigate fresh once connectivity allows, do not force `--apply` blind) |
| 4/4b | ~~Residual ambiguous wire-keys + margin_type mislabel~~                                                | **DONE**                                                      | —                                                                                                                                                                                                                    |
| 5    | ~~Catalogue-enumeration-gap script~~                                                                   | **DONE**                                                      | —                                                                                                                                                                                                                    |
| 6    | LIGHTER-ZKSYNC numeric-stem GCS rename backfill (~11,283 objects)                                      | Not done                                                      | Resolver code SHIPPED (`mtds@8835b899`); the actual dry-run + apply of the GCS rename itself never completed (workflow stalled on connectivity) — retry once connectivity allows                                     |
...
**Recommended next**: retry a cheap connectivity check first; once normal, resume 2b (LATE renames) and 3 (Surface C
chain-drop investigation) in parallel via DIRECT Bash execution (not Workflow dispatch, per the lesson above), then 6
(LIGHTER backfill), then 2c, then 9.

## Step 8 verdict (autonomous mode — this IS the rule-6 Progress Log entry for this tick, no separate chat summary since the operator is away)

**Safe to compact: YES.** Pushed SHAs this tick: `unified-trading-pm` (this commit), `market-tick-data-service@8835b899`
(the recovered LIGHTER-ZKSYNC commit) — both confirmed `ahead=0` against origin. `instruments-service` also confirmed
`ahead=0` (no new commits this tick). **What was at risk and is now saved**: one real, QG-green commit (`mtds@8835b899`)
that existed only locally after its parent workflow stalled — would have been invisible to any future session, now
pushed and verified. **What is deliberately NOT saved**: the ~867MB session scratchpad (one-off diagnostic scripts +
regenerable parquet snapshots + QG/quickmerge logs; grepped for dangling references from committed docs — the only hits
found are pre-existing references from OLDER, unrelated plan/issue docs predating this session, already flagged stale
where relevant, nothing new). **Where to resume**: re-check GCS connectivity health (cheap timed `gsutil stat`) before
resuming any of items 2b/3/6 — do not blindly re-dispatch heavy workflows into still-degraded connectivity.
