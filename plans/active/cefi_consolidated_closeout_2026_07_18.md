...
- **na-eligibility-audit 2026-08-21**: KEEP-NA, valid — reaffirms 2026-08-17 verdict; the 6 open items (Track 0
  INDEX-perp design + equity-perp backfill dependency-block, Track 1 fleet-follows-not-this-roll-up citation-hold,
  Track 2 POST-BACKFILL gates dependency-blocked, Track 8 casing residual dependency-blocked) are unchanged in
  substance.
