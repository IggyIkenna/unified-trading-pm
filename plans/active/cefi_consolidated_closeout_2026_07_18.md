...
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | KRAKEN-SPOT dry-run v4 finish clean (zero unhandled collisions), then `--apply` the 155,878 planned renames                                                                                                                                                                                                                                                                                                                                                                                                                      | Cannot be done yet                               | The dry-run itself is still running (past the dense 2026-02-03 day that killed v2, now at 02-05/06) — nothing to do but watch for the `SCRIPT 2 FILENAME RENAME SUMMARY` marker or a process death                                                                      |
...
| 4   | ~~Residual ~216 ambiguous CeFi wire-keys~~ — **84/216 SHIPPED** (`instruments-service@bf5322bb9`: BINANCE-DELIVERY 4/4, BINANCE-FUTURES 2/2, KRAKEN-FUTURES 2/2, OKX-FUTURES sub-pattern-A 76/146 — all the same numeric-wire-date off-by-one shape as the already-fixed DERIBIT bug). **132 remain**: BYBIT 39 (base-asset parsing regression, 36 fixable-but-not-yet-built / 3 correctly-excluded-real-products), BITGET-FUTURES 18 + OKX-FUTURES sub-pattern-B 70 + OKX-SWAP 5 (margin_type mislabel questions — see item 4b) | Not done (BYBIT's 36) / Operator-owned (item 4b) | BYBIT's 36 fixable base-asset-parsing dupes are real unscoped work, pick up any time; item 4b is gated on operator review                                                                                                                                               |
