...
> 2026-07-26 and is restored by `/plans/active/sports_taxonomy_p1_capture_and_contracts_2026_08_08.md`; (2) the arb
> same-operator guard was measured BROKEN on canonical venue values and is fixed by
> `/plans/active/sports_arb_operator_group_and_commission_bugfix_2026_08_08.md`; (3) the venue/data_type taxonomy
> migration and derived-layer backfill (13 of ~2,250 days covered) are P2/P4 of that chain. Do not re-raise activation
> as an open question until all four land.
