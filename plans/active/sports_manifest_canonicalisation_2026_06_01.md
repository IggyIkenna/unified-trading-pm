...
- [ ] [CODE] P2. Extend the `COVERAGE_EXCLUSIONS` gate (item -008 above) to the instruments-service expected-universe
      ...
      2026-07-17 to keep that todo's diff matched to the pre-validated written-and-reverted diff.
