...
- [ ] [SCRIPT] P3. Add a genuine cross-repo parity test in `system-integration-tests` asserting deployment-ui's
      ...
      denominator study 2026-07-17 (follow-up from the `TypedReasonBadges` taxonomy-drift fix).
