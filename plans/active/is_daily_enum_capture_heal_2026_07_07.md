...
- [x] ✅ [DATA] P1. **RESOLVED 2026-07-28 (slot-5)**: the genuine remainder tracked in
      `plans/active/issues/sports_is_daily_enum_backfill_oom_at_32gi_ceiling_2026_07_27.md` is now fully closed — all 3
      of that doc's Open work items are done (durable chunked-scan/slim-read fix `instruments-service@5134a5f0`;
