...
- **Strategy/PnL/backtest axis**: `/plans/active/defi_strategy_pnl_axis_index_2026_07_24.md` (entry point).
- **Bucket / storage / migration**: `/plans/active/defi_dedicated_bucket_shared_migration_2026_07_13.md`,
  `/plans/active/mvp_backfill_defi_onchain_v10_2026_06_27.md`,
...
- **Coverage / honest-coverage / manifest**: `/plans/active/data_completion_defi_2026_07_15.md`,
  `/plans/active/lst_rate_honest_coverage_2026_07_21.md`,
  ...
  `/plans/active/issues/phantom_captures_defi_2026_06_28.md`.
- **DeFi-specific canonicalisation residuals**:
  `/plans/active/defi_onchain_derivable_values_and_date_drift_2026_06_20.md`,
  `/plans/active/defi_lending_writer_retire_prerequisite_2026_07_20.md`,
  `/plans/active/defi_pipeline_e2e_and_coverage_validation_2026_06_20.md`,
  `/plans/active/issues/defi_pool_canonical_instrument_id_policy_contradiction_2026_07_17.md`,
  ...
  `/plans/active/issues/mtds_lst_extended_rates_uncited_addresses_2026_07_19.md`,
  ...
  `/plans/active/issues/defi_curve_optimism_subgraph_no_allocations_2026_07_15.md`,
  ...
  `/plans/active/issues/defi_pipeline_mode_source_desync_yearn_v3_2026_07_21.md`,
  ...
  `/plans/active/issues/defi_upstream_instruments_catalog_stale_2026_07_15.md`,
...
- **Cross-AG / infra / process**: `/plans/active/canonical_id_builder_retrofit_checklist_2026_07_08.md`,
  ...
  `/plans/active/issues/dp_catalog_not_running_sports_prediction_2026_07_15.md`,
  ...
  `/plans/active/issues/migration_orphan_sweep_performance_decay_2026_07_22.md`.
- **Cross-AG-touching cefi plans referenced here for their defi overlap**:
  ...
  `/plans/active/cryptovenue_equity_perps_and_tokenized_stocks_2026_06_20.md` — see
  `/plans/active/cefi_consolidated_closeout_2026_07_18.md` for their primary tracking.
