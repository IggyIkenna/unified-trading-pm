...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Glued-id manifest rebuild verify + delete `_migrated_` markers                                                                                                                                                                                                                            | **In progress, 2026-07-22 continued (tick 3).** First rebuild attempt (`canonical-migration-defi-rebuild-20260722-193748`) was SPOT-preempted mid-run (confirmed genuine reclaim via `gcloud compute operations list` showing a `stop` op, no `EXIT_STATUS` written) after progressing cleanly through 2020-01-01..2022-04-29 (~1.07M manifest entries written, no errors). No `PROGRESS.json` checkpoint exists for this new `defi-rebuild` launcher category (unlike the backfill launchers), so resumed manually from the log's last-confirmed date rather than restarting the whole range: relaunched as `canonical-migration-defi-rebuild-20260722-194751` scoped to `2022-04-29..2026-12-31` (re-doing the boundary day for safety), watchdog armed. The 148/157-recovered retry + the 9 residual ORCA/SOLANA cells (root-caused to directory-size fan-out, tracked separately) still stand from tick 2.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Resume VM reaching a terminal state, then verify 0 glued ids + delete `_migrated_*` markers. Separately: consider adding a PROGRESS.json checkpoint to the `defi-rebuild`/`defi-pi-range` launcher categories to match the backfill-launcher auto-resume contract, since this is the second SPOT preemption this session to require a manual date-range resume.                                                                                                                                                                                                                                                                                                                                                                                            |
