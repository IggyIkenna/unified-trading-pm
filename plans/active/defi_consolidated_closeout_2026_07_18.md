...
- **2026-07-22 (session 3, continued) — shipped `available_at` broader fix; recovered a stalled SPOT VM.**
  ...
  **Lessons this session**: (1) heartbeat-only liveness checks are insufficient for detecting a genuine VM-level hang —
  ...
  change to add SSH access.

## Deferred work after 2026-07-22

| Item                                                                                                                                                     | State / why deferred                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Blocked on                                                                                                                                                                                                   |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Glued-id manifest rebuild verify + delete `_migrated_` markers                                                                                           | Cannot be done yet — 3 recoveries so far, all idempotent, zero progress lost: VM1 (`...-033122`) hung mid-2025-chunk; VM2 (`...-053820`) genuinely SPOT-preempted mid-2025-chunk (`TERMINATED` + confirmed `compute.instances.preempted` op); VM3 (`...-062439`) hung AGAIN at the same year=2025 boundary (49min all-signals-dark, `RUNNING`, no OOM/panic signature, SSH unauthorized so root cause not yet localized). CURRENT VM is `canonical-migration-defi-per-instrument-20260722-080408` (`WORKERS=8`, `MIGRATION_YEARS="2025 2026"` — variables changed after the repeat hang), watchdog `bn0wso8cz` (10min stall threshold), running | The VM reaching a terminal `EXIT_STATUS`. If it hangs a THIRD time at this same boundary, root-cause via quarter-by-quarter bisection of 2025 instead of another blind relaunch (see Progress Log finding 5) |
