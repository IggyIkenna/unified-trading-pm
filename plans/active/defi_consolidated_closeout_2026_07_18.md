...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Glued-id manifest rebuild verify + delete `_migrated_` markers                                                                                                                                                                                                                            | **Concurrent session's 2025-01-01..2025-06-30 shard (`-075224`) completed clean (`exit_code=0`, 181 distinct dates, 4,957,616 total shards, 59 venues, 18 data_types) -- their 2026 shard also finished earlier. Found an OLDER 2026-07-20 rebuild attempt (year-sharded, `-2020` through `-2026` + `2025b/c/d`/`2022b/c` retries) while checking the flagged `2025-07-01..2025-08-09` gap -- none of the `2025*` attempts I sampled show a clean completion marker (consistent with the same repeated-preemption pattern hit today), so their coverage of that window was genuinely ambiguous from logs alone. Rather than trust 3-day-old partial-attempt archaeology, verified the raw GCS data exists for the window (spot-checked 2025-07-01/07-15/08-01/08-09, all present) and launched a definitive scoped closure**: `canonical-migration-defi-rebuild-20260723-130931` (on-demand, `2025-07-01..2025-08-09` only), watchdog armed. Once this lands, coverage is: mine (`2020-01-01..2024-12-31`) + concurrent session's (`2025-01-01..2025-06-30` + `2025-08-10..2026-12-31`) + this closure (`2025-07-01..2025-08-09`) = the full 2020-2026 range, no gaps.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | This closure VM (`-130931`) reaching a terminal state, then run the 0-glued-id verification pass over the full range.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
