...
- **[[pnl_interest_accrual_wrong_engine_and_banned_formula_2026_07_21]]** (`issues/`) — DeFi interest PnL correctness.
  ...
  entirely — implementation not started); `recursive_staking`'s real Aave `borrow_index` leg (E3) — now folded into the
  orphaned-archetype build plan below as "Phase 2."
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Glued-id manifest rebuild verify + delete `_migrated_` markers                                                                                                                                                                                                                            | **My portion COMPLETE 2026-07-23.** `canonical-migration-defi-rebuild-20260723-081354` (on-demand, scoped to the actual gap `2024-10-08..2024-12-31`) finished clean: `exit_code=0`, 1,042,769 total shards processed for this range (679 unparseable, 17,700 skipped markers, 2,420 write errors -- all within normal bounds for a historical rebuild). This closes my sequential coverage: `2020-01-01..2024-12-31` now fully rebuilt across 3 VMs (`-193748`, `-194751`+`-080400`+`-080749` chain, `-081354`). **Remaining, owned by the CONCURRENT session**: `2025-01-01..2025-06-30` + `2025-08-10..2026-12-31` (3 shards, still RUNNING as of this check) + the flagged `2025-07-01..2025-08-09` gap (unclaimed by any shard seen so far). Do NOT start the 0-glued-id verification or the purge/reseed work until those finish AND the gap is confirmed covered -- the manifest is not fully consolidated until every shard lands.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | The other session's 3 remaining shards reaching terminal + confirmation the 2025-07-01..2025-08-09 gap has a shard covering it, then a full-range 0-glued-id verification pass.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
