...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Glued-id manifest rebuild verify + delete `_migrated_` markers                                                                                                                                                                                                                            | **FULL 2020-2026 REBUILD COMPLETE 2026-07-23 — both sessions confirmed done, no actual gap.** The concurrent session's 2020-01-01..2024-12-31 coverage (VMs `-193748`/`-194751`+`-080400`+`-080749`/`-081354`) and my 2024-10-08..2026-12-31 coverage (VMs `-075807` 2024 Q4a, `-075900` 2024 Q4b, `-075224` 2025 H1, `-073738`→`-080250` 2025 H2 resumed after preemption, `-073604`→`-083424` 2026 resumed after preemption) are BOTH now terminal with `exit_code=0`. The `2025-07-01..2025-08-09` window the other session flagged as "unclaimed" is NOT actually a gap: `-073738` durably wrote through `2025-08-09` (25,400 shards that day, flushed to its own per-VM shard) before its own preemption — confirmed directly from its run.log, not inferred. Combined with the `-080250` resume (`2025-08-10..2025-12-31`), the full 2025-07-01..2025-12-31 range has no hole. Final per-VM totals: 2024 Q4a 532,261 shards/140.6s, 2024 Q4b 510,508/137.0s, 2025 H1 4,957,616/18336.3s, 2025 H2 3,578,528/9593.2s, 2026 1,910,446/2344.9s. All per-VM shards are picked up by the `uts-prod-manifest-consolidator-market-data-defi-cron` (`*/1 * * * *`, confirmed healthy + actively merging mid-rebuild). Proceeding to the 0-glued-id verification pass now that every shard has landed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | None — ready for the 0-glued-id verification pass against the fully-consolidated index.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
