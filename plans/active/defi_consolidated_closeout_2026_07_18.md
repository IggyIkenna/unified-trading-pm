...
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Glued-id manifest rebuild verify + delete `_migrated_` markers                                                                                           | Cannot be done yet — 4 recoveries so far, all idempotent, zero progress lost: VM1 hung mid-2025-chunk; VM2 genuinely SPOT-preempted mid-2025-chunk; VM3 (`WORKERS=8`) hung AGAIN at the same year=2025 boundary; VM4-attempt (`WORKERS=8`, `...-080408`) hung a THIRD time at the same boundary, ruling out simple thread-count contention. CURRENT VM is `canonical-migration-defi-per-instrument-20260722-093218` (`WORKERS=1` fully serial, `MIGRATION_YEARS="2025 2026"`), watchdog `beq9wz9tn` (10min stall threshold), running. If serial ALSO hangs, the last log line will pinpoint the exact poison day/file for a targeted fix | The VM reaching a terminal `EXIT_STATUS`. If serial (`WORKERS=1`) hangs too, escalate to an issue doc — 4 recoveries on one job is past the point of silent self-recovery, needs operator visibility even though each recovery is individually decidable |
...
| Resume paused DeFi crons (11 collect + 3 forward) + fix consolidator                                                                                     | Cannot be done yet                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Explicitly gated on Track 1/2 landing first (plan's own ordering) — Track 1's residual items (canon walk, purge, LENDING migration) are still open                                                                                                       |
...
| Checker collect-* fleet-wide real-VM-launch verification                                                                                                 | Not done                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Deliberately deferred by that agent (avoided forcing a dirty tarball) — MTDS is clean now, this can proceed                                                                                                                                              |
