...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Glued-id manifest rebuild verify + delete `_migrated_` markers                                                                                                                                                                                                                            | **In progress, 2026-07-22 continued.** R3 all-chunks migration COMPLETE (`rc_all=1`, expected — the 157 known ORCA/SOLANA/PANCAKESWAP_V3 cells; year=2026 wrote clean: 6963 instruments/177514 rows/0 errors). Root cause for the 157 found by a parallel sub-agent (see Progress Log): most sampled objects are provably healthy (read cleanly alone + concurrently, same shape/size as neighbors) — the real mechanism is likely **queue-starvation collateral**: `_run_cells()`'s single global 600s-since-last-completion clock sweeps every still-queued cell (however healthy) into the same abandonment event once a handful of genuinely-stuck reads permanently occupy all worker threads, not 157 independently-poisoned objects. Resolved the `deployment-service` stashed foreign WIP (3-way merge, `deployment-service@065cf70`) adding `defi-pi-range` (arbitrary date-range retry, no year restriction) + `defi-rebuild` (manifest-rebuild-only) launcher modes — exactly the tooling this row needed. **Retry launched**: `canonical-migration-defi-pi-range-20260722-190642` (`--start-date 2025-12-23 --end-date 2025-12-31 --apply`), watchdog armed. Manifest rebuild to follow once the retry reaches a terminal state (sequenced so the rebuild picks up the retried cells too, not just the original 63-cell result).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Retry VM (`-190642`) reaching a terminal state, then run `defi-rebuild 2020-01-01 2026-12-31 full` (the new launcher mode) over the whole corpus                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
