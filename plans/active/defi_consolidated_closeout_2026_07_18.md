...
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Glued-id manifest rebuild verify + delete `_migrated_` markers                                                                                           | Cannot be done yet — VM launched (`canonical-migration-defi-per-instrument-20260722-033122`), still running | The VM reaching a terminal `EXIT_STATUS` (watchdog armed, polls `run.log`/`EXIT_STATUS` every 2 min)                                                                     |
| Forward write-path fix (shared stable-filename helper, ~15 handlers)                                                                                     | Not done — real work, no structural blocker (MTDS is clean, no in-flight collision anymore)                 | None                                                                                                                                                                     |
...
| `available_at` broader ~20-handler fix                                                                                                                   | Not done — real work, no structural blocker anymore                                                         | None                                                                                                                                                                     |
