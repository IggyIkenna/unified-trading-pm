...
- **context-scout 2026-08-15**: re-scouted; context_scope unchanged (4 entries), still accurate — the sole open todo
  (warm git-object cache) still targets `fast-checkout.sh`/`glue-runner-run.sh` directly.
