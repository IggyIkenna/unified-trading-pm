...
> sampled-vs-walked per row; real-prod probes on `central-element-323112`. **One real batch≠live divergence surfaced +
> FIXED this pass (⑪).** Current LDR: mtds@202f5e0b · utl@fae6c23d · is@2971a064 · uac unchanged.
...
| ④   | Empty/partial honest + downstream batch=live   | 🟢       | CF-11 typed-empty/expected (not failure); SOURCE_RETURNED_ZERO within-bounds reclass; classifier-None NaN parity (Polymarket+Kalshi); shared MDPS candle finalize. WALKED (code + tests).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
