...
`import unified_api_contracts.market; import unified_api_contracts.execution; ...` (all 15 facades) **Domain init test**
(Phase 2.5): `from unified_api_contracts.canonical.domain import CanonicalTicker, CanonicalOrder, ...`
...
Pydantic models with camelCase fields from external APIs, and `from X import `\* patterns. These WILL trigger QG
failures if not pre-empted.
