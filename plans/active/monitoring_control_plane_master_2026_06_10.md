...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------- | -------------------------------------------------- |
| deployment-api/deployment-ui/e2e content → `main` (deployment-ui/AO/PM v2 GREEN + draining; **deployment-api LDR→staging v2 RED on PRE-EXISTING lint-codex file-size debt** — `data_status_service.py` 3734L / `deployments.py` 968L, NOT this session's files which are ≤790L; local QG green, CI counts stricter = the ci_local_qg_parity gap) | this plan + ci_local_qg_parity_2026_06_08.md      | IN-FLIGHT (dep-api gated on pre-existing debt)     |
...
| `ORCHESTRATOR_API_TOKEN` for the fleet-git-health proxy (live fleet data)                                                                                                                                                                                                                                                                        | ci_dashboard plan + pings/slot_3.md               | BLOCKED-CREDENTIALS                                |
