...
| `ORCHESTRATOR_API_TOKEN` for the fleet-git-health proxy (live fleet data) — **MOOT, corrected 2026-08-16 (plan_reconciler Phase -1): the sole cited purpose (deployment-ui's `/fleet` proxy route) no longer exists — deleted per the 🟡 PARTIALLY SUPERSEDED banner above (`deployment_ui_fleet_tab_removal_2026_07_27.md`, status: resolved); agent-orchestrator's own dashboard serves fleet git-health data directly and states no need for this token** | ci_dashboard + ikenna_orchestrator/pings/slot_3.md   | ~~BLOCKED-CREDENTIALS~~ MOOT                                                                                                                                                                                                                                                                                                                                                                                                      |
