---
doc_type: plan
title: DeFi consolidated close-out — history (contradiction-resolution audit + Progress Log, extracted 2026-07-24)
summary:
  Archive-bound history doc for defi_consolidated_closeout_2026_07_18.md — carries the 2026-07-18 canonical-target
  contradiction-resolution audit (75 findings, 95% closed — 7 of 9 tracked todos shipped) VERBATIM, plus the full
  chronological Progress Log (2026-07-18 through 2026-07-23, ~2090 lines). Extracted so the parent could come back under
  the 1000-line hard cap. The 2 still-open audit todos were relocated LIVE into the parent's Track 1, not archived here
  — see the parent for those.
status: complete
nature: record
asset_group: [defi]
stage: [meta]
...
source: >-
  ...
  1800-line historical log"). Content moved verbatim, no rewrite. The Contradiction-resolution audit's 2 still-open
  todos were relocated to the parent's Track 1 rather than duplicated here (single-copy conservation) — see the note in
  the audit section below for where they went.
---

# DeFi consolidated close-out — history (archived 2026-07-24)

> **Purpose.** This is the historical/archive-bound record for
> [`defi_consolidated_closeout_2026_07_18.md`](defi_consolidated_closeout_2026_07_18.md), split out 2026-07-24 (plan
> line-cap remediation) to bring the live parent back under the 1000-line hard cap. Nothing here was rewritten or
> summarized — every line below is a verbatim move from the parent. This doc carries two things: (1) the 2026-07-18
> canonical-target contradiction-resolution audit (75 findings; 9 tracked todos here, 7 already shipped/closed), and (2)
> the full chronological Progress Log. The parent plan remains the live tracker for Tracks 1-8 and all open work.
...
> **Relocated 2026-07-24** (plan line-cap remediation) — this todo (LENDING-retire consumer #3, UTL
> `_derive_instrument_id.py:76-77`, MOOT under the interim) was still open, so it was moved LIVE into the parent
> [`defi_consolidated_closeout_2026_07_18.md`](defi_consolidated_closeout_2026_07_18.md)'s **Track 1** (not duplicated
> here — Track 1 is the single source of truth for it going forward).
...
> **Relocated 2026-07-24** (plan line-cap remediation) — this todo ("Prediction is a THIRD shard-atom grain", the
> cross-AG PREDICTION-canonicalisation pointer) was still open, so it was moved LIVE into the parent
> [`defi_consolidated_closeout_2026_07_18.md`](defi_consolidated_closeout_2026_07_18.md)'s **Track 1** (not duplicated
> here — Track 1 is the single source of truth for it going forward).
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Glued-id manifest rebuild verify + delete `_migrated_` markers                                                                                                                                                                                                                            | **Part 1 + Part 2 BOTH COMPLETE this tick (sub-agent, 2026-07-23) -- Part 1's real result is 21 glued ids, NOT 0; report the real number per this task's own instruction rather than rounding down.** **Part 1 (0-glued-id check)**: after 3 failed attempts (a plain `pyarrow.dataset` read over `gcsfs` hit a thrift-deserialize error; two row-group-by-row-group scans, one plain and one GCS-generation-pinned, both still hit a hard `NOT_FOUND` mid-scan -- this bucket does NOT have GCS Object Versioning enabled, so a concurrent rewrite of `_index/availability_index.parquet` hard-deletes the exact generation a slow sequential read is targeting, and pinning the generation number does not protect against that), a 4th attempt succeeded: a PARALLEL 24-chunk byte-range download (all chunks pinned to one generation, minimizing the wall-clock exposure window to ~340s instead of the ~15-25min a sequential row-group scan needs) fully downloaded + parsed the then-current 933,194,484-byte / 23,477,224-row index. Applying the migration script's OWN `is_bundled_batch_leaf()` predicate to all 23,368,123 `asset_group=defi`+`capture_status=captured` rows found **21 glued-id rows** (not the hoped-for 0): **9 are the ALREADY-DOCUMENTED, already-tracked ORCA/SOLANA `dex_pool_state` residual cells for 2025-12-23..2025-12-31** (see `issues/mtds_defi_migration_cell_stall_untimed_gcs_read_2026_07_22.md`'s addendum -- these 9 day-cells have 5-8x the normal ~1,000-file fanout and their source bundles were deliberately LEFT INTACT after 2 stall/timeout rounds, pending a higher-timeout or parallelized-write retry; NOT a new finding, this row just confirms they still show up in the fresh manifest exactly as expected). **12 are NEW**: a single `liquidations` collection run stamped `20260723_013349` (2026-07-23, ~01:33 UTC -- hours before this tick) across AAVE_V3/COMPOUND_V3/GMX/FLUID/SPARK x 8 chains, still in OLD bundled-batch shape (`{venue}_{chain}_{ts}` leaf, no per-instrument split) -- these are simply pending, not-yet-migrated LIVE captures (the R3 historical migration's last pass predates them; they are NOT `_migrated_*` markers and do NOT touch Part 2's delete-candidate set at all), but they DO suggest the `liquidations` handler's forward-write path may still use the pre-R1 bundled convention rather than `write_defi_rows()`'s per-instrument shard -- not confirmed further this tick (the plan's "Forward write-path fix" row's "0 new glued objects across 8 consecutive live-GCS days" verification evidently did not happen to sample a `liquidations` collection run). Neither the 9 nor the 12 block Part 2 (they are un-split LIVE bundles, not retirement markers) -- flagging as a genuine, if narrow, follow-up rather than rounding to "0 confirmed". **Part 2a (total `_migrated_*` count) DONE**: 356,314 markers via server-side `match_glob` (2020-01-01..2026-07-23, 139s). By `data_type`: dex_pool_state 125,937, liquidations 68,263, lending_indices 50,338, dex_swaps 31,770, dex_pool_swaps 21,010, lst_rates 19,178, gas_fees 14,868, perp_funding 8,065, vault_share_price 7,327, oracle_prices 7,216, perp_daily_ctx 1,109, risk_params 854, perp_mark_price 316, dex_pools 63. **Part 2b (250-marker stratified sample safety-verify) DONE**: SAFE 132, SAFE_FILECOUNT_ONLY (>30 siblings, capped) 71, FLAGGED_NO_SIBLINGS 47 -- all 47 individually investigated: 36 genuinely 0-row (nothing to lose), 2 real dex_pool_state content (263+289 rows) fully covered by their `_needs_attribution/day={D}/{data_type}_{D}.parquet` twin, and 9 GMX perp_funding 1-row aggregate snapshots of which **4/9 have a needs_attribution twin but 5/9 do NOT** (days 2022-01-25/2022-04-11/2022-05-23/2023-01-10/2023-04-01 -- for these, the marker is the ONLY surviving copy, most likely a migration VM killed after retiring the source but before its end-of-run `_flush_needs_attribution()`). **Shipped + re-tested**: `market-tick-data-service/scripts/one_offs/delete_migrated_defi_markers_2026_07_23.py`, now a proper 3-leg check (0-row short-circuit -> sibling+row-count -> needs_attribution coverage fallback), dry-run default, `--apply` human-gated, deletes only SAFE/SAFE_NEEDS_ATTRIBUTION_COVERED via UTL `gcs_delete_object`, ruff-clean, re-verified against all 4 example cases exactly. **BLOCKED FROM SHIPPING (new finding, filed separately)**: committed locally (`market-tick-data-service@952618d1`) but `quickmerge.sh`'s full-suite re-gate failed identically TWICE (not a flake-once, a reproducible-twice block) on 2 tests totally unrelated to this change (`test_prediction_stays_prod_without_is_test_run` + `test_adapter_resolves_canonical_cefi_bucket_is_test_run_aware`, both pass in isolation) -- root-caused to a likely `monkeypatch.setenv("DEPLOYMENT_ENV","dev")` leak from `test_prediction_universe_prod_catalogue_gating.py`'s parametrized case surviving into a later test under `pytest-xdist -n 2`; full detail + evidence: `issues/mtds_deployment_env_monkeypatch_leak_blocks_quickmerge_2026_07_23.md`. The commit remains local + unpushed pending that issue or a future re-attempt. **HARD-STOP (unchanged)**: `/codex/02-data/gcs-and-manifest-delete-safety-protocol.md` hard-stop #1 + CLAUDE.md's "prod-bucket deletes are human-only" mean no `--apply` was run or will be run by any agent regardless of confidence -- that is a human/operator action, separate from and not blocked by the quickmerge issue above. | **Two independent follow-ups, neither gates the other**: (1) a **human/operator** runs `python -m scripts.one_offs.delete_migrated_defi_markers_2026_07_23 --apply` once the tool is pushed (blocked on the quickmerge test-flake issue above, or pull the local commit directly) -- gated on the prod-bucket-delete hard stop regardless. (2) The 21 real glued ids: the 9 ORCA cells need the already-recommended higher-timeout/parallel-write retry (tracked in the cell-stall issue doc); the 12 fresh `liquidations` bundles need someone to confirm whether that handler's forward-write path needs the same per-instrument fix `write_defi_rows()` already got, or whether a future scheduled R3 pass will simply pick them up as-is (they are not urgent -- 12 objects, not blocking anything). |
...
| Path shape pin (code portion) + kill second dexpool writer                                                                                                                                                                                                                                | **BOTH halves SHIPPED — fully done.** MTDS half: `market-tick-data-service@0fcfa803` (2026-07-22, quality-gates.sh green, 6814 passed) — root cause was NOT the historical bare-`0x<address>.parquet` writer (fixed 2026-07-09, confirmed dead via live-GCS read) but the REAL second writer, `live_tick_blob_path` (LIVE DeFi path, `mtds@3043f2dc1` 2026-06-26), which put `chain=` before `venue=`, diverging from the canonical batch order for ~1 month, undetected because `canonical_path_violations` never validated segment ORDER. Reordered `live_tick_blob_path` + pinned the `_PER_AG_SHARD_COUNTS["DEFI"]` regression test (drifted 2673→2592 by the unrelated concurrent `uac@9a047a31` phase-downgrade commit) + a new live/batch order regression test. **UAC half SHIPPED `unified-api-contracts@1cd27478` (2026-07-23)**: the paired oracle hardening (defi order/case/position check in `canonical_path_violations`, 4 new regression tests, 126 total UAC tests green including a zero-false-positive proof against every real `build_defi_partition_path` output). It had been left uncommitted, blocked on a pre-existing unrelated defect — by ship time that defect was ALREADY resolved by concurrent work (`uac@68c4c371` fixed `test_archetype_capability_manifest_parity.py`'s root-cause path resolution; the codex markdown sections were never actually missing, the test was reading a stale outer-root PM checkout). Re-verified directly: full `quality-gates.sh --no-fix` green, all 17 archetype-parity tests + all 89 `test_partition_path_is_canonical.py` tests passing, then shipped via quickmerge scoped to `unified_api_contracts/canonical/partition_paths.py` + `tests/unit/test_partition_path_is_canonical.py`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | None — done                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `deployment-service` `launch-canonical-migration-vm.sh` foreign WIP (defi-pi-range/defi-rebuild) -- STALE, already resolved                                                                                                                                                               | **RESOLVED 2026-07-22/23.** 3-way merged the stash against current HEAD (4 unrelated conflict hunks -- tradfi-cid/tradfi-manifest-cas/candle-census/candle-apply categories, none touching the stash content). QG green, shipped `deployment-service@065cf70`. Both `defi-pi-range` and `defi-rebuild` categories are live and have been used repeatedly this session for the full 2020-2026 manifest rebuild + targeted retries.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | None -- done.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
### 2026-07-23 (tick 5) — stall-timeout CLI override shipped; 9 residual large cells retried with extended budget

The 9 residual `ORCA/SOLANA/solana_amm_pool/dex_pool_state` cells (root-caused earlier this session to genuinely large
per-day pool counts, 4.7-8x the ~1,000-file baseline) needed either a longer per-cell timeout or parallelized writes.
Shipped the smaller, safer fix: a `--stall-timeout-seconds` CLI override on `migrate_defi_batch_to_per_instrument.py`
(default unchanged at 600s; existing callers unaffected) — `market-tick-data-service@5218837e`, 43/43 tests green (one
existing test updated: `_CELL_STALL_TIMEOUT_SECONDS` monkeypatching no longer works since the timeout is now a parameter
with a def-time-bound default, not a module global read at call time — the test now passes `stall_timeout_seconds=0.2`
explicitly instead).

Rebuilt the MTDS tarball (`--allow-dirty-tarball`, since a concurrent session's unrelated WIP — a one-off script +
`quality-gates.sh` + 2 test files, none on this script's import path — was sitting uncommitted in the shared checkout)
and relaunched the 9-cell retry scoped tightly: `defi-pi-range 2025-12-23 2025-12-31` with
`MIGRATION_EXTRA_ARGS="--venue ORCA --chain SOLANA --stall-timeout-seconds 1800"` (30 min budget, on-demand given the
zone's measured SPOT contention earlier today) — `canonical-migration-defi-pi-range-20260723-165602`, watchdog armed.

**Also independently rediscovered, then found already fixed**: verifying "0 glued ids" post-rebuild found 34 captured
rows still matching the glued-instrument-id regex. Before writing this up as a new finding, discovered a concurrent
session had already found the identical 34 rows, root-caused them correctly (the reshard tool is index-driven — these
objects existed on GCS before the 2026-07-21 sweep's manifest snapshot, so it never saw them), shipped a proper
`defi-glued-reshard` launcher category (`deployment-service@3345bf9`), resharded all 34 (242 new twins written), and
launched a 6-way parallel full-corpus rebuild to reflect it — see
`defi_lst_oracle_timestamp_glued_instrument_id_2026_07_20.md`'s "Update 2026-07-23" section for the full record.
Deferred to that in-flight work rather than duplicating it; watching for its 6 VMs to reach terminal before re-verifying
0 glued ids myself.

**Bonus finding, filed separately**: while running a scoped single-day rebuild to investigate the above, found every
KALSHI_PERP `perp_funding` object fails manifest emission (`source='kalshi_perp'` not registered in
`SOURCE_PRIORITY[("defi", "perp_funding")]`, which only allows `hyperliquid`) — objects exist on GCS but never get a
manifest row. Filed as `defi_kalshi_perp_perp_funding_source_not_registered_2026_07_23.md`; likely tied to the
KALSHI_PERP asset_group classification question already open in the distinct-values census audit, but the concrete
failing symptom is tracked separately since it's currently, actively dropping data from the manifest.

**Watchdog false-positive found + fixed (2026-07-23, post-compaction)**: the glued-check rebuild watchdog
(`watch_gluedcheck_rebuild.sh`) reported `TERMINAL[...]: instance no longer describable` for BOTH
`canonical-migration-defi-rebuild-20260723-143019` and `-142022` within moments of each other. Before trusting it,
re-ran `gcloud compute instances describe` directly for each — both came back `RUNNING` cleanly on the very next call.
Root cause: a transient `gcloud`/GCP-API connectivity blip (observed directly — `gcloud compute operations list` crashed
with `ConnectionError: Connection aborted... Remote end closed connection` in the same window) produces one empty
`describe` response, and the watchdog's original logic treated a single empty response as proof of permanent deletion,
with no retry — setting `done_flag=1` and permanently dropping both VMs from tracking even though neither had actually
terminated (no `EXIT_STATUS` marker, no `TERMINATED` status, nothing — they just kept running). This is a DISTINCT root
cause from the zsh word-splitting false-alarm earlier this session (that was a shell-scripting bug on my end; this is
upstream API flakiness), but the same failure class: **a monitor must not equate one transient probe failure with ground
truth.** Fixed by writing `watch_gluedcheck_rebuild_v2.sh` (retries `describe` 3x, 5s apart, before declaring
terminal-by-disappearance) and relaunching (Monitor task `b2u5d035u`) against all 3 still-running VMs (`-141001`,
`-142022`, `-143019`) — confirmed all genuinely `RUNNING` via a fresh direct check immediately before relaunch. No data
or progress was actually lost; this was purely a false alarm in the watch tooling, caught before acting on it.

**`-141001` (2026 range) finished cleanly**: `EXIT_STATUS=0`, 4,149,784 total shards (306 unparseable, 60,822 skipped
`_`-prefixed markers — correct per the writer's own skip-marker contract; 4,596 write_errors, ~0.11% — small enough not
to block on, worth a glance once all chunks land), self-deleted per `VM_SHUTDOWN_ON_COMPLETION=true`.

**`-143019` (2025 H2) hit a genuine SPOT preemption** shortly after, correctly caught by the v2 watchdog's
retry-before-terminal logic (15s of retries found nothing — a REAL loss this time, not the transient blip above).
Confirmed via `gcloud compute operations list`: `compute.instances.preempted`, DONE, 2026-07-23T17:05:10Z. `run.log`
showed clean progress to `date=2025-12-13` (24,471 shards scanned) at `17:03:58`, then stopped — no graceful shutdown,
no `EXIT_STATUS`. `--instance-termination-action=DELETE` (the launcher's SPOT default) explains why the instance
vanished entirely rather than sitting `TERMINATED`. Resumed from measured progress per the SPOT-preemption HARD RULE
(never replay the original start date): relaunched `defi-rebuild 2025-12-13 2025-12-31 full` as
`canonical-migration-defi-rebuild-20260723-183334` (kept SPOT default — first preemption on this slot, not yet a repeat
pattern). **This resumed run also finished cleanly moments later**: `EXIT_STATUS=0`, 410,652 shards (169 unparseable,
2,795 skipped markers, 391 write_errors), self-deleted.

Codified this as a standing rule (operator instruction, 2026-07-23): added a "Manual check-in on a SPOT VM: verify
preemption BEFORE diagnosing anything else" HARD RULE to `/codex/05-infrastructure/spot-vms-for-backfill.md` (the
`gcloud compute operations list` check + how to read presence/absence of `compute.instances.preempted`, using this exact
preemption-vs-false-positive pair as the worked example) + a terse pointer in `CLAUDE.md`'s SPOT bullet.

Watchdog now down to 1 VM: `-142022` (2022-04-29..2024-04-29), tracked by `watch_gluedcheck_rebuild_v2.sh` (Monitor task
`bylxh27vg`).

**Parallel per-leaf-write fix shipped for the 9 residual ORCA/SOLANA cells** (todo #41's follow-up). Root cause
confirmed this session via two escalating controlled experiments (retry all 9 at 1800s → still 0 completions; isolate
ONE cell alone at 900s → still 0 completions), ruling out queue-starvation/contention and confirming the true mechanism:
`_process_cell()`'s per-leaf loop does a sequential `fs.exists` + `pd.read_parquet` + `fs.open(...).write` round-trip
PER distinct instrument, with no per-leaf progress signal visible to the cell-level stall watchdog — and these 9 cells
carry 4,688-8,072 leaves vs a ~1,000-file baseline, so the cumulative sequential cost alone exceeds any reasonable
per-cell timeout even with zero actual hang.

Fix: extracted `_write_leaf(fs, dest, group) -> bool` out of `_process_cell`, and fan the per-leaf loop across a bounded
`ThreadPoolExecutor(max_workers=min(16, len(per_leaf)))` only when `len(per_leaf) > _LARGE_CELL_PARALLEL_LEAF_THRESHOLD`
(200) — ordinary/small cells keep the exact prior sequential path (no thread-pool setup cost). Each leaf targets a
distinct destination path; no shared mutable state besides the already lock-guarded `stats` counters.

Hit the repo's 900-line file-size codex-compliance gate at 924 lines on the first pass (`Files exceed 900 lines`) —
trimmed comments/control-flow (docstrings, one inline comment, collapsing the 3-way apply/parallel/sequential branch
into a shared `oks` list) down to exactly 900 lines without touching logic; syntax + the 43-test unit suite re-verified
clean after each trim. Full `quality-gates.sh` green (242s), shipped as `market-tick-data-service@2ba4226e`.

Next: rebuild the MTDS tarball on this SHA and re-run the previously-poison cell(s) (day=2025-12-23,
`--venue ORCA --chain SOLANA`, or the full 9-cell batch) to confirm the fix actually resolves the hang in production —
not yet validated against real infra.

---

**`-142022` produced TWO MORE false-terminal alarms** before genuinely finishing — the same `gcloud describe` flakiness
recurring at a higher rate than the earlier fix accounted for. First: v2's `gsutil cat` (whole-file, no range) started
returning empty on this VM's now-larger `run.log`, and v2's logic OVERWROTE `last_date` with the empty result instead of
retaining the last known value — every heartbeat printed `142022=` with nothing even though the VM was healthy
(confirmed via a manual byte-range tail read each time). Fixed as `watch_gluedcheck_rebuild_v3.sh`: read only the last
~20KB via `gsutil cat -r "-20000"` instead of the whole file, and never blank `last_date`/`stall_count` on an empty read
(treat it as "no signal this tick", not a state change). Second: even v2/v3's 3x/5s `describe` retry (15s total) wasn't
enough once — a describe blip outlasted it, again independently confirmed `RUNNING` with clean progress moments later.
Widened to `watch_gluedcheck_rebuild_v4` (script content unchanged besides the retry function): 6x/10s (60s total) + a
second API path (`gcloud compute instances list --filter=name=...`) as a cross-check each attempt. No further false
alarms after that.

**`-142022` (2022-04-29..2024-04-29) then finished genuinely cleanly**: `EXIT_STATUS=0`, 5,527,313 total shards (0
unparseable, 123,205 skipped markers, 11,228 write_errors, 96 `vsp_reclassified_prelaunch`), self-deleted. **ALL 6
glued-id-reflecting rebuild VMs are now terminal, all exit 0.** Cumulative across all 6 chunks (2020-22, 2022-24,
2024-Q4, 2025-H1, 2025-H2 incl. its preemption-resume, 2026): the full 2020-01-01..2026-07-22 corpus has been walked
fresh, post-reshard.

Next: re-verify 0 glued ids against the now-fully-fresh consolidated manifest, then (dry-run only, myself) the
sanctioned `_migrated_` marker delete script — the `--apply` command goes to the operator to run, never executed by me.

---

**Re-verify already run (a different thread on this same row, concurrent with the above) — answer for the "Next" step**:
re-ran the same glued-id check against the now-fully-fresh consolidated index (in-region VM, same pattern as before).
Result: **still 34, same exact `instrument_id`s as pre-rebuild.** This is NOT the fix failing — direct GCS verification
(listing the KAMINO `day=2026-05-28` `lending_indices` directory) confirms zero glued-timestamp-named files remain, only
clean UUID-named per-instrument twins + one `_migrated_` marker, matching the reshard tool's own reported outcome (34
retired, 242 twins written). **Root cause of the persisting count**: the consolidated index is append/UPSERT-oriented
with no mechanism that prunes a row when its underlying object is later renamed/retired — these 34 rows were written
into the index by an EARLIER rebuild pass (before the reshard fix ran) and, once written, no further
`rebuild_defi_manifest` re-scan removes them, no matter how many times it runs. They are structurally the same "phantom
row" class as this plan's own separately-tracked "purge 1.79M dup + ~219.5K phantom rows" todo, not a distinct problem.
**Practical implication for the Next step above**: the manifest-level "0 glued ids" number will only reach 0 once that
phantom-row purge runs (it folds these 34 in) — chasing it via more rebuild cycles won't work. Full writeup:
`issues/defi_lst_oracle_timestamp_glued_instrument_id_2026_07_20.md` (2026-07-24 update).
