...
on option 1 vs option 2. **Update (slot-25, pre-compact re-check):** resynced MTDS to `behind=0`; contention now WORSE
(6→12 concurrent `quality-gates.sh` + 2 active quickmerges); scratchpad audit: nothing at risk. No retry11.
