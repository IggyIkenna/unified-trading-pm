...
- **na-eligibility-audit 2026-08-17 (cross-cutting tranche, dispatch agt-3931fd)** [body-hash:9983aa7ec3f148b9]: KEEP-NA, valid — Doc's own frontmatter `source:` field + 4 separate na-eligibility-audit Progress Log entries (08-02, 08-06, 08-07) cite an explicit dated operator ruling: 'Operator ruling 2026-07-17: all 5 folds as HUMAN plans' — this is Fold E, the LAST/live-trading-adjacent fold, reader-cutover+delete explicitly OPERATOR-GATED. Per the never-re-litigate rule this is KEEP_NA_VALID on citation alone; all 3 remaining todos (AWS TF leg, IAM+lifecycle join, alias sunset) are residual infra work under that same ruling, none stale (no evidence any is done elsewhere). Ruling/citation: Operator ruling 2026-07-17 (cited in bucket_estate_fold_design_2026_07_13 successor doc's `source:` field): 'all 5 folds as HUMAN plans' — this is Fold E, the LAST/live-trading-adjacent fold.
