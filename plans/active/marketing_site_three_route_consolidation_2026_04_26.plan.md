...
copy, signup form labels, codex SSOT, and admin tooling; lacks a per-prospect tailored layer between the Platform
walkthrough and Bespoke Tailoring (`/strategy-review` does not exist); and exposes long-form content (FAQ, founder
story) on public pages that should be gated.
...
| File                                                                         | Phase | Action                                                                                                                                                                                                                                         |
| ---------------------------------------------------------------------------- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `unified-trading-pm/codex/08-workflows/signup-signin-workflow.md`            | 0     | Insert Strategy Review + Platform walkthrough stages (§2.4b/§2.5 — Eval → Walkthrough → Review order); rename Regulatory Umbrella → Regulated Operating Models in marketing-context table cells; keep IM/Reg legal labels in §2.7.2 path table |
