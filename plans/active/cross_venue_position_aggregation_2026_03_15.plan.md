...
todos:
  ...
  - id: p0-uac-sports-arb-position
    content: |
      - [ ] [AGENT] P0. Add SportsArbPosition + SportsArbLeg to UAC canonical/domain/sports/arb.py.
        Export from sports/__init__.py and sports.py facade.
    status: pending
  - id: p0-uic-aggregation-messages
    content: |
      - [ ] [AGENT] P0. Add AGGREGATED_POSITIONS, PORTFOLIO_VIEWS, RISK_GROUP_UPDATES to
  ...
  - id: p0-uei-aggregation-events
    content: |
      - [ ] [AGENT] P0. Add 8 event constants to UEI schemas.py: POSITION_AGGREGATED,
  ...
  - id: p0-upi-re-exports
    content: |
      - [ ] [AGENT] P0. Update UPI schemas.py to re-export AggregatedPosition, PortfolioView,
  ...
  - id: p1-pbms-cross-venue-aggregator
    content: |
      - [ ] [AGENT] P0. Create CrossVenueAggregator in PBMS core/cross_venue_aggregator.py.
  ...
  - id: p1-pbms-mark-price-subscriber
    content: |
      - [ ] [AGENT] P0. Create MarkPriceSubscriber in PBMS core/mark_price_subscriber.py.
  ...
  - id: p1-pbms-aggregator-wiring
    content: |
      - [ ] [AGENT] P1. Wire CrossVenueAggregator into PositionTracker.process_fill() via
  ...
  - id: p1-pbms-greeks-aggregator
    content: |
      - [ ] [AGENT] P0. Create GreeksAggregator in PBMS core/greeks_aggregator.py.
  ...
  - id: p1-pbms-pnl-attribution-aggregator
    content: |
      - [ ] [AGENT] P1. Create PnLAttributionAggregator in PBMS core/pnl_attribution_aggregator.py.
  ...
  - id: p1-pbms-risk-group-aggregator
    content: |
      - [ ] [AGENT] P0. Create RiskGroupAggregator in PBMS core/risk_group_aggregator.py.
  ...
  - id: p1-pbms-sports-arb-engine
    content: |
      - [ ] [AGENT] P1. Create SportsArbEngine in PBMS core/sports_arb_engine.py.
  ...
  - id: p1-pbms-defi-health-aggregator
    content: |
      - [ ] [AGENT] P1. Create DeFiHealthAggregator in PBMS core/defi_health_aggregator.py.
  ...
  - id: p1-pbms-defi-lp-aggregator
    content: |
      - [ ] [AGENT] P1. Create DeFiLPAggregator in PBMS core/defi_lp_aggregator.py.
  ...
  - id: p1-pbms-defi-staking-aggregator
    content: |
      - [ ] [AGENT] P1. Create DeFiStakingAggregator in PBMS core/defi_staking_aggregator.py.
  ...
  - id: p1-pbms-cross-venue-recon
    content: |
      - [ ] [AGENT] P1. Extend ReconciliationEngine with reconcile_aggregated_positions().
  ...
  - id: p1-pbms-sse-aggregated
    content: |
      - [ ] [AGENT] P2. Add /stream/aggregated-positions SSE endpoint to PBMS
        api/routes/positions_stream.py following existing /stream/positions pattern.
    status: pending
    blocked_by: p1-pbms-cross-venue-aggregator
  - id: p1-pbms-config-extensions
    content: |
      - [ ] [AGENT] P2. Add aggregation config to PBMS config.py: aggregation_enabled,
  ...
  - id: p2-risk-subscribe-aggregated
    content: |
      - [ ] [AGENT] P1. Add AggregatedPositionSubscriber in risk-and-exposure-service
  ...
  - id: p2-strategy-consume-portfolio
    content: |
      - [ ] [AGENT] P1. Add PortfolioViewConsumer in strategy-service
  ...
  - id: p2-execution-publish
    content: |
      - [ ] [AGENT] P2. Add PBMS publisher to execution-service UnifiedPositionTracker
  ...
  - id: p2-pbms-rest-endpoints
    content: |
      - [ ] [AGENT] P1. Add REST endpoints to PBMS api/routes/:
  ...
  - id: p3-sports-commission-config
    content: |
      - [ ] [AGENT] P2. Commission rates as dict[str, Decimal] from
  ...
  - id: p3-sports-cross-venue-limits
    content: |
      - [ ] [AGENT] P2. SportsArbEngine.check_exposure_limits(max_exposure_per_selection).
        Sum total_backed+total_laid across venues. Log POSITION_LIMIT_CHECKED.
    status: pending
    blocked_by: p1-pbms-sports-arb-engine
  - id: p3-correlation-config-loader
    content: |
      - [ ] [AGENT] P1. Create CorrelationConfigLoader in PBMS core/correlation_config.py.
  ...
  - id: p4-tests-cross-venue-aggregator
    content: |
      - [ ] [AGENT] P0. Unit tests for CrossVenueAggregator: 9 cases -- single venue,
  ...
  - id: p4-tests-greeks-aggregator
    content: |
      - [ ] [AGENT] P0. Unit tests for GreeksAggregator: 6 cases -- same underlying nets
  ...
  - id: p4-tests-pnl-attribution
    content: |
      - [ ] [AGENT] P0. Unit tests for PnLAttributionAggregator: 5 cases -- single position
  ...
  - id: p4-tests-risk-group
    content: |
      - [ ] [AGENT] P0. Unit tests for RiskGroupAggregator: 7 cases -- same underlying nets
  ...
  - id: p4-tests-sports-arb
    content: |
      - [ ] [AGENT] P0. Unit tests for SportsArbEngine: 5 cases -- profitable arb,
        unprofitable, commission netting, single-venue no arb, mixed selections.
    status: pending
    blocked_by: p1-pbms-sports-arb-engine
  - id: p4-tests-defi
    content: |
      - [ ] [AGENT] P0. Unit tests for all 3 DeFi aggregators: DeFiHealth (6 cases inc.
  ...
  - id: p4-tests-integration
    content: |
      - [ ] [AGENT] P1. PBMS integration tests: fill on venue A + fill on venue B ->
  ...
  - id: p4-tests-schema
    content: |
      - [ ] [AGENT] P0. Schema tests in UAC: AggregatedPosition, PortfolioView,
  ...
  - id: p5-sit-end-to-end
    content: |
      - [ ] [AGENT] P1. System integration test in system-integration-tests/:
