...
| 6.5   | ✅ Backtest-replay infrastructure ships (inference cache + directive log + cutoff clamp + 6 tests) — uac@20567882 + trading-agent@33a7ae9                                                                                                                                                         | trading-agent-service QG (per-commit, 6 tests)                                                 | 2026-05-20 slot-3 |
| 7     | trading-agent-service workspace-qg green on live-defi-rollout                                                                                                                                                                                                                                     | per-repo workspace-qg (per-commit)                                                             | PENDING           |
| 8     | ✅ All manifest entries applied (M1-M6/PW1-PW2/F1/Q1-Q2/E1-E2/SR1/SA1/FC1 + 10-plan sweep); codex SSOT shipped (directive-pipeline.md + config-reloader-pattern.md); conflict-resolved final — PM@d7964d0dc                                                                                       | daily inventory-regenerator + plan-vs-codex doc-drift audit                                    | 2026-05-20        |
