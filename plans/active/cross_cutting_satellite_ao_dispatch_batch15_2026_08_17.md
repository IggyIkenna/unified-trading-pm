...
- [x] ✅ [AGENT] P2. Migrate Kamino's `supply()`/`withdraw()` uncited `0x01`/`0x02` discriminator bytes to Kamino's — execution-service@791f50d817 + evidence: quality-gates.sh (8767 passed, 22 skipped, 1 xpassed, 48 warnings)
