...
- [ ] [DATA] P1. **F1 — backfill instruments-service for CEFI venues MTDS has but instruments lacks historically**:
      ...
      fully ✅ once Kraken reaches 2026-06-18 (the monitor reports completion). **2026-08-07 (plan-reconcile
      agt-c6e8c7)**: completion NEVER recorded in the corpus 7 weeks after the 2026-06-18 ETA claim — sibling docs
      (mtds_venue_backfill_and_ops_hardening_residuals:157-161, cross_cutting_consolidated_closeout:320) still list F1
      Kraken open/verify. Verify against the IS manifest (KRAKEN-SPOT/FUTURES instrument-store coverage
      2020-01-01→2026-06-18) or re-run the idempotent IS daily CLI before flipping.
