...
- **na-eligibility-audit 2026-08-17 (cross-cutting tranche, dispatch agt-3931fd)** [body-hash:30ae01e1b38c4987]: KEEP-NA, valid — Doc is self-described as 'a historical/audit record, not itself gating anything' (top banner, verbatim extraction from the master coordinator). Two prior na-eligibility-audit passes (2026-08-02, 2026-08-08 round7) already confirmed KEEP-NA valid on this exact scope. Every open todo is either owned by a different doc (G1.code), gated on real multi-AG engineering dependencies (G1.dry-run, G1.run's explicit a/b/c prerequisites), or explicitly redirected to a named successor doc (G1.run-prediction → prediction_phase_ab_residuals_2026_07_24.md, active). Ruling/citation: na-eligibility-audit 2026-08-02 and 2026-08-08 (round7) both KEEP-NA valid; doc's own 'historical/audit record, not itself gating anything' banner; G1.run-prediction redirect to prediction_phase_ab_residuals_2026_07_24.md
