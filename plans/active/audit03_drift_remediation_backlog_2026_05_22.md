...
- [x] ✅ [AGENT] P1. **F-37b** (narrowed + relocated) — Genuine residual = the
      ...
      (best-of-both) — see its AUDIT-03 follow-up todo. Tracked there, not here.** — strategy-service@5b2e9924
      (hedge_ratio_writer.py:135 + decision_context_writer.py:148 both use resolve_bucket_name for catalogue_bucket,
      backfilled 2026-05-24)
