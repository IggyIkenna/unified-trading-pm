...
> _(path corrected 2026-07-26: it said `plans/archive/2026_08/…`, which is self-contradictory with "archived" and does
> not exist — the file is in `plans/archive/2026_07/`; verified 0 open / 30 done todos there)_. This doc carries
