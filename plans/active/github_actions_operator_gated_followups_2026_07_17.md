...
- [x] ✅ [REVIEW] P0. **RESOLVED 2026-08-08 — consolidated 20→1, root cause diagnosed, fix specified (not yet
      shipped).** **operator ruling 2026-08-08**: consolidate the 20 open issues down to 1, archive the rest, fix the 2
      real schema mismatches (Balancer pools / Deribit ticker), then retire the last remaining issue once the fix lands.
      **Executed live via `gh issue close`/`gh issue comment` against `IggyIkenna/unified-api-contracts`**: closed 19
      duplicates (#641, #660, #672, #683, #698, #713, #720, #729, #736, #758, #778, #791, #814, #825, #827, #843, #850,
      #862, #870) as dup-of-#880 (not false-positives — each is annotated as a correct daily detection of the same real
      condition); kept **#880** (2026-08-08, newest) as the single live tracking issue, verified via
