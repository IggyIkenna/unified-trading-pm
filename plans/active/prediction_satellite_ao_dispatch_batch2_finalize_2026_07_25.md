...
- [ ] [REVIEW] P2. **Reconcile the 5 distinct source docs.** batch2's 6 todos cite 5 different source docs
      ...
      **Done when**: all 6 source-doc updates are verified present with commit citations recorded in this plan's own
      Progress Log.
- [ ] [DOC] P2. **Correct `prediction_consolidated_closeout_2026_07_18.md`'s stale claims discovered during batch2's
