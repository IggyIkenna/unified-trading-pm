...
- [ ] [REVIEW] P2. **Reconcile `cefi_deribit_binance_futures_bundle_verification_2026_06_20.md`'s checkboxes** against
      ...
      `cefi_deribit_binance_futures_bundle_verification_2026_06_20.md` active (do not force-archive) and note what's
