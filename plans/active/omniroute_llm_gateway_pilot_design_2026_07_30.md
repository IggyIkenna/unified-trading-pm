...
locked_by:
locked_since:
context_scope: [/codex/06-coding-standards/model-tier-selection.md, agent-orchestrator/server/accounts.py, deployment-api/deployment_api/deployment_api_config.py, deployment-api/deployment_api/commentary/pipeline_uat.py]
---
