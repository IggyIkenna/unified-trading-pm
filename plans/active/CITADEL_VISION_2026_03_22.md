...
**Minimum bar to call the demo “Citadel-complete” for **code**: steps **1–2** + Tier 1 Playwright green. **Tier 2** (real service processes + readiness truthfulness) requires step **3** readiness probes and configured upstream URLs.
