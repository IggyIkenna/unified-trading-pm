...
- [x] ✅ [DATA] P0. **Migrate the live manifest (Surface B) — RE-VERIFIED LIVE 2026-07-25.**
      ...
      `CAS FINAL rc=0`). Fresh live read of `_index/availability_index.parquet` (2026-07-25, 5,902,157 rows) confirms
      this landed and held: FUTURE/OPTION `instrument_id` canonical (regex
