...
- [ ] [VERIFY] P0. **GATE — STILL OPEN. `20260727-041704` CONFIRMED ALL-8-PREEMPTED 2026-07-27 (slot-9, zero
      `EXIT_STATUS`, ops events confirm) — relaunched as `20260727-061325`, all 8 `RUNNING`.** No checkpoint exists
      (safe restart-from-0, wasteful — follow-up `mtds_chain_bundle_migration_no_progress_checkpoint_2026_07_27.md`). Do
      NOT re-launch again until terminal state verified (ETA ~5-6h), THEN run `assert_tradfi_derivative_ids_canonical`.
...
> `task_template.md` §3 finding J; content fully superseded by the "2026-07-21/22 continuation" section below, which
> says so explicitly) → verbatim history at
> `/plans/archive/2026_07/tradfi_manifest_content_recovery_completion_history_2026_07_24.md`.
