...
- [ ] [AGENT] P2. **Live sub-todo under the resolved VIX ruling above** — steps (1)/(2) in the item above now target the
      ...
      `feature_group_service._calculate_features`) are unchanged and still open. **Resolved (plan_reconciler 2026-08-09,
      agt-a3e83c, operator ruling BLK-345eb7ce, option B)**: `("tradfi","futures_chain")` remains policy-restricted to
