...
- [ ] [VERIFY] P2. **Two remaining `github_actions_operator_gated_followups_2026_07_17.md` items, combined into ONE todo
  ...
  - **Done when**: sub-item 1's utilization number is recorded in the source doc (measurement window, or flagged as an
    operator credential gap if BigQuery access is unreachable), and sub-item 2 is recorded as a pointer to
