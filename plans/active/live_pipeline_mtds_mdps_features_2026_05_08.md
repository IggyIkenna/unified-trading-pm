...
| Phase 11.4 — Deploy-Missing live-cluster UI button              | `todo` (`- [ ]`)                  | DEFERRED-AFTER-Phase-11.2 consumer wire-in (deployment-api endpoint that consumes `_LIVE_CLUSTER_LAUNCHER_SCRIPTS` + renders the Deploy live cluster UI action). Tracked in `deployment_ui_lifecycle_tabs_2026_05_08`. |
