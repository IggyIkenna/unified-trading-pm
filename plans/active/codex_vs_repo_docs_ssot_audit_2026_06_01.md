...
- **context-scout 2026-08-15**: re-scouted; context_scope unchanged (5 entries) -- documentation-standards.md +
  SSOT-INDEX.md + model-tier-selection.md + the phase3-hold-vs-reclassify ruling doc + check_repo_docs_ssot.py remain
  the accurate minimal set.
