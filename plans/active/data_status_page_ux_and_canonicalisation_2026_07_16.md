...
- [ ] [DATA] P3. _(NEW — side-discovery 2026-07-17, measured while root-causing the (A) legacy-values todo above)_
      ...
      **Deliberately NOT folded into the (A) todo**: sports keys on `("data_type","league_id")` (UAC
      ...
      > ### ⚖️ INVESTIGATED 2026-07-17 (workflow `wf_a5766faa`, survived all 3 adversarial lenses — 0 refutations).
                      ...
                      >   corrupting order — exactly the class that just cost tradfi 425,096 instruments.) Needs a pre-drain of the
...
- [x] [DATA] P1. ✅ _(Q2 — TRADFI blank instrument_type)_ — instruments-service@66258618 + Evidence below. **Root
      ...
      **Real scope** (live GCS read 2026-07-16): the manifest index (`_index/availability_index.parquet`,
      ...
      > ### 🔴 THE STRUCK-THROUGH "ADJACENT FINDING" ABOVE IS WRONG — CORRECTED 2026-07-17. **This migration
                                                  ...
                                                  >
                                                  > **Reproduced independently 2026-07-17** (surfaced by the sibling cefi/defi backfill; re-verified from scratch
                                                  > before recording, because it is an accusation against a completed+flipped migration):
                                                  > `Σ instrument_count` tradfi **47,149,715 → 46,724,619 = −425,096 instruments' coverage silently lost**.
                                                  > The very example cited above disproves the old explanation: for **CME 2026-06-28** the **CANONICAL object holds
                                                  > 74,005 rows** (OPTION 69,212 / COMBO 4,446 / FUTURE 347) — **exactly the original manifest count** — while the
                                                  > **LEGACY object holds 2,826** (OPTION 2,566 / COMBO 228 / FUTURE 32) — **exactly what the migration wrote**. The
                                                  > manifest was never stale; the migration read the wrong object.
                                                  >
