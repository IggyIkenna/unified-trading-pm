...
| 7   | Real `question`/`title` column (polymarket/kalshi adapters)   | P3 follow-up  | P3  | **OPEN — blocked 2026-07-17**: same CATALOG_COLUMNS collision + regen race; batch with row 5.                    |
