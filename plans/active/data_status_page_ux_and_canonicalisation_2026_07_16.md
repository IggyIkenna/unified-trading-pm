...
| 5   | Distinct `expiry` column in `CATALOG_COLUMNS`                 | P2 clean-LT   | P2  | **OPEN — blocked 2026-07-17**: live same-file agent + regen race; batch with row 7 (one schema change, one regen). |
