...
- [ ] [REVIEW] P1. **Reconcile every batch23 todo's evidence into its named source doc.** For each of the 5 todos,
      ...
      (todos 3-5) — do not trust a source doc's own copy of the evidence line, re-verify the cited commit actually
...
- [ ] [REVIEW] P1. **Check whether any source doc now has zero open todos** as a result of the reconcile above — if
      ...
      `[AGENT]`-tagged fenced-code-block design decision, that this batch does not touch).
