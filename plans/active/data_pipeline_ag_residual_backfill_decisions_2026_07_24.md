...
- [ ] [CODE] P1. **Residual defi DIVERGENT_EMPTY real-gaps (13,760, 2 classes) — backfill OR handler↔oracle data_type
      ...
      ASTER/GMX `perp_funding` (GMX half MOOT — REMOVED 2026-07-25, see `defi_gmx_venue_removal_2026_07_25.md`; ASTER
      decision still open), FLASHBOTS `mev_events`, PYTH `oracle_prices`, AAVE `governance_events`]. Candidate CSV
      ...
      — the 2026-06-22 triage (divergence CSV + measured first-capture cross-ref) split the post-`coverage_start`
                                                                                                                  ...
                                                                                                                  see `defi_gmx_venue_removal_2026_07_25.md`; ASTER decision still open), FLUID lending, AAVE `governance_events`,
