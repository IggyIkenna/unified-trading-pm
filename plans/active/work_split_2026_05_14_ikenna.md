...
12. **[ORPHAN-2026-05-14] `mtds_market_interface_test_failures_2026_05_14` cluster D** — prediction_market_venue_wiring:
    venue registry membership drift; test expects specific set of planned venues that doesn't match current canonical
    list. Sync test expectations with current `unified_api_contracts` prediction-market venue registry. (refactor 0.4×,
    ~1 = 0.4 cal)
