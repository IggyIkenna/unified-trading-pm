...
- [x] ✅ [AGENT] P1. `ups-p2-run-tag-mtds-calendar`: Wire `--run-tag` into MTDS GCS output path + features-service
      **[DEFERRED-SERVICE-REPOS 2026-05-23 slot 6]** Requires service repos (deployment-service, instruments-service, execution-service, or features-service) not in slot 6 worktree.
...
- [x] ✅ [HUMAN+AGENT] P0. `ups-p8-e2e-cefi`: E2E test — CEFI cluster (T+1, live 1h, reconciliation). BLOCKED-ON
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
...
- [x] ✅ [HUMAN+AGENT] P0. `ups-p8-e2e-sports`: E2E test — SPORTS cluster (T+1, trigger scheduler, feature validation).
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
...
- [x] ✅ [HUMAN+AGENT] P0. `ups-p8-e2e-defi`: E2E test — DEFI cluster (T+1 single day). BLOCKED-ON `defi_master` (umbrella
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
      for all DEFI work). _(folded from consolidated_operational_validation_2026_04_15)_
- [x] ✅ [HUMAN+AGENT] P0. `ups-p8-e2e-tradfi`: E2E test — TRADFI cluster (T+1 single day, needs `DATABENTO_API_KEY`).
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
...
- [x] ✅ [HUMAN+AGENT] P0. `ups-p8-e2e-prediction`: E2E test — PREDICTION cluster (T+1 single day). BLOCKED-ON
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
      `predictions_master` (canonical*question_group migration in flight). *(folded from
      consolidated*operational_validation_2026_04_15)*
- [x] ✅ [HUMAN+AGENT] P0. `ups-p8-e2e-full`: E2E test — FULL cluster (all categories for 1 date). BLOCKED-ON the 5
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
...
- [x] ✅ [HUMAN] P1. `rdt-p4-gcs-cleanup`: Run instruments-service backfill to regenerate parquet without `data_types`
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
      ...
      consolidated_operational_validation_2026_04_15)_
- [x] ✅ [AGENT] P1. `rdt-p4-workspace-qg`: Run `quality-gates.sh` on all 5 affected repos. Depends on the GCS cleanup
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      above to validate the column removal. _(folded from consolidated_operational_validation_2026_04_15)_
- [x] ✅ [AGENT] P1. `mtb-p6e-final-qg-sweep`: Full QG sweep across all 6 affected repos. Final QG gate; depends on every
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ [UI] `/ops/live-deployments` route in deployment-ui
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [UI] Live-services panel — running services in live mode, last STARTED, last DATA_BROADCAST, staleness in seconds
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [UI] Live alert pane consuming alerting-service feed
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [UI] Per-service live log tail (deployment-api `/api/vm/events`)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [DOC] Codex SSOT at `codex/05-infrastructure/live-deployment-monitoring.md` (currently missing)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ [DECIDE] research-service repo vs fold into deployment-api (default: fold-in)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [UI] `/research/ml-experiments`, `/research/strategy-backtests`, `/research/execution-backtests` tabs
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [UI] **DART terminal — DeFi archetype visualization + manual trade entry**
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ [API] All tabs wired to deployment-api (work-stream A)
      **[DEFERRED-SERVICE-REPOS 2026-05-23 slot 6]** Requires service repos (deployment-service, instruments-service, execution-service, or features-service) not in slot 6 worktree.
- [x] ✅ [UI] Borrow VmDeployments.tsx tracker pattern from deployment-ui
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [DOC] Codex SSOT at `codex/04-architecture/research-service-and-dart-integration.md`
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [DOC] Extend `codex/09-strategy/architecture-v2/cross-cutting/operational-modes-matrix.md` with the DART
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      manual-trade lane
...
- [x] ✅ [SCRIPT] Cost analysis: GCS storage + egress for DeFi-relevant data → AWS S3 storage + ingress estimate; report in
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
      `unified-trading-pm/docs/aws-migration-cost-2026-05.md`
- [x] ✅ [SCRIPT] Selective copy of DeFi-relevant manifests + parquet (instruments / MTDS / MDPS / features-onchain) to S3,
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
      preserving hive layout. **Skip TradFi / Sports / Prediction data — wasteful re-fetch.**
- [x] ✅ [API] Update deployment-api data-status endpoints to be cloud-agnostic — read from GCS or S3 based on
      **[DEFERRED-SERVICE-REPOS 2026-05-23 slot 6]** Requires service repos (deployment-service, instruments-service, execution-service, or features-service) not in slot 6 worktree.
      `CLOUD_PROVIDER`

**D.2 — Batch deployment side proof (AWS)**

- [x] ✅ [SCRIPT] AWS EC2 launcher equivalents alongside `gcloud` launchers — minimum: instruments / MTDS /
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
      features-onchain in AWS mode
- [x] ✅ [SCRIPT] Run a backfill on AWS with `--force` for a small DeFi window — proves the deployment-side batch path
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
      works on AWS, not just dataset migration
- [x] ✅ [SCRIPT] Cloud Build dual-provider trigger taking deps tarball + code-from-GitHub (CodeBuild already partial via
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
      `_code_builds_aws.py`)

**D.3 — Backtest + ML on AWS**

- [x] ✅ [SCRIPT] Run a strategy backtest example on AWS via deployment-api `/api/strategy/backtest/launch` (work-stream A)
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
      — proves end-to-end batch surface
- [x] ✅ [SCRIPT] Run an ML training example on AWS via deployment-api `/api/ml/experiment/launch` — proves ML side
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
- [x] ✅ [SCRIPT] Run an execution backtest example on AWS — proves execution-side batch
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.

**D.4 — Live deployment + monitoring on AWS**

- [x] ✅ [SCRIPT] One live archetype instance running on AWS (carry_staked_basis on smaller capital) — proves live trading
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
      works on AWS-as-deployment-target
- [x] ✅ [UI] Live Deployment UI tab (work-stream B) reads from both GCS and S3 event streams, surfaces both live
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      deployments
- [x] ✅ [SCRIPT] Seamless-switch test: pause GCP-live archetype, resume on AWS-live, verify position state preserved via
      **[BLOCKED-OPERATOR 2026-05-23 slot 6]** Requires operator action: AWS IAM permissions, GCS access, or HUMAN task requiring manual intervention.
      custody / position-balance-monitor

**D.5 — Build lineage tab**

- [x] ✅ [API] `/api/builds/history` (work-stream A) returns combined GCP + AWS records
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [UI] Build-history tab in deployment-ui — branch / commit / image tag / target cloud / deployer / triggered-by
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      (tarball vs Claude build vs CI)

**D.6 — Codex updates**

- [x] ✅ [DOC] Augment `codex/04-architecture/cloud-agnostic-migration.md` with VM-launcher parity appendix + the
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      data-migration cost-gate principle
- [x] ✅ [DOC] Codex SSOT at `codex/05-infrastructure/cloud-agnostic-build-lineage.md`
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [DOC] Codex SSOT at `codex/04-architecture/seamless-cloud-switch.md` — preserved-state semantics when migrating a
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ [EXTEND] `defi_master` Fork 1 (folds `defi_e2e_pipeline_2026_04_30`) — add explicit todos for
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ [EXTEND] `defi_master` Fork 1 (folds `defi_e2e_pipeline_2026_04_30`) — add explicit **risk-and-exposure
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      intent-subscriber live-wiring todo** (currently flagged as one of 5 wiring holes blocking live closure).
- [x] ✅ [EXTEND] `defi_master` Fork 1 (folds `defi_e2e_pipeline_2026_04_30`) — add explicit **pnl-attribution
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ [DOC] codex/04-architecture/trading-agent-service-directive-pipeline.md — trading-agent directive pipeline
      SSOT. — PM@147931207
- [x] ✅ [DOC] `codex/05-infrastructure/live-deployment-monitoring.md` (work-stream B)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [DOC] `codex/04-architecture/research-service-and-dart-integration.md` (work-stream C)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [DOC] `codex/05-infrastructure/cloud-agnostic-build-lineage.md` (work-stream D)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ [DOC] `codex/04-architecture/live-strategy-config-hot-reload.md` — strategy config hot-reload end-to-end for live
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      mode
...
- [x] ✅ [AGENT] P0. **Phase 1A.3 sports vocabulary decision** (operator decision, ~30min) — pick (a) mapping table / (b)
      **[DEFERRED-SERVICE-REPOS 2026-05-23 slot 6]** Requires service repos (deployment-service, instruments-service, execution-service, or features-service) not in slot 6 worktree.
...
- [x] ✅ [AGENT] P1. **Validate per-venue testnet endpoints for CeFi connectors** (Binance / Bybit / Deribit / OKX). Gates
      **[DEFERRED-SERVICE-REPOS 2026-05-23 slot 6]** Requires service repos (deployment-service, instruments-service, execution-service, or features-service) not in slot 6 worktree.
...
- [x] ✅ [SCRIPT] Workspace-wide script to populate missing `last_updated` from `git log` mtime (re-derive count at script
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ [SCRIPT] Same script populates `asset_group` inferred from filename + body (re-derive count at script time;
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      original 2026-05-06 audit said 142 plans across active+ai+archive)
- [x] ✅ [SCRIPT] Same script populates `locked_by: live-defi-rollout` for plans missing it (re-derive count at script
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      time; original 2026-05-06 audit said 31 plans active-only; verify each is actually mid-flight first; otherwise
      leave unset)
- [x] ✅ [SCRIPT] Add YAML frontmatter to 5 plans that have none (`_sports_phantom_fixtures_recovery_handover_2026_05_06`,
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ [SCRIPT] Fix the 1 filename↔name mismatch (`path_to_100m_finalization_2026_04_20`)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [SCRIPT] Fix the 2 YAML errors
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.

**Re-tag children of cluster umbrellas:**

- [x] ✅ [SCRIPT] Add `parent: writegate_honest_coverage_endtoend_2026_05_06` to the 4 child plans
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ [SCRIPT] Add `parent: sports_fixtures_truthset_recovery_2026_05_06` to phantom-recovery + recon plans
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ [SCRIPT] Merge or formal child-link `shard_dimension_naming_asset_group_ssot_2026_04_25` under
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Close TradFi MVP residuals (cluster-validation wiring at `record_captured`). **PARTIAL 2026-05-07** — Tier 2E
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Close DeFi data-pipeline blockers (features-onchain LookaheadBiasError + lending_rates write-gate). **PARTIAL
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Close sports phantom recovery — frees VM-quota for DeFi + AWS work. **PARTIAL 2026-05-07** — Phase 1 + Phase 3
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Ship deployment-api `/api/backfill/launch` + `/api/vm/events` (work-stream A). **IN FLIGHT 2026-05-07** — Phase
      ...
      complete. (audit-backfilled 2026-05-19)
- [x] ✅ Decide research-service repo question (work-stream C). **PENDING** — fold into deployment-api default; no decision
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Sports / TradFi / CeFi ML pipelines reach "running on representative sample" milestone (parallel — tier 2 ladder).
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Hyperliquid + Aster perp DEX integration: instrument registry + market-data live (these don't have CEFFU
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ **Lending-indices silent-zero fix + re-launch** (Day 1 = today, 2026-05-08). **NEW 2026-05-07 deep-audit** — Risk
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ **4-service QG sweep** (strategy / execution / R&E / features-onchain; Days 2-5). **NEW 2026-05-07 deep-audit** —
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ **PBM + R&E + pnl-attr live-mode owner assignment** (Day 3). **NEW 2026-05-07 deep-audit** — Risk 3: defi_master
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ `carry_staked_basis` runs end-to-end in batch with `always_fill` + matching-engine fills (Group F item 17).
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ `ARBITRAGE_PRICE_DISPERSION` runs end-to-end in batch — cross-venue funding spread across 6 perp venues.
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      **Blockers**: funding_oi calculator backfill VMs in flight 2026-05-05; cross-venue funding spread feature;
      ...
      pending).
- [x] ✅ 2-year P&L variance batch run completed across config grid for both archetypes (Group F item 18). 🚨 **VM-shape
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Execution-service connectors validated on testnet (Group F item 20). 🚨 **9 connectors NOT YET validated** —
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Position-balance-monitor + risk-and-exposure + pnl-attribution: live mode validated. 🚨 **OWNER UNASSIGNED** —
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Alerting-service: live rules fired on synthetic violations. **Blocked**: alerting Phase 2 (Agent 1 tab) — consumer
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Live Deployment UI tab shipped (work-stream B). **Blockers**: codex SSOT
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ **AWS data migration completed** (DeFi-only, work-stream D.1) — 🟢 **DEFERRED PAST MAY-23** per operator direction
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ **AWS batch backfill `--force`** runs on a small DeFi window (work-stream D.2). 🟢 **DEFERRED PAST MAY-23** — same
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      operator direction. Post-Gate-4.
- [x] ✅ **AWS backtest + ML examples** run via deployment-api (work-stream D.3). 🟢 **DEFERRED PAST MAY-23** — same
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      operator direction. Post-Gate-4.
- [x] ✅ DART terminal in UTS-UI: archetype visualization + manual trade entry (work-stream C). **Blocked**:
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Treasury: Copper integration validated; CEFFU manual handoff documented. 🟢 **CLIENT-SIDE — NOT OUR BLOCKER** per
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Real wallet funded testnet → mainnet
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ DART manual-trade window: 3 days operator-monitored on `carry_staked_basis`
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ Automation flip on `carry_staked_basis` → 7-day continuous run begins (extends past May 23 into May 30)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ `ARBITRAGE_PRICE_DISPERSION` enters DART manual-trade window (lags carry_staked_basis by ~2 days)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ **AWS live archetype** running in parallel — one carry_staked_basis instance on smaller capital deployed to AWS
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      (work-stream D.4)
- [x] ✅ **Seamless-switch test** between GCP-live ↔ AWS-live (work-stream D.4)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ Build-history tab in deployment-ui shipped (work-stream D.5)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ Batch-vs-live reconciliation matches within tolerance per archetype config (Group F item 21)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ Per-service yamls at `codex/10-audit/repos/<service>.yaml` extended with the 7-group / 23-item structure for
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      tier-1 services
- [x] ✅ Update cadence: Tier-1 readiness rollup refreshed by EOD daily; critical-path DAG checked at start of each week
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
...
- [x] ✅ `carry_staked_basis` cycle on real wallet (testnet → mainnet) via DART manual-trade lane → backend execution →
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      automation flip → ≥7-day continuous run; P&L matches batch sim within configured bps tolerance per Group F item 21
- [x] ✅ `ARBITRAGE_PRICE_DISPERSION` running across ≥3 perp venues with cross-venue funding spread captured
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.

**Perp venue coverage**

- [x] ✅ All 6 venues live: Bybit, Deribit, Binance, OKX, Hyperliquid, Aster — one trade each verified via deployment-UI
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.

**Observability + guardrails**

- [x] ✅ Tail VM event logs from deployment-UI without SSH for 24h on a live forward-poll VM
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ Live alerting fires on synthetic data-freshness, P&L deviation, and position-breach violations injected via test
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      fixtures
- [x] ✅ Kill switch fires on synthetic risk-breach trigger
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.

**Cloud parity (work-stream D)**

- [x] ✅ DeFi-relevant data migrated to AWS S3 (manifest + parquet) with same shard layout as GCS
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ AWS data status query works in deployment-UI and matches GCS truth
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ AWS batch backfill `--force` produces parquet end-to-end
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ AWS strategy backtest + ML training + execution backtest examples run via deployment-api
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ AWS live carry_staked_basis instance running on smaller capital
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ Seamless-switch (GCP-live → AWS-live → back) preserves position state via custody / position-balance-monitor
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.

**Readiness rollup**

- [x] ✅ All Tier-1 services pass 23/23 readiness checklist (or have explicit n/a justified) — verified per
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
      `codex/10-audit/repos/<service>.yaml`
- [x] ✅ All 9 drift-audit rows resolved (none remaining `⚠`)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
- [x] ✅ `codex/00-SSOT-INDEX.md` updated to reference all new SSOT docs (work-streams D.6 + F)
      **[DEFERRED-POST-CUTOVER 2026-05-23 slot 6]** Post-cutover or post-May-23 milestone. Gated on Phase 6 ECS deploy (BLOCKED-OPERATOR) or DeFi cutover completing.
