...
_Last regenerated: 2026-05-13 09:29 UTC via `scripts/plans/regenerate_active_plan_inventory.py`. Sorted by `cal_left`
...
| 18   | F · Trading prereqs  | 2-year batch backtest run: completed across config grid; P&L variance per archetype; **VM-shape profiled via synthetic benchmark (both archetypes)**                                                                                                                                                      | `cron:strategy-backtest-grid-` (launcher SHIPPED deployment-service@06f0a54+5914c83; 2 VMs RUNNING 2026-05-10) **+** `cron:synthetic-benchmark-matrix-` (Phase 5.B 8-VM matrix complete 2026-05-12; per-stage wall-clock/CPU/RSS/IO aggregated to `benchmark_report.{parquet,md}` at `gs://central-element-323112-benchmark-reports/`; mtds_read + strategy comfortably fit c2-standard-8; 4 failing stages await Phase 3.D reader wire-in)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 2026-05-13                                                                                                                                                                                                                                                                                                                                   |
