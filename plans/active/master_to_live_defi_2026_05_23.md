...
_Last regenerated: 2026-05-17 14:46 UTC via `scripts/plans/regenerate_active_plan_inventory.py`. Sorted by `cal_left` desc. TBD = baseline not yet filled by owner agent. Orphan = plan not referenced by master or any epic — should be folded into the appropriate epic._
...
| [`available_at_lookahead_bias_completion_2026_05_08`](./available_at_lookahead_bias_completion_2026_05_08.md) | cefi_master_2026_05_07 | design | 28/47 | 60% | 0.6 | — |
...
| **TOTAL** (69 plans) | 0 orphans, 0 TBD | — | — | **51% done** | **495** | — |
<!-- AUTO-INVENTORY-END -->
