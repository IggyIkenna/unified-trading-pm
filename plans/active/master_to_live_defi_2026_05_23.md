...
_Last regenerated: 2026-06-22 18:48 UTC via `scripts/plans/regenerate_active_plan_inventory.py`. Sorted by `cal_left` desc. TBD = baseline not yet filled by owner agent. Orphan = plan not referenced by master or any epic — should be folded into the appropriate epic._
...
| [`tradfi_data_completion_live_and_batch_2026_06_22`](./tradfi_data_completion_live_and_batch_2026_06_22.md) | master | infra | 5/7 | 71% | 1.4 | — |
...
| **TOTAL** (105 plans) | 0 orphans, 0 TBD | — | — | **57% done** | **237** | — |
<!-- AUTO-INVENTORY-END -->
