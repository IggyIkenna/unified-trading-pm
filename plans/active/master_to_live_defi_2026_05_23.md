...
_Last regenerated: 2026-05-20 06:47 UTC via `scripts/plans/regenerate_active_plan_inventory.py`. Sorted by `cal_left`
...
- [ ] [DOC] codex/04-architecture/trading-agent-service-directive-pipeline.md — trading-agent directive pipeline SSOT. —
      PM@<sha from task 5 commit>
