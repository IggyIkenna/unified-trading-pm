...
_Last regenerated: 2026-05-17 19:52 UTC via `scripts/plans/regenerate_active_plan_inventory.py`. Sorted by `cal_left` desc. TBD = baseline not yet filled by owner agent. Orphan = plan not referenced by master or any epic — should be folded into the appropriate epic._
...
| **TOTAL** (69 plans) | 0 orphans, 0 TBD | — | — | **53% done** | **478** | — |
<!-- AUTO-INVENTORY-END -->
