...
- **na-eligibility-audit 2026-08-21**: KEEP-NA, valid — reaffirms 2026-08-18 verdict; 2 open items unchanged
  (concurrency step-to-6 DEPENDENCY_BLOCKED on the Tardis N=1 slot still occupied by the live BINANCE-FUTURES
  backfill; Phase 4 tail-latency widen conditional/optional, unrun prologue analysis).
