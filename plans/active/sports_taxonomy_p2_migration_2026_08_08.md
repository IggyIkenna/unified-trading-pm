...
- [x] ✅ [REVIEW] P0. **Four-surface reconciliation after the migration**, per
      ...
      found+filed — `/plans/active/issues/sports_p2_raw_tick_live_writer_still_emits_trades_2026_08_15.md` (P0,
      root-caused) + `/plans/active/issues/sports_p2_reference_bucket_uppercase_regrowth_2026_08_15.md` (P0, site TBD).
      S1 oracle clean (40/40); S2/S4 not run (budget, stated).
