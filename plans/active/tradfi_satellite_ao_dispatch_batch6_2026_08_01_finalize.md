...
- [ ] [REVIEW] P1. **Reconcile all 4 distinct source docs.** For each of
...
- [ ] [REVIEW] P1. **Re-check batch6's own Deferred sections now that time has passed.** For the 3 too-large-or-risky
...
- [ ] [DOC] P1. **Archive `tradfi_satellite_ao_dispatch_batch6_2026_08_01.md`** via the standard 6-step ritual (per
