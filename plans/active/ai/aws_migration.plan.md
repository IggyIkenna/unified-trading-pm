...
repo_gates:
  - repo: deployment-service
    ...
    deployment: none
    business: none
    readiness_note: "C0: not started. BR N/A: deployment/migration plan — no commercial KPI or user sign-off required."
  - repo: unified-cloud-config
    code: C5
    deployment: none
    business: none
    readiness_note:
      "C5: all quality gates passing. BR N/A: deployment/migration plan — no commercial KPI or user sign-off required."
