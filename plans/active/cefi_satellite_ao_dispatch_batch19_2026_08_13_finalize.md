...
> **Machine-gated on `/plans/active/cefi_satellite_ao_dispatch_batch19_2026_08_13.md`** (`depends_on` +
...
- [ ] [REVIEW] P2. For every completed todo in `cefi_satellite_ao_dispatch_batch19_2026_08_13.md`, reconcile the
...
- [ ] [REVIEW] P2. Once `cefi_satellite_ao_dispatch_batch19_2026_08_13.md` itself has zero open todos, run the standard
