...
> `/plans/active/data_status_page_ux_and_canonicalisation_2026_07_16.md` (P6 — Instrument catalogue explorer) as part of
> the plan line-cap remediation. That parent plan retains ~2000 lines of shipped history (P1-P10, including P6 Phase 1)
> as the durable record — read it for full P6 context (design guide, what exists, the MVP predicate, the phase-1 shipped
> commits). This child carries forward only the one still-open workstream: the Phase-2 true-catalogue source. The todo
> below is moved **verbatim** from the parent — nothing summarized or rewritten.
