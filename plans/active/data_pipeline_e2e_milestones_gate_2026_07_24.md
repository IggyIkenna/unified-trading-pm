...
| Point 3's tradfi/defi/prediction orphan-sweep re-measurements                                                                                | Partially done (defi/prediction measured by a concurrent session; tradfi/cefi/sports already had numbers)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | **CORRECTED 2026-08-16 (plan_reconciler)**: none — prediction's `B_legacy_duplicate` count was resolved `= 0` on 2026-08-30, per `estate_orphan_assessment_2026_07_21.md` todo 8's own `[x]` DONE entry                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
- **na-eligibility-audit 2026-08-17 (cross-cutting tranche, dispatch agt-3931fd)** [body-hash:bf5ab4d74bda2f7b]: KEEP-NA, valid — archive_exempt: true plus an explicit dated operator ruling makes this a standing reference/index surface with 0 open todos by design — reaffirmed KEEP-NA by na-eligibility-audit on 2026-08-02, 08-06, 08-07 and 08-08; this is the doc /plan-reconcile's own hunter 6 cites to verify every distributed todo actually landed in its target plan, an ongoing duty rather than a completed/archivable state. Ruling/citation: autonomous_session_operator_decisions_2026_07_25.md entry #10 (resolved 2026-07-26, option A): standing reference surface, not an archival candidate — 0 open todos is expected here even when fully 'done', since this doc's own todos read '✅ DONE — target: <file>' meaning distributed-not-shipped.
