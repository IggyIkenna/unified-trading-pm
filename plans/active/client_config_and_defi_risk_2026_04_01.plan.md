...
todos:
  ...
  - id: cc-2d-withdrawal-delay
    content: |
      - [x] [AGENT] P1. Model EtherFi/Lido withdrawal delays as liquidity risk
    status: done
    note: "EtherFi 2-week delay in stress scenarios"
  - id: cc-3a-ui-client
    content: |
      - [x] [AGENT] P1. Update UI for per-client config display + risk enhancements
    status: done
    note: ""
  - id: cc-4a-e2e
    content: |
      - [ ] [AGENT] P1. Add client config + risk scenarios to e2e-testing
    status: todo
    note: ""
  - id: cc-5a-docs
    content: |
      - [ ] [AGENT] P1. Update codex docs
    status: todo
    note: ""
