...
- **na-eligibility-audit 2026-08-21** (cross-cutting tranche): KEEP-NA, valid — reaffirms the chain of 4 prior audit passes (2026-08-17 x3, 08-19), unchanged: 9 open items — 1 [OPERATOR] design-ratification question (current-state+narrow-change-log vs monthly-snapshots vs full-row-versioning) + 7 direct dependents gated on it + 1 explicit non-scope deferred note (corporate actions). 2 of the original 11 items were already extracted 2026-08-17 to `cross_cutting_satellite_ao_dispatch_batch15_2026_08_17.md`.
