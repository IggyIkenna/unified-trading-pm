...
- `- [ ] [DATA] P2. VM fleet preemption auto-recovery has a real, already-tracked coverage gap for short-lived VMs`
  ...
  > VM names this note describes) as 2 of the 8 launchers the native-shutdown-script fix landed on 2026-07-30 — the gap
  > this note flags is now closed at the launcher level.
...
| VM fleet preemption early-boot blind window for smoke-test VMs             | FIXED 2026-07-30 (deployment-service)                                                                                                                                            | `/plans/archive/issues/vm_fleet_preemption_autorecovery_gap_2026_07_23.md` items 8-9 (resolved)                                                            |
