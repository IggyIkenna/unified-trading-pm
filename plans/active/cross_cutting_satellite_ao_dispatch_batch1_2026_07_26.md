...
- [ ] [DOCS] P2. **Reconcile the two bookkeeping-only residuals in
      `bucket_estate_consolidation_closeout_2026_07_24.md`** (cross-cutting, first AO batch for this doc). **⚠️
      SCOPE-FENCED 2026-07-31 (corpus-wide ownership-conflict sweep, operator ruling keep-one-cite-the-other): sub-item
      (a) is TRANSCRIPTION, not re-derivation.** The 3 dedicated DeFi buckets
      (`dex-pools-prd`/`lst-rates-prd`/`perp-funding-prd`) are owned end-to-end by
