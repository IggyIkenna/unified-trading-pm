...
> **🟡 IN-FLIGHT 2026-08-08 ~02:00 UTC — slot-9 running in tmux `orch-slot-9:backfill` (harness-kill-proof). Rolling
> boundary 2026-04-10 (7 chunks: 2020-06-06..2026-04-09). Chunk 1/7 EXIT_STATUS=0 ✅. Chunk 2/7 VM
> `expected-universe-v2-sports-20260808-015906` RUNNING (2021-01-01..2021-12-31) — partially seeded (~1M rows/retry,
> ~14+ retries so far across prior sessions). Chunks 3-7 pending. All 4 tarballs current (f3063b98). Resume:
> `tmux capture-pane -t "orch-slot-9:backfill" -p -S -20` or
