...
- **na-eligibility-audit 2026-08-17 (cross-cutting tranche, dispatch agt-3931fd)** [body-hash:e01a7c36a46c0a2a]: KEEP-NA, valid — Doc's entire thesis is that batch13 mis-classified this MDPS polars-adapter migration as AO-bounded; a concrete file-by-file survey found it's an atomic single-PR migration across an ABC/Protocol boundary (18 adapters, 5 needing genuine feature-engineering rewrites, correctness-risk on live candle production) already operator-deferred twice ('LATER migration') under 2 archived predecessor plans. The sole remaining todo is itself scoping/design work ('[DESIGN] P3: scope a dedicated implementation plan'), explicitly redirected to stay parked at its designated owner mtds_file_size_refactor_2026_06_08.md — exactly the CLAUDE.md-mandated 'resolve as a LOCAL plan first' step, not premature AO-bounded work. Ruling/citation: Operator-deferred twice ('LATER migration') per archived predecessor plans mdps_pure_polars_migration_2026_05_28.md and mdps_adapter_protocol_pandas_to_polars_2026_06_21.md; redirected to stay owned by mtds_file_size_refactor_2026_06_08.md ('this plan itself remains the owner').
