...
summary: "The daily manifest-hygiene-vs-GCS orchestrator found non-empty candidate lists for: tradfi. Finding-classes: schema_version_not_v9, oracle_expects_but_empty, noncanonical_path_on_disk, phantom_capt..."
status: active
nature: process
...
The daily manifest-hygiene-vs-GCS orchestrator found non-empty candidate lists for: tradfi. Finding-classes: schema_version_not_v9, oracle_expects_but_empty, noncanonical_path_on_disk, phantom_captured_no_parquet, shard_4pillar_fail.

Candidate list(s) (deterministic, machine-written):

- `/home/ubuntu/unified-trading-system-repos/.tabs/3/unified-trading-pm/plans/audit/results/manifest_hygiene_tradfi_2026_06_28.csv`
