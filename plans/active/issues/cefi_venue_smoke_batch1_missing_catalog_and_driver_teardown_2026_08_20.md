...
**2026-08-21 — slot 14 terminal rerun.** Current pushed MTDS code (`3d8b4d7b33c3`) ran with explicit staging configuration. VM `pipeline-e2e-check-mtds-20260821-005802-1aa1ea` reached terminal `EXIT_STATUS=1` at `2026-08-21T02:46:15Z`; phase-0 consolidation succeeded (`shards=1`, `rows_in=115470`, `rows_out=115470`). The retained report measured `total=294`, `passed=5`, `failed=77`, `ambiguous=0`, `skipped=212`, and no orphaned VMs. Reason counts included 54 `canonical_no_matching_objects_in_test_bucket`, 5 `vm_not_success:vm_self_deleted_no_exit_status`, 95 `tardis_guard_busy` skips, and 117 `no_captured_data_for_cell` skips; remaining failures were source-specific `no_parquet_under`/skip-signature failures. This is terminal RED evidence, not a zero-row success; P0 remains open. Evidence: log `gs://deployment-scripts-central-element-323112/vm-logs/pipeline-e2e-check-mtds-20260821-005802-1aa1ea/run.log`; JSON report `gs://deployment-scripts-central-element-323112/pipeline-e2e-check-reports/data_pipeline_e2e_check_mtds/2026-08-20/data_pipeline_e2e_check_mtds_2026_08_20_cefi.json`.
