...
- 2026-07-28 ~23:08-23:26 UTC (cicd, slot-4, `agt-ddd14c`, `ldr_qg_failure` on `instruments-service`, PR #1007): another
  ...
  14/15GB. PR #1008's `tests` job sat `in_progress` 51+ min zero progress (admitted-job- starves mode). Did NOT revert
  `self_hosted_runner_labels`; canceled the stuck job, triggered a fresh dispatch (`30407834160`), closed out without
  holding the slot. No repo-blocker; allowlist/VM untouched.
