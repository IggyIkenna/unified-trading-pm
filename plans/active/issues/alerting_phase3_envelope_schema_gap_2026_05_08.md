...
> **Severity**: P0 — was blocking Phase 3 producer migration. **Status**: ✅ RESOLVED.
> **Resolution**: operator chose Option A (extend envelopes with `code: AlertCode`); shipped end-to-end via UAC@2636815
...
- features-onchain-service emission sites — DEFERRED per Sub-B finding: the 5 DEFI_* codes target calculators that
