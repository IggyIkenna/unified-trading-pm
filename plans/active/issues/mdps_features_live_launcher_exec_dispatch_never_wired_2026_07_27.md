...
- [x] ✅ [INFRA] P2. Executed the 2026-07-30 operator ruling on BLK-fd70b57c: forked the undecided shard-discovery
      ...
      — the exec-dispatch code itself is not shippable until the enumerator lands) — unified-trading-pm, this commit.
      See `/plans/active/issues/uac_mdps_mvp_universe_data_type_axis_2026_07_30.md` + this doc's `depends_on` /
