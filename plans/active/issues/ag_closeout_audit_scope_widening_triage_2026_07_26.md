...
- [x] ✅ [DOC] P3 — unified-trading-pm@PENDING_SHA. Once the delta is fully classified, add a corpus-wide regression
      check (or extend `check_ag_closeout_linkage.py`, which does not currently catch this class) so a future doc tagged
