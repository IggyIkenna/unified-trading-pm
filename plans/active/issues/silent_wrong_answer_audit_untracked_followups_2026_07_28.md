...
- **na-eligibility-audit 2026-08-17 (cross-cutting tranche, dispatch agt-3931fd)** [body-hash:71c8c1b9b53c3205]: KEEP-NA, valid — Sole open todo is an explicit [DESIGN] P3 item: define real per-data_type UAC seed_validator contracts for defi/sports. A 2026-08-15 implementation session already wired the tick-family half (safe, verified against live connectors) and found the two 'obviously matching' defi/sports candidate contracts (yield-shaped defi, sports odds) don't match live production writer schemas at all -- a bigger finding than originally scoped, correctly left unimplemented with evidence and regression tests pinning the deliberate non-wiring. The doc's own text frames the remaining question as possibly needing a reframing of seed_validator's role itself -- genuine design work, not bounded implementation. Reaffirmed by 3 prior na-eligibility-audit rounds (2026-07-30, 2026-08-04, 2026-08-07).
