...
2. `plans/archive/2026_08/issues/deployment_api_artifact_pipeline_health_test_date_drift_flake_2026_07_29.md`
   (archived 2026-08-07, na-eligibility-audit — the fix had already shipped) — "Fix direction (not yet done)" prose;
   its Progress Log had already self-nominated for this sweep. Converted.
