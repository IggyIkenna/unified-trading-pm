...
| `defi_distinct_values_zero_noncanonical_dispatch_2026_08_04.md` · `defi_kamino_lending_venue_drift_live_data_verification_gap_2026_08_04.md` (archived 2026-08-11)                                                                                | defi                               | **NEW since 2026-08-02** — not this run's tranche, unclassified                             |
...
- **na-eligibility-audit 2026-08-17** [body-hash:5640a169553537d4]: KEEP-NA, valid -- 1 open item verified via grep (re-run the sweep at the next monthly /plan-reconcile pass), matching inventory. This is a deliberately-permanent standing register owned by the /plan-reconcile scheduled job's monthly cadence, not AO/operator judgment -- the doc's own § 'Genuinely informational' explicitly documents a twice-fixed duplicate-AO-dispatch bug (regen_backlog_from_plan.py) as the reason certain items in its OWN corpus stay checkbox-free, and the doc's standing-owner table names /plan-reconcile as owner precisely so the class does not lose ownership again the way it did twice before. Three prior na-eligibility-audit passes (2026-08-02, 08-04, 08-07) all reaffirm KEEP-NA on this identical reasoning. Not re-litigated.
