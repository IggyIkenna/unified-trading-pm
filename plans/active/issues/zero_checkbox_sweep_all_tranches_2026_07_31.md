...
| `client_reporting_api_promote_wedge_backmerge_dead_2026_08_06.md`                                                                                                                                                   | cross-cutting/ci                   | **RESOLVED 2026-08-09** (plan_reconciler agt-c80749, ci tranche) — the prose-only 4-step resolution was superseded by a structural fix (`shared_ci_workflow_repo_extraction_2026_08_06.md`), never converted to todos; `status: resolved` + archived, live-verified moot |
