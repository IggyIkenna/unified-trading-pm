...
2. `plans/archive/issues/deployment_api_artifact_pipeline_health_test_date_drift_flake_2026_07_29.md` (archived
   2026-08-04, na-eligibility-audit — was `plans/active/issues/...`) — "Fix direction
