...
- **na-eligibility-audit 2026-08-17 (cross-cutting tranche, dispatch agt-3931fd)** [body-hash:5640a169553537d4]: KEEP-NA, valid — Deliberately-permanent standing register (own text, twice: 'NOT archive-on-complete -- archiving is what orphaned this class twice already'), owned by the /plan-reconcile scheduled job, not AO dispatch. Re-confirmed KEEP-NA valid by na-eligibility-audit on 2026-08-02, 2026-08-04 and 2026-08-07 with consistent reasoning that flipping assigned_vm would cause backlog-regen to derive a perpetual duplicate re-dispatch -- the exact trap this doc's own 'Genuinely informational' section 3 warns against. Ruling/citation: Doc's own Progress Log: na-eligibility-audit 2026-08-02, 2026-08-04, 2026-08-07, all KEEP-NA valid.
