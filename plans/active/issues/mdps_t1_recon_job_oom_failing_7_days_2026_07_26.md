...
- [ ] [SCRIPT] P1. **Fix sports `odds_horizon_bucket`'s Path A½ honest-absence check silently suppressing ALL
      non-MATCH_ODDS candle output (MATCH_ODDS_LAY/ASIAN_HANDICAP\__/OVER_UNDER\__), always, regardless of whether real
      ...
      (2026-07-27, slot-11)**: full 3-layer trace + layer-2 fix shipped (`market-data-processing-service@ab0ccea`) in
      `issues/mdps_sports_odds_horizon_bucket_h2h_anchor_fix_2026_07_27.md` (this doc at 999/1000-line cap, zero
      headroom for inline detail); this todo stays open — layers 1+3 remain, see that doc for the design decision
      needed.
