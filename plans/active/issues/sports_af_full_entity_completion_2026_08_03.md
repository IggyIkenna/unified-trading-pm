...
| **STANDINGS**    | **all-383**                  | 108,662 expected, 76,292 already resolved, **32,370 needed** (was 64,439 on 08-04, **-32,069**) — **ACTIVE** via a separately-discovered dedicated VM, see below              |
| **TEAMS**        | **all-383**                  | 108,662 expected, 80,168 already resolved, **28,494 needed** (was 64,723 on 08-04, **-36,229**) — **ACTIVE** via `instr-backfill-sports-teams-20260805-055622` (chunk ~31/76) |
...
**Grand total needed, 2026-08-06T06:46Z: 124,571 across PLAYER_STATS+INJURIES+STANDINGS+TEAMS** (was 192,877 on 08-04, a
