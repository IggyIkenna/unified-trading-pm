...
| FIXTURE_STATS    | all-383 (widened 2026-07-28) | 66,291 expected (non-MVP), 227,195 already resolved, **43,883 needed** (new record acceleration, -1,244 this tick) — ACTIVE via `af-backfill-20260806-022033`                 |
...
| **STANDINGS**    | **all-383**                  | 108,662 expected, 84,876 already resolved, **23,786 needed** (was 64,439 on 08-04, **-40,653**) — **ACTIVE** via a separately-discovered dedicated VM, see below              |
| **TEAMS**        | **all-383**                  | 108,662 expected, 88,752 already resolved, **19,910 needed** (was 64,723 on 08-04, **-44,813**) — **ACTIVE** via `instr-backfill-sports-teams-20260805-055622` (chunk ~31/76) |
...
**Grand total needed, 2026-08-06T10:24Z: 107,403 across PLAYER_STATS+INJURIES+STANDINGS+TEAMS** (was 192,877 on 08-04, a
further ~44% drop — mostly STANDINGS/TEAMS backlog draining via a separately-discovered dedicated VM, see Progress Log)
**+ 102,406 across FIXTURE_STATS+FIXTURE_LINEUPS** (43,883 + 58,523). TEAMS/STANDINGS and FIXTURE_STATS are BOTH
