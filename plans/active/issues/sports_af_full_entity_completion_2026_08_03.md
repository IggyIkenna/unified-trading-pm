...
| FIXTURE_STATS    | all-383 (widened 2026-07-28) | 66,291 expected (non-MVP), 235,518 already resolved, **42,795 needed** (continued strong progress, -1,088 this tick) — ACTIVE via `af-backfill-20260806-022033`               |
...
| **STANDINGS**    | **all-383**                  | 108,662 expected, 85,529 already resolved, **23,133 needed** (was 64,439 on 08-04, **-41,306**) — **ACTIVE** via a separately-discovered dedicated VM, see below              |
| **TEAMS**        | **all-383**                  | 108,662 expected, 89,409 already resolved, **19,253 needed** (was 64,723 on 08-04, **-45,470**) — **ACTIVE** via `instr-backfill-sports-teams-20260805-055622` (chunk ~31/76) |
...
**Grand total needed, 2026-08-06T10:44Z: 106,093 across PLAYER_STATS+INJURIES+STANDINGS+TEAMS** (was 192,877 on 08-04, a
further ~45% drop — mostly STANDINGS/TEAMS backlog draining via a separately-discovered dedicated VM, see Progress Log)
**+ 101,318 across FIXTURE_STATS+FIXTURE_LINEUPS** (42,795 + 58,523). TEAMS/STANDINGS and FIXTURE_STATS are BOTH
