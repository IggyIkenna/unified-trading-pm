...
status: open
nature: issue
asset_group: [defi, cefi, cross-cutting] # tradfi removed 2026-08-09 (plan_reconciler agt-a3e83c) — 3 independent full-doc reads (08-06 ag-closeout-audit, this run's hunter+verifier) unanimously found zero tradfi-specific content.
stage: [data]
...
depends_on: []
context_scope: [
    # repointed 2026-08-09 (plan_reconciler agt-a3e83c) from 2 archived+resolved docs to the real current blocker
    # named in the 2026-08-08 Progress Log entry (VM premature-deletion root cause).
