...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| Corpus recompute (`run_cefi_perp_funding_corpus.py --start 2026-05-16 --end <today>` for the 6 CARRY_BASIS_PERP venues) — this doc's P1 todo                                                                                                                                              | Cannot be done yet — raw input absent for the 6 venues; compute would re-do only the frozen pre-gap days + honest-skip the gap, and `funding_window()` would still return empty for recent days                                           | Raw `derivative_ticker` for the 6 venues landing in the cefi bucket (2026-05-23→08-06 currently ~0 objects at the reader path) |
