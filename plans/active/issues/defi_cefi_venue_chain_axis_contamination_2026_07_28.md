...
- [ ] [DATA] P2. **2026-08-08 follow-up.** Root-cause and fix forward-cron venue gap — operator confirmed
      `cefi-fwd-daily-cron-*` resumed 2026-08-03 but NOT capturing
      BINANCE-FUTURES/BYBIT/OKX-SWAP/KRAKEN-FUTURES/BITGET-FUTURES/BITFINEX-FUTURES `derivative_ticker` as of 2026-08-05
      (BLK-6363d525 addendum). Fix before backfill data ages stale.

- **slot-14 2026-08-08 (BLK-6363d525 answered — VM launched)**: GCS probe confirmed 2026-06-05→2026-08-08 absent for 5
  venues; `cefi-fwd-20260806-065837` terminated at 12/75 days (cefi_tardis archival premature). Option A approved;
  operator also confirmed forward cron resumed 2026-08-03 not yet capturing these venues → new P2 `- [ ]` above.
  **Backfill VM `cefi-fwd-20260808-110409` launched 2026-08-08T11:04Z for 2026-06-05→2026-08-05,
  `--data-types derivative_ticker`; all 4 tarballs fresh.**

## Deferred work after 2026-08-08

| Item                          | State                                                                                                                          | Blocked-on                               |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------- |
| P1 corpus recompute           | Cannot yet — raw gap 2026-06-05→08-05 being filled by `cefi-fwd-20260808-110409`; gated on TERMINATED + GCS probe verification | VM completion                            |
| Forward-cron fix for 6 venues | Not started — needs a fix worker                                                                                               | New P2 todo above; BLK-6363d525 addendum |
