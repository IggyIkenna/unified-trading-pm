...
- **P1 corpus recompute**: gated on `cefi-fwd-20260808-110409` TERMINATED + GCS probe verifying full gap coverage.
- **Forward-cron venue fix (6 venues)**: new P2 `- [ ]` above; not started, needs a fix worker.
