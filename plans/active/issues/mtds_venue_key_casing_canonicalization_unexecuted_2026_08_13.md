...
- **na-eligibility-audit 2026-08-17 (cross-cutting tranche, dispatch agt-3931fd)** [body-hash:ab15136692562597]: KEEP-NA, valid — Redirect banner (2026-08-16 Progress Log entry): the sole open todo (canonicalize WS_FEED_CONNECTOR_FACTORIES venue keys to uppercase per the 2026-07-10 operator ruling) was extracted verbatim to mtds_venue_key_casing_reverify_then_execute_ao_dispatch_2026_08_16.md. Verified live: status active, assigned_vm planning -- reclassifying THIS doc would create a duplicate dispatch mechanism alongside the one that already exists. Ruling/citation: /plans/active/mtds_venue_key_casing_reverify_then_execute_ao_dispatch_2026_08_16.md (status: active, assigned_vm: planning) -- extraction target per this doc's own 2026-08-16 Progress Log entry; also listed in this doc's own context_scope.
