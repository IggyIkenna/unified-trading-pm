...
2026-07-25**, see `/plans/archive/2026_07/defi_gmx_venue_removal_2026_07_25.md`, so this comparison point is now moot).
REC: add a 2026-07-18 correction banner (matching the existing `defi_master:260` pattern), NOT a blind find-replace.
