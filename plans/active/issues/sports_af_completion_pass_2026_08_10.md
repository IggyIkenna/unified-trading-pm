...
| ---------------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------- |
| **STANDINGS backfill** (`af-backfill-20260810-162910`)           | RUNNING, `2022-01-08`, ~581/2258 days (~25.7%)       | VM completion (real infra)         |
...
**Recommended NEXT item**: STANDINGS VM at `2022-01-08` (~25.7%). Monitor for `exit_code=0`; then launch TEAMS →
