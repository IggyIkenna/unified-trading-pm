...
| ---------------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------- |
| **STANDINGS backfill** (`af-backfill-20260810-162910`)           | RUNNING, `2021-12-30`, ~572/2258 days (~25.3%)       | VM completion (real infra)         |
...
**Recommended NEXT item**: STANDINGS VM at `2021-12-30` (~25.3%). Monitor for `exit_code=0`; then launch TEAMS →
