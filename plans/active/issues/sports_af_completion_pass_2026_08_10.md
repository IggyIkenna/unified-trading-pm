...
| ---------------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------- |
| **STANDINGS backfill** (`af-backfill-20260810-162910`)           | RUNNING, `2021-12-12`, ~554/2258 days (~24.5%)       | VM completion (real infra)         |
...
**Recommended NEXT item**: STANDINGS VM at `2021-12-12` (~24.5%). Monitor for `exit_code=0`; then launch TEAMS →
