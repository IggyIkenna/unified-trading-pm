...
| ---------------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------- |
| **STANDINGS backfill** (`af-backfill-20260810-162910`)           | RUNNING, `2021-12-02`, ~531/2258 days (~23.5%)       | VM completion (real infra)         |
...
**Recommended NEXT item**: STANDINGS VM at `2021-12-02` (~23.5%). Monitor for `exit_code=0`; then launch TEAMS →
