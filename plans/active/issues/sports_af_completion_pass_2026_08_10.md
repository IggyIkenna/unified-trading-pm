...
| ---------------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------- |
| **STANDINGS backfill** (`af-backfill-20260810-162910`)           | RUNNING, `2022-01-21`, ~594/2258 days (~26.3%)       | VM completion (real infra)         |
...
**Recommended NEXT item**: STANDINGS VM at `2022-01-21` (~26.3%). Monitor for `exit_code=0`; then launch TEAMS →
