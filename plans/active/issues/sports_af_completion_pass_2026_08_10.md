...
## Deferred work after 2026-08-10 ~20:18Z

| Item                                                             | State / why deferred                                              | Blocked on                         |
| ---------------------------------------------------------------- | ----------------------------------------------------------------- | ---------------------------------- |
| **STANDINGS backfill** (`af-backfill-20260810-162910`)           | RUNNING, `2021-04-08`, pace ~16 dates/h (will decelerate), no ETA | VM completion (real infra)         |
