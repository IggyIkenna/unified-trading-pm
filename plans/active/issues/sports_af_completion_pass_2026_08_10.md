...
| ---------------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------- |
| **STANDINGS backfill** (`af-backfill-20260810-162910`)           | RUNNING, `2022-03-07`, ~630/2258 days (~27.9%)       | VM completion (real infra)         |
...
**Recommended NEXT item**: STANDINGS VM at `2022-03-07` (~27.9%). Monitor for `exit_code=0`; then launch TEAMS →
