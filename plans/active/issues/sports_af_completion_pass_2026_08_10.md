...
| ---------------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------- |
| **STANDINGS backfill** (`af-backfill-20260810-162910`)           | RUNNING, `2022-03-15`, ~638/2258 days (~28.3%)       | VM completion (real infra)         |
...
**Recommended NEXT item**: STANDINGS VM at `2022-03-15` (~28.3%). Monitor for `exit_code=0`; then launch TEAMS →
