...
| ---------------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------- |
| **STANDINGS backfill** (`af-backfill-20260810-162910`)           | RUNNING, `2022-01-28`, ~601/2258 days (~26.6%)       | VM completion (real infra)         |
...
**Recommended NEXT item**: STANDINGS VM at `2022-01-28` (~26.6%). Monitor for `exit_code=0`; then launch TEAMS →
