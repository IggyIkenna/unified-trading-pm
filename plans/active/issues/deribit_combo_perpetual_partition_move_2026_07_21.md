...
resolved_by:
  ...
  follow-on todos filed (an [OPERATOR] MVP-scope decision + a low-priority [DATA] bookkeeping-regen todo) — **UPDATE
  2026-08-09 (plan_reconciler agt-5f7f31): both now DONE, not open — the [OPERATOR] P2 MVP-scope decision was RULED
  2026-08-03 (line ~484) and the [DATA] P3 bookkeeping-regen decision was made the same session (line ~500), both
  checked [x] in the body below.**"
---
