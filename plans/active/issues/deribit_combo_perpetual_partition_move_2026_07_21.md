...
resolved_by:
  ...
  slot-14): a genuine Surface C v2 dedup-apply consolidation bug, not an intentional purge — see the 9th todo. Two
  follow-on todos filed (an [OPERATOR] MVP-scope decision + a low-priority [DATA] bookkeeping-regen todo); BOTH now DONE
  (2026-08-03 / 2026-08-05 respectively — corrected 2026-08-09, plan_reconciler, was stale 'both open')."
---
...
- [ ] [DATA] P2. **RULED 2026-08-06 (operator): proceed now.** Signed off to schedule the `--apply` against the full
      ...
      AO-dispatchable. **BLOCKED-OPERATOR — genuine sign-off decision, not worker-determinable, per §7.** Operator
      review of §7 (widened scope, live-fleet sequencing, code-fix-first ordering) before any `--apply` is scheduled.
      **Scope re-verified 2026-08-03 (task `deribit_combo_perpetual_partition_move-004`, slot 13)**: re-ran §2a's own
