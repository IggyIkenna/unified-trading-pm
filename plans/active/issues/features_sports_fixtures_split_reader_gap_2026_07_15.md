...
- `plans/active/sports_fixtures_schema_split_completion_2026_06_20.md` — the migration plan; "Already shipped" section
  names the UTL helper as already covering consumers (it does not, per finding #4 above).
