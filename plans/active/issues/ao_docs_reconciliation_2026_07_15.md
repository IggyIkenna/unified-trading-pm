...
| slot_venv_duplication_disk_pressure_2026_06_29          | ~~CURRENT-OPEN (needs-triage)~~ **TRIAGED-CLOSED 2026-07-17** | formal todo was added 2026-07-16 AND is now `[x]` with the live SSM measurement (verdict: guard-running-but-outgrown → cadence 2h + prune cron, via `ao_host_disk_pressure_2026_07_16`, archived). Doc stays open only for the operator-parked 30G stale-cache item. |
