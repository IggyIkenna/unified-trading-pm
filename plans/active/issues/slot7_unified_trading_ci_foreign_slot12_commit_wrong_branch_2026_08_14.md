...
- **context-scout 2026-08-16**: populated context_scope (3 entries — added `scripts/hooks/slot-identity-lib.sh`,
  named directly in this doc's own commit-identity-convention finding).
