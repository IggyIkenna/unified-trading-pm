...
- [ ] [DATA] P3. Exercise the 'Tardis venues still correctly refused' half of the launcher-guard fix during a genuine
      live MID-BACKFILL window — P2's own 2026-08-03 run had NO Tardis-consuming VM live, so that half 'stays open as a
      standing verification gap — re-verify opportunistically'; only the CAP-EXEMPT non-refusal half was proven.
