...
- [ ] [DATA] P2. **NEW 2026-08-15.** Purge/reclassify stale `attempted_failed` rows in `market-data-tick-tradfi`'s
      ...
      here; corrected again 2026-08-19, plan_reconciler — the Progress Log's own measurement is 10/1379 LACKING a
      captured counterpart, i.e. (1379-10)/1379 = 99.3% overlap, not the literal fraction 10/1379), ~97.6% of ICE's `attempted_failed` dates already
