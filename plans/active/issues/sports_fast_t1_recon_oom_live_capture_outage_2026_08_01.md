...
/plans/active/issues/stale_service_venvs_below_declared_fastapi_floor_2026_08_11.md` pointer at its Venv gotcha bullet
(the addition this todo's own P2 sibling could not land here directly, since the doc was already over cap). Every entry
from 2026-08-06 (slot 8) onward stays in this doc, below.
