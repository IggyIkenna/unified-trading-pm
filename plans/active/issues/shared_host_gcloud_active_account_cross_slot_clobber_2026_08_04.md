...
- [ ] [INFRA] P3. Alternative/complementary: give each slot its own NAMED gcloud configuration
      ...
      bootstrap tooling)
- **[DOC] P3. EXTRACTED 2026-08-09 -> `cross_cutting_satellite_ao_dispatch_batch4_2026_08_09.md`.** Document
      the `gcloud config set account` host-wide-mutation hazard in `/codex/05-infrastructure/per-tab-worktrees.md`
      § "Multi-agent safety". See the batch doc for the full scoped todo; do not duplicate-dispatch from here.
