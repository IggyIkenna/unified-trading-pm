...
source:
  - "found via git-stash pre-existing-failure baseline check while verifying
    ...
    todo's scope)"
context_scope: [/plans/active/ci_satellite_ao_dispatch_batch4_2026_07_31.md, /plans/epics/infrastructure_master.md, scripts/quality-gates-base/tests/test-setup-sh-uv-bootstrap-fallback.sh]
---
