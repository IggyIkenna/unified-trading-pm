...
- **na-eligibility-audit 2026-08-17 (cross-cutting tranche, dispatch agt-3931fd)** [body-hash:b2d279e3ff692b16]: KEEP-NA, valid — 0 open todos -- pure citable evidentiary record of 7 operator rulings issued and applied in one continuous 2026-08-15 session (own text: 'no separate confirmation todo needed here'). Its own precedent (operator_ruling_record_ao_round5_apply_session_2026_08_08.md, same doc class/purpose) remains in plans/active/issues/ over a week later, not archived -- consistent pattern for this doc class to stay as a standing citable home other docs' checkbox-flip evidence points to.
