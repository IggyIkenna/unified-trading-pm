...
Updated: 2026-05-08" and the file has not changed since 2026-05-22. The health digest computes **INDEX.md ↔ active-plans
drift = 99**: ~90 current active plans are absent from it, and ~8 of its entries point at plans already archived (e.g.
`cme_polymarket_arb_2026_05_08.md`, `instruments_master.md`, `market_tick_data_to_100pct_2026_05_05.md`). No regenerator
script exists — the only scripts touching `INDEX.md` are read-only checkers. The live, maintained index is the
`<!-- AUTO-INVENTORY -->` block in `plans/archive/2026_07/master_to_live_defi_2026_05_23.md` (regenerated by
