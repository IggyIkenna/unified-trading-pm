...
- [x] ✅ [SCRIPT] P2. **RULED 2026-08-06 (operator), option A [WORKER REC]: narrow the existing exception.** `[SCRIPT]`
      ...
      unified-trading-pm) — operator ruled option A 2026-08-06; carve-out shipped per
      `d4f7fab9d` (operator ruling 2026-08-02 batch).
- [x] ✅ [SCRIPT] P2. Once ruled: if A, implement the marker-only carve-out in `scripts/plan-hygiene/check_line_caps.sh`
      ...
      carve-out already in script; codex SSOT updated + regression test added
      (`tests/test_check_line_caps_marker_append.bats`, 8/8 pass); Phase-3 checkbox flipped with batch8 citation.
