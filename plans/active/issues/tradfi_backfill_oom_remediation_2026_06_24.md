...
- [ ] [DATA] P3. **Determine whether any downstream reader of tradfi/cefi single-instrument tick parquet
      ...
      yes/no outcome per reader; write the answer as a new dated finding in THIS issue doc. Target repos:
      `features-service`, `market-data-processing-service`, `instruments-service`.
