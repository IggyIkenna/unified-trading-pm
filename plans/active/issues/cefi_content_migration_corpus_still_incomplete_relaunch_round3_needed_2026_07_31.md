...
- [ ] [DATA] P1. Corpus-wide re-verify of round-6's 9 shards (16,17,18,19,21,23,40,41,42) — confirm each shard's
      `run.log` shows the terminal `SCRIPT 1 CONTENT MIGRATION SUMMARY` banner. Shards 18,21,40,42 still on round-5
      (`canonical-migration-cefi-content-<N>-round5-20260807-060729`); shards 16,17,19,23,41 on round-6:
