...
- [ ] [INFRA] P1. **`cefi-round8-midnight-prereq-flip` Cloud Scheduler job is permanently stuck failed — fix or replace
      it, then manually verify+flip `cefi-round8-budget-reset-2026-08-08` if the budget is genuinely reset.** Found
      2026-08-08 (slot 20, while verifying `ao_false_done_backlog_rows_and_unresolved_plan_refs_2026_08_08.md` item
      `-025`):
