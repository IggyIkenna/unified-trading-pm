...
- [ ] [DATA] P1. Relaunch the cefi content migration round-4 (tarball >= dc037373) to complete the 10 still-incomplete
      shards (13,16,17,18,19,21,23,40,41,42) — corpus 'done when' unmet, no relaunch in flight.

> **2026-08-06 archive-candidate audit**: Live unresolved migration — 10 shards (13,16,17,18,19,21,23,40,41,42) still
> incomplete, 'no relaunch is currently in flight', round-4 relaunch on tarball >= dc037373 recommended but not
> dispatched; corpus 'done when' unmet. [KEEP_OPEN todo synthesized from justification by archive sweep]
