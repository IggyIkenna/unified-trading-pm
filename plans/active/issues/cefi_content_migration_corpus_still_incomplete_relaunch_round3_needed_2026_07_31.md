...
- [x] ✅ [DATA] P1. Corpus-wide re-verify of round-5's 9 shards (16,17,18,19,21,23,40,41,42, VMs
      ...
      remainder. (repo: unified-trading-pm) — worker, slot 7, 2026-08-07: re-verified all 9. 4 dead (16,17,19,23):
      round-6 dispatched for 16 (`canonical-migration-cefi-content-16-round6-20260807-075919`) and 17 (already running
      by prior agent, `canonical-migration-cefi-content-17-round6-20260807-073935`); 19 and 23 at budget cap 2/2 today
      (deferred to 2026-08-08, resume frontiers documented in Progress Log). 5 still running (18,21,40,41,42) — forward
      progress confirmed, no terminal SUMMARY yet; tracked by follow-up todo below.

- [ ] [DATA] P1. Re-verify round-5 completion for running shards + launch round-6 for budget-capped shards — shards
      18,21,40,41,42 were still RUNNING in round-5 at 2026-08-07T08:05Z check; shards 19 and 23 were at the
      RB-INFRA-RELAUNCH ≤2/(vm-prefix,day) cap. (a) For shards 18/21/40/41/42: re-check each shard's `run.log` for the
      terminal `SCRIPT 1 CONTENT MIGRATION SUMMARY` banner after the VMs complete or are reaped; dispatch round-6 for
      any shard that fails before its terminal SUMMARY. (b) For shards 19 and 23: launch round-6 on 2026-08-08 (after
      budget resets) using the resume frontiers documented in the 2026-08-07T08:05Z Progress Log entry:
      19=2025-02-16..2025-03-17 (monotonic: last_completed=2025-02-15+1), 23=2025-09-07..2026-01-01 (non-monotonic:
      replay round-5 original start). Done when: all 7 shards terminal-verified complete OR round-6 dispatched for the
      remainder. (repo: unified-trading-pm)
