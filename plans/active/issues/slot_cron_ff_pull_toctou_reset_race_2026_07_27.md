...
- [x] [SCRIPT] P1. ✅ **DONE 2026-07-28 (slot 10)** — root-caused via live reproduction, see the canonical doc's todo 7
      ...
      ever triggering the preserve ref — reproduced exactly (matching reflog signature + missing preserve ref) against
      a scratch clone. Not a stale-PM-clone issue; the guard itself has an inherent TOCTOU race.
