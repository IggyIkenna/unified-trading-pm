...
- **na-eligibility-audit 2026-08-17 (ao tranche)** [body-hash:24ee848d2e464ac1]: KEEP-NA — the [BACKEND] durable-fix item is ALREADY claimed by the active `ao_satellite_ao_dispatch_batch22_2026_08_16.md` (its todo 5 cites this doc by path); leave open, do not duplicate. The [OPERATOR] slot-3-recurrence item stays KEEP-NA (operator-only live-infra action; a 2026-08-16 staleness note is a suspicion, not hard evidence of closure).
