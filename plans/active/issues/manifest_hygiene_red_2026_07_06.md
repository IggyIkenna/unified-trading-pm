...
tags: [manifest-hygiene, cefi, data-pipeline, daily-audit]
related: []
...
- `/home/ubuntu/unified-trading-system-repos/.tabs/13/unified-trading-pm/plans/audit/results/manifest_hygiene_cefi_2026_07_06.csv`
...
- [ ] [CODE] P1. Manifest hygiene RED — 1 AG(s) with findings (2026_07_06) — diagnose + fix the root cause
