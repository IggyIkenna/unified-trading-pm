...
- [ ] [DATA] P0 — **LAUNCHED VIA THE BROADER CHAIN, NOT YET CONVERGED (re-verified 2026-08-09, see note + Progress Log
      below — do not launch a separate VM; a guard-respecting chain already covers both windows, currently at chunk
      16/451, ~430 chunks from the target range).** UNBLOCKED 2026-07-29 (was `BLOCKED-CREDENTIALS` through 2026-07-28 —
      a 2026-07-29 mechanical rephrase pass, commit `6edd4486a`, had once already incorrectly stripped this line's
