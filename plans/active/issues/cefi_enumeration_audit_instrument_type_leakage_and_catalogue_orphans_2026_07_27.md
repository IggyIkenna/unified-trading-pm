...
- **RULED 2026-08-12 (/plan-reconcile, operator interactive)**: honor round5's technical finding — the sole open todo's
  ...
  is a SEPARATE, still-open question, not a reason to keep this specific migration todo gated. **Correction (2026-08-15,
  /plan-reconcile)**: no such separate todo was ever added to this doc despite the "new todo below" wording above — the
  only open item remains the `[DATA] P2` marker-format migration todo. If batch10's broader catalogue-orphan-disposition
  question is still live, it needs its own tracked `- [ ] [OPERATOR]` todo authored fresh (against whatever doc
  currently owns that question) rather than assumed to exist here.
- **execution_scope fix (2026-08-15, /plan-reconcile)**: frontmatter carried `assigned_vm: planning` +
