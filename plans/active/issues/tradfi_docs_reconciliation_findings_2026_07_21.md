...
- [ ] **[P1 L124]** MVP universe: '**CME BTC + ETH futures + options** (crypto index products on the TradFi venue)'. →
      ...
      option_underliers={ES})".
- [ ] **[P2 L297]** Open todo '- [ ] [BACKEND] P1. Massive dual-source shape parity + consolidator dedup-key omits
      ...
      omits source' todo (or mark it ~~struck~~ MOOT), and at L977-982 remove/strike the 'Rou
- [ ] **[P2 L278]** Open '- [ ] [BACKEND] P0. The ENTIRE tradfi availability index has schema_version typed as STRING —
      ...
      pinned yfinance==0.2.66 install after -e . --no-deps + image-import-smoke extended to i

### `plans/active/tradfi_massive_dual_source_2026_05_28.md` — 4 (P1,P1,P1,P2)

- [ ] **[P1 L7]** status: active — an entire plan whose reason for existing is to add Massive (formerly Polygon.io) as a
      ...
      2026-07-19: Databento = batch SoT, Yahoo = daily; dropped from SOURCE_PRIORITY, ru
- [ ] **[P1 L281]** 'Priority downgraded P0→P2 2026-07-12 … Databento is PRIMARY … Massive remains a documented fallback
      ...
      2026-07-19 (operator ruling: Databento = batch SoT, Yahoo = daily) — deleted from SOURC
- [ ] **[P1 L283]** Open `- [ ]` todos to (Phase 4b) rebuild MassiveTradfiRestConnector to emit canonical columns, wire
      ...
      cross-source parity test,
- [ ] **[P2 L359]** Open `- [ ]` todos to build the S3 flat-files bulk-backfill ingester writing
...
- [ ] **[P1 L316]** - [ ] [DATA] P1. NEXT — run Massive tradfi reference capture → regenerate catalogue → unblock gate-b
      ...
      removed as a tradfi source (operator ruling 2026-07-19, uac@a2beed46) and subscripti
- [ ] **[P1 L86]** All migration todos are unchecked `- [ ]`: 'C0 ONE bundled walk on the tradfi _index + objects'
      ...
      tradfi_v9_stage1_finish_2026_07_06.
- [ ] **[P1 L166]** COVERAGE GAP ... tradfi equities/ETF (NYSE/NASDAQ) were NEVER genuinely ingested — only the 0-row
      ...
      NYSE g01-g05, ohlcv_1m + ohlcv_1s, window 2023-2026 (XNAS/XNYS Databento discovery
- [ ] **[P2 L99]** multi-source cells (the 6 databento+massive/yahoo/barchart cells) emit two rows ... Notify
      tradfi_massive_dual_source to flip its Task -031 ... Stamp source via → FIX: Rewrite the three
      massive/barchart-bearing items to Databento+Yahoo only and mark the dead dual-source cross-links:
...
- [ ] **[P1 L174]** Sourcing = DATABENTO-FIRST (`SOURCE_PRIORITY[("tradfi", *)] = ["databento", "massive"]`; Massive is
...
- [ ] **[P1 L797]** P1 — important; post-current-gate: [`tradfi_massive_dual_source_2026_05_28`] status: active ·
      ...
      codex/02-data/tradfi-databento-sourcing-ss
- [ ] **[P2 L88]** Workstream-routing table routes manifest/pipeline_mode canonicalisation + phantom-audit residual to
      ...
      `[tradfi_manifest_canonicalisation_2026_06_01](../active/tradfi_manifest_canonicalisation_2026_
- [ ] **[P2 L195]** MVP backtest scope: S&P 500 (CME ES + ES.OPT + SPY) + BTC/ETH ETFs (NASDAQ IBIT, NASDAQ ETHA) +
...
- [ ] **[P1 L2059]** tradfi source-wiring row: "✅ WIRED | databento, massive | Multi-source; SOURCE_PRIORITY[("tradfi",
      ...
      KRX Korean underliers + FX/treasury indices); Notes = Live SOURCE_PRIORITY per _sou
- [ ] **[P1 L692]** Two full subsections present a live "TradFi dual-source (Databento + Massive)" capture model —
      ...
      semantics in a dual-source cell" (line 2071): "SUPERSEDED 2026-07-21 — Massive removed as a TradFi s
- [ ] **[P2 L365]** Temporary-state table + line 734: v9 source-column backfill for TradFi parquets is "pending operator
      ...
      no longer a pending Massive dual-source drain. Replace with a RESOLVED note: "Tr
- [ ] **[P3 L552]** AvailabilityRecord.source comment (line 552) enumerates current values "databento | massive | yahoo
      ...
      "massive" (removed 2026-07-19) / "barchart" (retired 2026-06-24) appear ONLY on legacy rows

### `plans/active/master_data_canonicalisation_migration_catalogue_2026_06_07.md` — 2 (P1,P2)

- [ ] **[P1 L79]** G5 governing sequence / WAVE 5 / G5 sub-plan registry frame the remaining post-migration work as
      ...
      Resume BACKFILLS → 100% honest coverage (UI drilldowns shrink to minor)"; line 216 →
- [ ] **[P2 L763]** R5-fix-6 (open todo): 'wire or retire the mtds MassiveTradfiRestConnector ... either wire it into
      ...
      [DATA] P2. R5-fix-6 — MassiveTradfiRestConnector RETIRED. Massive removed as a tradfi source

### `plans/active/tradfi_sp500_ml_and_arb_backtest_readiness_2026_06_20.md` — 2 (P2,P3)

- [ ] **[P2 L57]** Instrument / MTDS / MDPS data-clean ... is owned by tradfi_manifest_canonicalisation_2026_06_01
      ...
      ./tradfi_manifest_canonicalisation_2026_06_01.md (n
- [ ] **[P3 L117]** VIX features (compute_vix_features()) require VIX OHLCV from Barchart/Yahoo; those are not in the
      ...
      blocker (futures_chain/options_chain data_types absent from the TRADFI MTDS bucket), but replace t

### `codex/02-data/non-canonical-path-inventory.md` — 2 (P1,P2)

- [ ] **[P1 L198]** Row 10: "market-data-tick-tradfi-prd-{pid}/ — all objects under pipeline_mode=batch_massive …
...
- [ ] **[P2 L199]** Row 11 (no-migrate-first): tradfi legacy path shapes — MIGRATE_HYPHEN 100,698, MIGRATE_NONHIVE_EQ
      ...
      migration run `20260720-120911`, 20/20 shards ORPHAN=0, MIGRATE 848,886 objects → ca
...
- [ ] **[P2 L232]** §4 carve-out: "batch_massive — Massive was removed as a tradfi source 2026-07-19, but batch_massive
...
- [ ] **[P2 L125]** C2a parked as an OPERATOR-RULING-NEEDED open question: 'instrument_type COLUMN case — UPPER vs
      ...
      (operator ruling D1): UPPERCASE column, catalogue wins" header, strike the old "REC:

### `plans/active/tradfi_multisource_backfill_2026_06_22.md` — 1 (P3)

- [ ] **[P3 L257]** 'VIX cash-index DELETE + Databento floor-clip landed 2026-06-23 (instruments-service@814b14a);
      ...
      GCS-object delete `--apply` completed 2026-06-23 (1,621 objects

### `plans/active/canonical_id_p1_tradfi_combo_leg_canonicalization_2026_07_08.md` — 1 (P2)

- [ ] **[P2 L157]** Open todo: 'TradFi single-leg @LIN/@INV-YYYYMMDD extension - NOT implemented, needs its own
      ...
      migration). TradFi single-leg @LIN/@INV-YYYYMMDD extension for FUTURE/OPTION — IMPLEMENTED vi

### `plans/active/tradfi_v9_stage1_finish_2026_07_06.md` — 1 (P2)

- [ ] **[P2 L439]** - [ ] [DATA] P0. BLOCKED-PREREQUISITES (2026-07-13, slot-5). E7 verify — cf_manifest_audit ...
      ...
      2026-07-16 (corpus now 100% schema_version=9, blank pipeline_mode=0, blank source=0, per task

### `codex/02-data/pipeline-mode-partition.md` — 1 (P3)

- [ ] **[P3 L136]** Closed-set values table lists "batch_barchart — VIX 15m historical preload (2020-01-02 →
      ...
      15m now aggregates from VX futures via Databento (XCBF.PITCH → `

### `codex/02-data/four-surface-reconciliation-procedure.md` — 1 (P3)

- [ ] **[P3 L369]** §6 tradfi bullet: "batch_massive read-recognition is retained until the gated GCS purge, so a
      ...
      batch_massive objects removed, 0 collateral — see resolved issue massive_purge_blocked_databe

## Plus, from the tradfi reconciliation (data_pipeline_reconciliation_tradfi_2026_07_21):

- [ ] **[P0 DOCS]** 4 codex docs still call the Massive purge PENDING/human-only — it EXECUTED (0 objects everywhere):
      `non-canonical-path-inventory.md` row 10, `reconciliation-finding-taxonomy.md` AE-4,
      `gcs-and-manifest-delete-safety-protocol.md` §3.3, `tradfi-databento-sourcing-ssot.md`.
- [ ] **[P1 DOCS]** `non-canonical-path-inventory.md` register patch: row 10 RETIRE (massive purged); row 11 counts
      (hyphen→2); row 22 `_quarantine` (was ~15,813 → now DELETED 2026-07-21); row 24 `_needs_attribution` (DELETED);
      `_migration_backup_2026_07_09` (DELETED, was 158,808 obj/35.91GB).
