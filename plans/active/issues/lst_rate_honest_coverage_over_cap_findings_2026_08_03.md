...
- **na-eligibility-audit 2026-08-08 (Phase 2, defi tranche)**: Todo1+Todo2 clear the whole-doc bar (both `[SCRIPT]`-
  ...
  already live — `plans/archive/2026_08/defi_satellite_ao_dispatch_batch10_2026_08_06.md` carried an OPEN `[DOC] P2` todo ("Bring
  lst_rate_honest_coverage_2026_07_21.md under the 1000L hard line cap...") that explicitly cited this doc's own
  Todo1+Todo2 verbatim as its source — **now DONE (archived 2026-08-11, all 9 todos completed)**.
  `defi_satellite_ao_dispatch_batch9_2026_08_06.md` (line ~300) independently
