...
- [x] [SCRIPT] P1. ✅ **[HISTORICAL DETAIL for the DONE todo above — not a separate open item]** Operator ruling
      ...
      the 7 currently-hard checks. **Prerequisite, NOT done here**: the sweep scans the WHOLE `plans/archive/2026_08/`
      corpus, not just a commit's touched files — measured 2026-07-23, 30 pre-existing plans already violate
