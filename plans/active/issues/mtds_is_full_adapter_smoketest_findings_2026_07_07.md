...
- [ ] [FIX] P3. P2/P3 minor/cosmetic sweep — partial: `drift.py` class-docstring self-contradiction fixed (real source
      is SDK TS constants, not the dead Data API) and the SolBlaze/BlazeStake dead `/api/v1/exchange_rate` endpoint
      fixed (real live endpoint is `/api/v1/stats`, confirmed live 2026-07-10 — this one was NOT actually dead code,
