...
- **2026-08-10 (slot-25, infra)**: Flipped todo 3 — removed "falls back to deployed_versions from the PM manifest"
  ...
  `unified-api-contracts@ea9ca78b8f` + `deployment-api@c6267286be` (both QG green, verified on origin). Issue doc
  archived to `plans/archive/2026_08/issues/`. This active-path copy retained as transient M3-verification reference
  (`archive_exempt: true` — all 3 todos done, genuine archive at archive path).
