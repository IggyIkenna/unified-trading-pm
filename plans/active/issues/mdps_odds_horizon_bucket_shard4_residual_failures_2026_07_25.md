...
> again on a future full-mode re-run', with 'nothing currently re-polls just these 26 dates'. **RESOLVED 2026-08-09
> (plan_reconciler agt-196785)**: the deferred retry IS tracked as the `- [ ] [DATA] P3` todo immediately above (lines
> 195-197) — this note's "not tracked as a todo" claim is stale, left for the historical record.
