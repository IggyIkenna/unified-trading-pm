...
> new `unified-trading-pm/scripts/onchain_truth/` SSOT generator. **Suggested owner**: `defi_master_2026_05_07.plan.md`
> Phase X (new). Composes with: `defi_protocol_governance_parameters_refresh_2026_05_08.md` (overlaps on Aave rate
> params at the consumer side), `writegate_honest_coverage_endtoend_2026_05_06.plan.md` Phase 2.E (the
> `EXPECTED_PRE_GENESIS_CHAIN` taxonomy that depends on correct launch dates), and
> `mtds_streaming_and_backpressure_2026_05_07.plan.md` (the lending-indices VM uses these dates for pre-launch skip
> decisions).
