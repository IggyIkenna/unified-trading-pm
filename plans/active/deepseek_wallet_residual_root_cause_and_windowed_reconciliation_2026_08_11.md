...
- **context-scout 2026-08-16**: re-verified context_scope, no change needed (7 entries) -- no body content change since
  2026-08-15 (frontmatter `last_updated` bump only); all 7 entries still resolve.
