...
- [ ] [INFRA] P1. **RULED 2026-08-06 (operator): AUTHORIZED — proceed with the disposable-IP probe.** The
      ...
      **BLOCKED-DESIGN-SPEC, checked 2026-08-09 (slot 9, infra)**: the head banner's claim that "the probe design is
      already stated as ready in this todo's own text" does NOT hold — re-read the full todo + every referencing doc and
      found no target vendor/endpoint, request pattern, disposable-IP provisioning mechanism, or success/stop/ teardown
