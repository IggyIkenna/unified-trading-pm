...
- [x] ✅ [BLOCKED-CREDENTIALS] P2. **ICE data subscription — RESOLVED BY OPERATOR DESCOPE 2026-07-14** (verbatim ruling:
      ...
      reclass captured 1,620,826→1,608,382 (delta exactly −12,444) + attempted_failed 342,211→342,134 (delta exactly
      ...
      floor-clip had already reclassed ICE's EU to `empty_confirmed[EXPECTED_*]`; the live anomaly purged today was
      ...
      `instruments_mtds_subset_consistency_remediation_2026_06_17.md` §ICE/CME-tail.
