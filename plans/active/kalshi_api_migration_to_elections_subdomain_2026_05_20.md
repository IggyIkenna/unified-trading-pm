...
- [ ] [SCRIPT] P1. Run integration test: authenticate against new host + fetch sample market.
- [ ] [SCRIPT] P1. Verify MTDS Kalshi adapter end-to-end fetch.
- [ ] [SCRIPT] P1. Verify execution-service Kalshi paper-order flow.

## Phase 4 — Canary regression + QG wire-in

- [ ] [SCRIPT] P2. After cassette refresh: dispatch UAC `weekly-validation.yml` + verify Kalshi cassettes pass.
- [ ] [SCRIPT] P2. Add to predictions_master: Kalshi URL must point at elections subdomain as regression check.
