...
- [x] ✅ [SCRIPT] P0. Per-topic decision: **SNS+SQS fan-out** (default — at-least-once, lowest-friction) vs **EventBridge**
      ...
      at-least-once. Document the policy. **DONE 2026-05-23** (slot 7): Policy documented in
      `codex/05-infrastructure/cloud-agnostic-audit-2026-05-07.md` § 7.B — SNS+SQS for all 18 domain-event topics;
      EventBridge only if cross-account CodePipeline routing needed. AWS naming convention: `uts-{gcp-topic-name}`.
