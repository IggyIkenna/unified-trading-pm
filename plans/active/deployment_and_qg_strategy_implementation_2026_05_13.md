...
- [x] [AGENT] P0. `pnl-attribution-service`: 3 C901 (`_compute_hold_day_pnl`, `compute_pnl`, `aggregate_fills_to_pnl_inputs`). Extract-method aggregator; noqa pipeline-stages. (pnl-attribution-service@9f3379f — all 3 C901 fixed: noqa with rationale on pipeline-stages; already on LDR as of 2026-05-14)
