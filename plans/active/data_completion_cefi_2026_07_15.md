...
- [ ] [DATA] P3. **market-data-processing-service** — leading-NaN before first observation (tracked:
      `issues/mdps_state_adapter_leading_nan_audit_2026_05_29.md`, still open). "Confirm adapters route
      `_finalize_session_grid`" sub-ask **DONE 2026-07-26 (batch1 todo 2, `unified-trading-pm@f332e179c`)**: all 5
      route, no-grid/non-routing both intentional — fix itself stays open. **(MIGRATED 2026-07-13.)**
...
- [x] ✅ [DATA] P1. E6 CF-7: `attempted_failed` re-measured at 11.61% (1,060,613 of 9,138,791 rows) — retire the stale
      ...
      `/plans/active/issues/cefi_e6_cf7_relabel_and_attempted_failed_remeasure_2026_07_26.md`. **(MIGRATED FROM:
