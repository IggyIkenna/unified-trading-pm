...
- [ ] [REVIEW] P2. **Reconcile `candle_canonical_path_migration_execution_2026_07_24.md`'s checkboxes** against whatever
      ...
      `candle_canonical_path_migration_execution_2026_07_24.md` active (do not force-archive) and note what's still open
      here instead.
