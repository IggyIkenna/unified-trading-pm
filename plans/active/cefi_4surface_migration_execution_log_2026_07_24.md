...
summary:
  ...
  Content moved verbatim, nothing summarized or dropped — see conservation check in the split's commit.
status: active
nature: process
asset_group: [cefi]
stage: [meta]
...
source: >-
  ...
  index. Operator-approved via interactive Q&A 2026-07-23/24.
umbrella: true
---
