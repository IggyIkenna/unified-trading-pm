...
This plan was created by task `plan_hygiene_silent_failure_capture-020` to verify
the Phase 6 PM-pull + regen pipeline end-to-end. The plan is pushed to LDR and
the ingestion latency is measured.
