...
| Coinglass API key not obtained (liquidation-levels todo)           | `[RESOLVED]`  | [api_keys_and_auth.plan.md](api_keys_and_auth.plan.md) § todo `phase-3-coinglass` (added 2026-03-06)                                            | [RESOLVED 2026-03-06] — `phase-3-coinglass` todo added to api_keys_and_auth.plan.md; Coinglass API key added to Phase 3 table. Unblocked.                                                          |
