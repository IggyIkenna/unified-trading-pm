...
| [`wave3x_residual_ssots_2026_05_08`](../archive/wave3x_residual_ssots_2026_05_08.plan.md)                                   | Tracks A (UAC `HALF_DAY_SESSIONS` + `EXPECTED_PARTIAL_HALF_DAY` reason) + D (zero-activity-bar audit per CLAUDE.md 4-category rule)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | 5-track parallel plan; A + D in scope here                                                                                                                                               | G1 (reason taxonomy — Track A) + G2 (cluster validation overlap — Track D zero-activity-bar)                                                                                                         |
