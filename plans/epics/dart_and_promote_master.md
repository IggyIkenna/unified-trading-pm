...
Strategy archetype + portfolio_allocator + risk/position/pnl scope went to [`strategy_master.md`](strategy_master.md) (L2).
...
_2 active plans declare `parent_epic: dart_and_promote_master` in their frontmatter. Workers pick up in priority order (P0 first). Auto-populated by `scripts/plans/populate_epic_bodies_2026_05_21.py`._
