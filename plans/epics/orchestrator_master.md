...
| 9   | [`ao_docs_reconciliation_2026_07_15`](../active/issues/ao_docs_reconciliation_2026_07_15.md)                                                  | P1  | Meta-tracker. Remaining: X1 codex single-VM sweep + F1 (this epic's `assigned_vm`).                                                                                                                                                                                                                                                                                                                                                                               | keep open                                                                           |
...
| 12    | [`dp_alert_flood_triage_and_monitor_fixes_2026_06_23`](../active/issues/dp_alert_flood_triage_and_monitor_fixes_2026_06_23.md)             | 10/10 done verified. **🔴 NEW, live, undocumented: `uts-prod-tradfi-wave-launcher-cron` is `state: PAUSED` since `2026-06-24T22:44Z` (21 days), 0 `tradfi-bf-*` VMs running.** The OOM fix is real but **nothing has run to exercise it**. The doc's open todo #12 waits on a backfill that is not happening; the doc never mentions the pause. Its other open todo (stale-image risk) is **OBSOLETE** — `:latest` rebuilt today.                                                                                                                                                                                                                                         | **🔴 OPERATOR DECISION — unpause?** Data-pipeline heartbeat.                                                                        |
