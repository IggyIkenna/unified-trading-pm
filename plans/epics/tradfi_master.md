...
related_plans:
  ...
  - ../active/tradfi_satellite_ao_dispatch_batch2_2026_07_25.md
  - ../active/tradfi_satellite_ao_dispatch_batch2_finalize_2026_07_25.md
...
tokens as of 2026-07-21 — CODEX-GATED follow-up needed, same spirit as the line-183 codex-gated note above**): S&P 500
...
_9 active plans declare `parent_epic: tradfi_master` in their frontmatter. Workers pick up in priority order (P0 first).
...
### [`tradfi_satellite_ao_dispatch_batch2_finalize_2026_07_25`](../active/tradfi_satellite_ao_dispatch_batch2_finalize_2026_07_25.md)

**status**: active · **estimate**: 0.3 cal AI-days (class: infra) **title**: TradFi satellite AO batch 2 — finalize
(reconcile source docs + re-check remaining deferrals + archive)
...
### [`tradfi_satellite_ao_dispatch_batch2_2026_07_25`](../active/tradfi_satellite_ao_dispatch_batch2_2026_07_25.md)

**status**: active · **estimate**: 1.0 cal AI-days (class: infra) **title**: TradFi satellite AO batch 2 — re-triage
clearance from batch1's 33 conflict-gated deferrals
