---
doc_type: epic
title: Security & Cross-Cutting Master — shard / data-status / deployment-build umbrella
summary:
  L4 cross-cutting umbrella for infra — shard-axis matrix + data-status drilldown surface, VM launcher /
  deployment-build maturity, AWS↔GCP parity, and quality-gates.sh ratchet/debt content; every asset_group umbrella
  consumes the shard-axis endpoint shipped here. Renamed from `infrastructure_master` 2026-08-18 (epic-taxonomy
  restructure) after its CI-topic references (see `ci_master`) and UAC-topic references (see `uac_master`) were
  carved out — this is the narrowed remainder.
status: active
nature: process
...
related_plans:
  ...
  - ../active/cross_cutting_satellite_ao_dispatch_batch13_2026_08_13.md
  - ../active/cross_cutting_satellite_ao_dispatch_batch13_2026_08_13_finalize.md
...
# Security & Cross-Cutting Master — shard / data-status / deployment-build umbrella

> **Renamed from `infrastructure_master` 2026-08-18** (epic-taxonomy restructure,
> `/codex/11-project-management/epic-taxonomy-2026-08-18.md`) — this epic's CI-topic references (quickmerge, the
> LDR→main gate set, GitHub Actions workflow templates, release tagging) moved to
> [`ci_master`](ci_master.md), and its UAC-schema-governance references moved to [`uac_master`](uac_master.md). This
> is the narrowed remainder: shard-axis/data-status, VM launcher/deployment-build maturity, bucket estate, and
> quality-gates.sh ratchet/debt content. See the restructure plan's Progress Log for the full classification.
...
_Active plans declare `parent_epic: security_and_cross_cutting_master` in their frontmatter. Workers pick up in
priority order (P0 first). This list was last auto-populated pre-rename by
`scripts/plans/populate_epic_bodies_2026_05_21.py`; the CI-topic and UAC-topic entries it originally carried were
manually removed in the 2026-08-18 split (see `ci_master.md` / `uac_master.md` for where they moved) — a fresh
regeneration is tracked as Phase 3's README-registry-refresh todo._
...
### [`deployment_api_unauthenticated_prod_p0_2026_08_10`](../active/deployment_api_unauthenticated_prod_p0_2026_08_10.md)
**status**: active · **estimate**: 0.8 cal AI-days (class: infra)

### [`lazy_scoped_loading_refactor_2026_08_16`](../active/lazy_scoped_loading_refactor_2026_08_16.md)
**status**: active · **estimate**: 3.2 cal AI-days (class: refactor)
...
### [`venue_readiness_and_registry_hardening_2026_08_16`](../active/venue_readiness_and_registry_hardening_2026_08_16.md)
...
### [`deployment_api_unauthenticated_prod_p0_2026_08_10_finalize`](../active/deployment_api_unauthenticated_prod_p0_2026_08_10_finalize.md)
**status**: active · **estimate**: 0.24 cal AI-days (class: infra)

### [`empty_confirmed_and_coverage_correctness_audit_2026_08_15`](../active/empty_confirmed_and_coverage_correctness_audit_2026_08_15.md)
**status**: active · **estimate**: 7.2 cal AI-days (class: research)
...
### [`strategy_service_centralization_fixes_2026_08_16`](../active/strategy_service_centralization_fixes_2026_08_16.md)
**status**: active · **estimate**: 8 cal AI-days (class: infra)
**title**: >-

## P2 — useful; opportunistic

### [`aster_and_cefi_rolling_adv_feature_2026_07_21`](../active/aster_and_cefi_rolling_adv_feature_2026_07_21.md)
**status**: active · **estimate**: 1.5 cal AI-days (class: brand-new)
...
### [`cross_cutting_satellite_ao_dispatch_batch13_2026_08_13`](../active/cross_cutting_satellite_ao_dispatch_batch13_2026_08_13.md)
**status**: active · **estimate**: 10.7 cal AI-days (class: refactor)
**title**: cross-cutting satellite AO dispatch batch 13 — 2026-08-13

### [`cross_cutting_satellite_ao_dispatch_batch13_2026_08_13_finalize`](../active/cross_cutting_satellite_ao_dispatch_batch13_2026_08_13_finalize.md)
**status**: active · **estimate**: 0.4 cal AI-days (class: infra)
**title**: cross-cutting satellite AO batch 13 — finalize
...
### [`infra_satellite_ao_dispatch_batch17_2026_08_16`](../active/infra_satellite_ao_dispatch_batch17_2026_08_16.md)
**status**: active · **estimate**: 3.2 cal AI-days (class: infra)
**title**: Infra satellite — lc_gcloud_create migration for the remaining raw-create VM launchers (batch 17)

### [`infra_satellite_ao_dispatch_batch17_finalize_2026_08_16`](../active/infra_satellite_ao_dispatch_batch17_finalize_2026_08_16.md)
...
### [`strategy_service_centralization_fixes_finalize_2026_08_16`](../active/strategy_service_centralization_fixes_finalize_2026_08_16.md)
