...
todos:
  ...
  - id: p1a-batch-event-reader
    content: |
      - [x] [AGENT] P0. Create BatchEventReader class in alerting-service.
  ...
  - id: p1b-event-source-registry
    content: |
      - [x] [AGENT] P1. Define EVENT_SOURCE_BUCKETS constant.
        File: alerting_service/subscribers/batch_event_reader.py
  ...
  - id: p2a-main-batch-wiring
    content: |
      - [x] [AGENT] P0. Wire batch mode in main.py to use BatchEventReader.
  ...
  - id: p2b-cli-date-args
    content: |
      - [x] [AGENT] P1. Add --date and --end-date CLI args for batch mode.
        File: alerting_service/main.py
  ...
  - id: p3a-batch-delivery-mode
    content: |
      - [x] [AGENT] P0. Add batch delivery suppression to route_event().
  ...
  - id: p3b-batch-summary-report
    content: |
      - [x] [AGENT] P1. Add batch replay summary report.
  ...
  - id: p4a-unit-tests
    content: |
      - [x] [AGENT] P0. Add unit tests for BatchEventReader + batch delivery mode.
  ...
  - id: p4b-codex-doc
    content: |
      - [x] [AGENT] P2. Document batch/live alerting convention in codex.
  ...
  - id: p5a-qg-sweep
    content: |
      - [x] [AGENT] P0. Run quality gates on all touched repos.
