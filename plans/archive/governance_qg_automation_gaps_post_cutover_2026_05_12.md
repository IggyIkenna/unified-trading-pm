...
| G-5     | governance       | Plan-filename convention: `plans/archive/2026_08/` uses `<slug>.md`                                     | Date-suffix variant (`<slug>_2026_MM_DD.md`) — codify which is canonical or normalize                                                  |
