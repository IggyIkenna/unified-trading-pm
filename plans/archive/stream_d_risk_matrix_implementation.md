...
| `PortfolioPnLAttribution`    | UAC position/:151-168                      | 11 P&L fields + by_asset_group + by_strategy dicts             | EXTEND — add dict[RiskType, Decimal] alongside existing fields                                          |
