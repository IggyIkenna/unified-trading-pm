...
`agent8_e2e_tests_quality_2026_03_22.plan.md`.

| Step | Owner                         | What “done” means                                                                                                                                                                                                                                                                                                           |
| ---- | ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | **Agent 8 (remaining todos)** | Finish open items in agent8 plan (currently **~19 todo / ~21 done** — run `rg 'status: todo' plans/active/agent8*.plan.md` to refresh). Priority: **UI build + vitest** (`a8-p1-ui-build`, `a8-p1-ui-vitest`), then **Phase 8** verification todos (`a8-p8-*`: QG on API + UI, tier/readiness E2E, redundant mock removal). |
