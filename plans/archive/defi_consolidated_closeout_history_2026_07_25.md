...
> decision record — origin story for `/plans/archive/2026_07/defi_gmx_venue_removal_2026_07_25.md` +
> `/plans/archive/2026_08/defi_dex_pool_symbol_fix_backfill_purge_2026_07_25.md` — and the Solana AMM symbol-collision
> fix, which the resume-crons todo cites directly).
...
- [x] ✅ [DATA] P2. **cefi/prediction timestamp-provenance audit — DONE 2026-07-24.** Sampled prediction's core adapters
      ...
      [`issues/cefi_available_at_wallclock_despite_deterministic_row_timestamp_2026_07_24.md`](/plans/archive/issues/cefi_available_at_wallclock_despite_deterministic_row_timestamp_2026_07_24.md)
      and routed the code-fix work into `cefi_consolidated_closeout_2026_07_18.md` Track 6 (owning plan — out of scope
      for this defi-plan audit todo). No code changed by this touch. **MIGRATED TO:**
      `plans/active/cefi_consolidated_closeout_2026_07_18.md` (Track 6).
