...
[authentication/light-auth-briefings.md](/codex/14-customer-journeys/authentication/light-auth-briefings.md) spec
exactly — it is deliberately NOT Firebase auth (too heavy for post-first-call prospects).
...
Codex SSOT: [/codex/14-customer-journeys/glossary.md](/codex/14-customer-journeys/glossary.md),
[codex/14-playbooks/\_ssot-rules/02-tone-and-posture.md](/codex/14-customer-journeys/_ssot-rules/02-tone-and-posture.md).
...
### Investment Management briefing — gap vs [im-decision-journey.md](/codex/14-customer-journeys/experience/im-decision-journey.md)
...
### DART briefing — gap vs [dart-briefing.md](/codex/14-customer-journeys/experience/dart-briefing.md)
...
### Regulatory briefing — gap vs [regulatory-umbrella-briefing.md](/codex/14-customer-journeys/experience/regulatory-umbrella-briefing.md)
...
- **Audience terms** — [audiences-and-journeys.md](/codex/14-customer-journeys/audiences-and-journeys.md)
- **Product terms** — [glossary.md](/codex/14-customer-journeys/glossary.md) +
  [\_ssot-rules/04-dart-commercial-axes.md](/codex/14-customer-journeys/_ssot-rules/04-dart-commercial-axes.md)
- **Environments** — [environments/README.md](/codex/14-customer-journeys/environments/README.md)
...
- **Tone & posture (anti-patterns)** —
  [\_ssot-rules/02-tone-and-posture.md](/codex/14-customer-journeys/_ssot-rules/02-tone-and-posture.md) lines 56-77
- **Playbook grammar (9-section structure)** —
  [\_ssot-rules/01-grammar.md](/codex/14-customer-journeys/_ssot-rules/01-grammar.md)
- **Building-block dimensions (for pricing-adjacent copy)** —
  [\_ssot-rules/05-building-block-dimensions.md](/codex/14-customer-journeys/_ssot-rules/05-building-block-dimensions.md)
