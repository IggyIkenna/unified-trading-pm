...
related: []
created: '2026-04-17'
overview: Per-service client-isolation policy (shared vs isolated) + SLA tiers + runtime profiles + chaos/kill-switch primitives wired end-to-end across runtime-topology SSOT, UAC, UTL, deployment-service/api/ui, and affected services.
type: mixed
