...
> archive-on-resolve rule. Both todos [x] with root-cause + shipped fixes: OKX-FUTURES trades zero-capture fixed by
> overriding _instrument_to_okx_futures_inst_id (market-tick-data-service@bf69e612); POLYMARKET-PERP perp_funding fixed
> by correcting the UAC endpoint URL + working collector (market-tick-data-service@b2497b73,
> unified-api-contracts@845f7ce5); no residual prose follow-ups. Moved by the 2026-08-06 AO issue-doc archive sweep.
