...
> **📦 ARCHIVED 2026-08-22 (archival pass 2)** — BRIDGE resolved: `locked_by` placeholder cleared 2026-08-12,
> 0 open todos; this dispatch's archival pass 2 is the explicitly-deferred follow-on pass. Kept as a
> historical record (universe-filter suffix fix + VM tarball-staleness `auto`-mode default flip, both shipped).
