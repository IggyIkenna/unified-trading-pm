...
depends_on: []
resolved_by:
  "unified-trading-pm@66ffc2ffe (new scripts/hooks/check-locked-plan-deletion.sh at the commit-msg prek stage, dead
  quality-gates.sh:406-422 block removed; end-to-end verified with a disposable fixture doc — BLOCK without
  [unlock-plan], PASS with it, real prek output pasted into the Progress Log) + unified-trading-pm@2c61a8dc4
  (retro-cleared locked_by/locked_since on the one already-affected archived doc)."
locked_by:
---
