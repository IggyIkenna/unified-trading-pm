...
> archive-on-resolve rule. Fix shipped (unified-trading-pm@568cd6e17 --overrides extraction), both affected repos' full
> QG genuinely green exit 0 (PM 1687 passed, deployment-service 3066), cryptography pip-audit clean; todo #3 resolved as
> 'Not needed -- operator ruled it out'. Moved by the 2026-08-06 AO issue-doc archive sweep.
