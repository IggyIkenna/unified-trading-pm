...
resolved_by:
  "market-data-processing-service@d921823 (candle-layer orphan sweep built + 31 unit tests) + deployment-service@d75e8f3
  (+ff8eebe VM-name fix); run to full-corpus completion on 4 Tier-2 SPOT VMs (cefi/defi/tradfi/prediction). Parent
  tooling-gap doc mdps_features_ml_strategy_orphan_sweep_tooling_gap_2026_07_27.md todo 1 already closed (BLK-c8936baa)."
locked_by:
locked_since:
depends_on: []
---
