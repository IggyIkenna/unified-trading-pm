...
> archive-on-resolve rule. All 4 todos done: trailer-stamp doc fix, the already-shipped Stage-5 push-retry loop
> verified, the push_race repo-blocker condition shipped end-to-end 2026-08-04, and the check-branch-drift MERGE_HEAD
> exemption 2026-07-31; final context-scout 2026-08-06 confirms no open work. Moved by the 2026-08-06 AO issue-doc
> archive sweep.
