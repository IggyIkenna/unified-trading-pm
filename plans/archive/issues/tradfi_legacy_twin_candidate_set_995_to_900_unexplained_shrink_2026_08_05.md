...
> archive-on-resolve rule. Root cause determined ((d) report regenerated 2026-07-30 + (b) real GCS/manifest churn;
> (a)/(c) ruled out), fresh sweep confirms B_legacy_duplicate=900 (instruments-service@2ff3aa80), stale 995 corrected
> everywhere (unified-trading-pm@1b0f98c82); bottom line: 'No further action needed.'. Moved by the 2026-08-06 AO
