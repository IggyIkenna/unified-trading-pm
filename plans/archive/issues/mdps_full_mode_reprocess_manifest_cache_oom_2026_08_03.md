...
> archive-on-resolve rule. P1 root-cause + fix shipped (unified-trading-library@4dc12dbe, filters-threaded lookup) and
> P2 (slot-9) ran clean to completion 571 days with zero OOM; root cause confirmed by the tracemalloc repro. Moved by
