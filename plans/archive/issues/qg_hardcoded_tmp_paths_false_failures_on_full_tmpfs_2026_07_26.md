...
- [x] ✅ [OPS] P2. **DONE 2026-07-28 — operator personally registered both crons on ip-172-31-5-118.** RULED 2026-07-28
      ...
      separately (`/plans/archive/2026_07/issues/plan_reconcile_autonomous_sweep_2026_07_30.md` — filed 2026-07-30, this
      doc's claim of separate tracking was prose-only until then) — not re-verified as part of this todo's closure,
      since the specific host that triggered this doc is now confirmed fixed.
