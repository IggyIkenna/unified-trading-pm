...
`cited_somewhere` (covered by an archive/2026_08/self-dispatched plan) and 12 are `never_cited`. **Zero
genuinely-orphaned prediction-primary docs remain** — every one of the 12 never-cited candidates classifies
