...
> archive-on-resolve rule. All 7 recommendation todos executed (58 v2 post-floor rows migrated, 5,028-row policy DECIDED
> option (a), readers instrumented, classifier rescan done, migrate-forward closed); Progress Log 08-06 notes only that
> status frontmatter still reads open. Moved by the 2026-08-06 AO issue-doc archive sweep.
