...
> archive-on-resolve rule. Both script defects fixed (unified-trading-pm@a589efe05), the Finding-2 NA-orphan definition
> RULED by operator 2026-08-06 (option A) with SKILL.md and script now agreeing (re-ran cefi: 9 orphans, not 0), and the
> two mechanical corpus items archived/flipped; all 5 todos carry commit evidence. Moved by the 2026-08-06 AO issue-doc
> archive sweep.
