...
locked_by:
resolved_by:
  unified-trading-pm@6c4ee4d0c -- script repurposed into the fleet's release-stall alarm, verified still live
  2026-07-26; disposition ruled as codex SSOT /codex/08-workflows/ci-cd-flow.md:1004
depends_on: []
---

> **🟢 SUPERSEDED 2026-07-26 -- verdict superseded by measured reality; the disposition is now the ruled codex SSOT.
