...
> archive-on-resolve rule. All 4 todos [x]; 2026-07-29 entry confirms restore verified (hive_total=105,316, +1,677 over
> baseline), delete question 'closed permanently', and remaining flat-shape work is explicitly folded into
> instrument_availability_hive_migration_unrecognized_shapes_and_content_mismatch_2026_08_03.md (Progress Log: 'doc
> eligible for archival (no locks)'). Moved by the 2026-08-06 AO issue-doc archive sweep.
