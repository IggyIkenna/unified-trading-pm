...
`plans/archive/2026_08/instruments_mtds_subset_consistency_remediation_2026_06_17.md`, whose "reader cutover DONE"
covers `raw_tick_data`/deployment-api drilldown only — **not** `instrument_availability/defi`. The live daily writer
