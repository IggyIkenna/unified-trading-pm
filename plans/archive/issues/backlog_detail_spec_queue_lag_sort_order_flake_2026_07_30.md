...
> **🗄️ ARCHIVED 2026-08-06** — resolved as a confirmed duplicate. Same two `backlog-detail.spec.ts` tests, same root
> cause as `/plans/archive/issues/ao_dashboard_backlog_detail_queue_lag_e2e_flaky_2026_07_26.md`, which shipped the fix
> (`agent-orchestrator@e761cb1`, live-verified 2/2 passing across 3 runs). No open todos, no Deferred items. Surfaced by
> the 2026-08-06 AO issue-doc sweep.
...
- **na-eligibility-audit 2026-08-04** (autonomous, tranche `ao`): KEEP-NA-STALE re-affirmed — no change since the
