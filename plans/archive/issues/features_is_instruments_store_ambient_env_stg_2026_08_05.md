...
> archive-on-resolve rule. Both todos shipped with evidence: instruments-store sweep @4b2edbd5 and onchain compute-path
> leaks @21119021 + unified-trading-library@b078d5ba, both QG green + verified; the clean-benchmark-number re-run is
> explicitly tracked by the separate `data_pipeline_check_mdps_features-056` plan, not open work in this doc. Moved by
> the 2026-08-06 AO issue-doc archive sweep.
