...
> archive-on-resolve rule. All 8 todos `[x]` with verified shipped commits (hung->paging @ea594d60, `_is_backfill_vm`
> family @fde4f4f3, STALL_PROGRESS_REGEX @b2d135a1, PROGRESS.json checkpoint @54817bc1, tracking-gap close @9c4bfef,
> funding-ts fix @727e3ca); Progress Log 2026-08-06 confirms 'All todos now closed (todo 7 landed 2026-08-04); doc is a
> completion-candidate for a future archival pass' — the earlier 'left open' note referred to todo 7, now closed. Moved
