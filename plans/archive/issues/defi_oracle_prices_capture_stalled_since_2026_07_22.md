...
- [x] ✅ [INFRA] P2. **ANSWERED 2026-07-30 (slot-16) — a standing scheduler already exists**, so there is no
      ...
      deployment-service)
- [x] ✅ [DOCS] P3. **Fix the stale referrer in `plans/archive/2026_08/lst_rate_honest_coverage_2026_07_21.md`** — fixed
      body "Audit:" line `plans/archive/2026_08/issues/`→`/plans/archive/issues/` (frontmatter
      `related:`+`context_scope:` were already correct); condensed 8 repetitive VM health re-check entries into one
      summary to bring file from 1017 to 986 lines (below 1000-line cap). — `unified-trading-pm@4718f3532` (repo:
      unified-trading-pm)
