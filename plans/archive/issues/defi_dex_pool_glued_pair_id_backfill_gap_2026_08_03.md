...
> archive-on-resolve rule. Code fix shipped (instruments-service@7a86f13f), full catalogue regen completed on VM with
> 66,669 blank glued_pair_id confirmed as accepted state (DECIDED 2026-08-05), and the 13 residual format-bug rows
> cosmetically normalized (instruments-service@89092650); context-scout 2026-08-05 confirms all todos closed. Moved by
