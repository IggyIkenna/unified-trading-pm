...
superseded_by:
resolved_by:
  "features-service@e9430f0d (todo 1, _load_and_validate_candles pipeline_mode resolution), @2c6062ab (todo 2,
  bulk-preload _tf_cluster_helper fix), @615abbaa (todo 3, lookback-validation manifest-key fix + real-day end-to-end
  proof against prod GCS data), @be36b42b (todo 4, LookbackValidator._discover_instruments() same-gap fix). Full
  quality-gates.sh green on every shipped commit."
source: >-
...
- **2026-07-27 (slot 8)** — Independently arrived at the identical todo-1 fix (same helper name, same
  ...
  (`/plans/archive/issues/qg_5_83_adapter_contract_regression_workspace_scan_timeout_2026_07_27.md`,
