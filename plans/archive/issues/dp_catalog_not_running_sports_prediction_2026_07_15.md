...
> **🟢 ARCHIVED 2026-07-31 — RESOLVED.** All 6 tracked todos shipped (sports FTP frozen-tail merge
> `instruments-service@24f84e86`; prediction Cloud Run memory bump `deployment-service@6bfa284`; events-sink IAM grant
> `deployment-service@48d5e0d`; cefi dedup-aware monotonic guard `instruments-service@5c1c3ccb`) — `status: resolved`
> since 2026-07-30, 0 open todos remain (checkbox and prose both confirmed). Archived by
> `sports_satellite_ao_dispatch_batch3_finalize_2026_07_25.md` todo 2.
...
Grepped `plans/archive/issues/` for `DP_CATALOG_NOT_RUNNING`, `DP-CATALOG-001/002`, `CATALOGUE_SHRINK_BLOCKED`, and
...
Dispatched (rulings-closeout sweep across `plans/archive/issues/`) against the 2026-07-28-ruled dedup-aware-guard todo
