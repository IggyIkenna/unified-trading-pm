...
depends_on: []
resolved_by:
  "plans/archive/issues/five_broken_defi_capture_paths_shipped_2026_07_22.md (status: resolved, same date) -- all 5
  venues shipped, Terraform-applied, manually verified live"
locked_by:
source: operator ("ok for these 5 lets fix them all then"), 2026-07-22
---

> **🟢 SUPERSEDED 2026-07-22 -- this doc's tracked 'in-flight' work was already shipped and closed the same day by
> five_broken_defi_capture_paths_shipped_2026_07_22.md, which this doc was never updated to reflect. Archived per
> issue-doc-lifecycle.**
...
| File the mev_events >100-payload/day pagination gap                                                                 | RESOLVED 2026-07-28 — `plans/archive/issues/defi_mev_events_pagination_gap_2026_07_28.md` (fix shipped market-tick-data-service@33fa3b58)                                                                                                               | Done                                                                                                                                                            |
| File the 02:25 UTC T+1 features-onchain freshness deadline concern                                                  | DONE 2026-07-30 (defi_satellite_ao_dispatch_batch1 finalize reconciliation) — filed `/plans/archive/issues/defi_t1_freshness_deadline_stagger_2026_07_28.md` per defi_satellite_ao_dispatch_batch1_2026_07_25.md todo 17 (unified-trading-pm@2c4c1355f) | Done                                                                                                                                                            |
| File the gas-fees historical `venue=<CHAINNAME>` path-migration (pre-existing objects won't move)                   | DONE 2026-07-30 (defi_satellite_ao_dispatch_batch1 finalize reconciliation) — filed `/plans/archive/issues/defi_gas_fees_historical_venue_path_migration_2026_07_28.md` per defi_satellite_ao_dispatch_batch1_2026_07_25.md todo 18                     | Done                                                                                                                                                            |
