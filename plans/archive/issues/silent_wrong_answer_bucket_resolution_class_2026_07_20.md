...
resolved_by:
  all 5 confirmed instances shipped with commits; 3 residual items each resolved or handed off to named sibling docs
locked_by:
---

> **🟢 RESOLVED 2026-07-20 -- completed investigation, loose ends properly delegated to named sibling docs. Archived per
> issue-doc-lifecycle.**
