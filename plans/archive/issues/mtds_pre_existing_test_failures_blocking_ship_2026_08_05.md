...
> archive-on-resolve rule. Both todos [x] (market-tick-data-service@ea9e6e1e): collect-rewards registered for
> ProtocolClass.LENDING and Polymarket fills sentinel fixed; QG green and shipped via quickmerge per Progress Log. Moved
