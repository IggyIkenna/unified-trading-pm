...
> archive-on-resolve rule. DIAG proved the 73.92%->71.71% drop is benign dilution from ~1.27M net-new rows (zero rows
> lost, 2,226/2,226 pre-merge-filled sample still filled, exact anti-join reconstruction to 71.71%); DECISION RULING
> ACCEPT no restore; REVIEW ruling keep alert-only; all 4 todos [x]; self-diagnosing guardrail enhancement shipped
> unified-trading-library@2eefb006. Moved by the 2026-08-06 AO issue-doc archive sweep.
