...
> key-gen flow per `/codex/15-runbooks/custody-onboarding-checklist.md` § B.3 is now the only operator-action remaining
> for mainnet wallet provisioning (and per 2026-05-12 POD scope clarification, even that's pre-cutover testing with
...
documented in [`/codex/15-runbooks/custody-onboarding-checklist.md`](/codex/15-runbooks/custody-onboarding-checklist.md)
