...
> archive-on-resolve rule. Single todo [x] (unified-trading-system-ui@7cd80d34): coverage.ts regenerated (+1034/-144),
> all 60 UAC StrategyArchetype values mirrored, downstream consumers updated, quality-gates.sh green; remaining
> contested-assigned_role note is not open work. Moved by the 2026-08-06 AO issue-doc archive sweep.
