...
context_scope:
  ...
  - /plans/archive/issues/features_is_instruments_store_ambient_env_stg_2026_08_05.md
...
> archive-on-resolve rule. All 6 todos `[x]` with shipped SHAs: BINANCE-DELIVERY gate fix @a7976931, MDPS-input sweep
> @ba385100, tarball verified current, commodity test bucket provisioned, IS catalogue pin @58702715, and gate
> re-verified OPEN + benchmark reached REAL compute (6034 instruments); clean full-throughput number is tracked by the
> separate -056 plan, not this doc. Moved by the 2026-08-06 AO issue-doc archive sweep.
