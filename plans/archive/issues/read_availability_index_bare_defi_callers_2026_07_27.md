...
> archive-on-resolve rule. All ~18 bare-call-site fixes shipped across 9 repos with per-site regression tests, the
> enforcing QG gate (check_bare_read_availability_index.py) landed with a baselined 24-entry yaml and 0 new occurrences,
> and the 2026-08-03 instruments-service repo-blocker was cleared (a325da86); no open work remains. Moved by the
