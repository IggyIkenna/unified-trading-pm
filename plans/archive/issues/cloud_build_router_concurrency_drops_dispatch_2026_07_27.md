...
resolved_by:
  "unified-trading-pm@ae331d21a (removed the fleet-wide concurrency group from change-freeze-check.yml, the real root
  cause) + unified-trading-pm@9d28120e0 (stale_build_monitor.py + stale-build-watcher.yml hourly monitor). Both
  Recommended-decision todos shipped and quality-gates.sh green."
---
