...
> archive-on-resolve rule. Both todos [x]: INFRA P2 defi machine-type bump to e2-highmem-8
> (deployment-service@6bfeae2bc) + SCRIPT P3 column-pruned read path (unified-trading-library@c1ec7311); the 'left open'
> P3 referenced in the P2 note is itself now done, and Progress Log flags archival-eligible. Moved by the 2026-08-06 AO
