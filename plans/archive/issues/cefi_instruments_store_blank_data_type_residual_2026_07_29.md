...
> archive-on-resolve rule. Todo 1 correction executed (instruments-service@bef3a001, verified 0 captured+blank rows
> remain) and Todo 2 closed by evidence (blank data_type on non-captured is correct universal manifest behavior,
> error_reason is the why signal). Moved by the 2026-08-06 AO issue-doc archive sweep.
...
> `/plans/archive/issues/cefi_e6_cf7_relabel_and_attempted_failed_remeasure_2026_07_26.md` owns the entirely separate
