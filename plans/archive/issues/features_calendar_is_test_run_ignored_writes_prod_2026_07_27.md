...
> archive-on-resolve rule. All 5 todos [x]: config fix (ba5143fd), PROD-bucket audit+cleanup executed, phantom-capture
> root-caused+fixed (23d03fef), phantom rows purged (5706e1a3), and the other-family audit closed under the archived
> features_sports_is_test_run doc whose own P2 is also done. Moved by the 2026-08-06 AO issue-doc archive sweep.
