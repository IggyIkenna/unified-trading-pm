...
> archive-on-resolve rule. Both todos [x]: PROTOCOL_CAPABILITIES entries for ankr/stader/stakewise/swell/mantle/maker
> landed (unified-api-contracts@314af7b8, A-B test EXPECTED 102->108, no regression) and the P3 audit's findings were
> filed as its own issue doc (defi_protocol_capabilities_lst_rates_audit_2026_08_05) with 8 fix todos — 'Both todos now
> done.'. Moved by the 2026-08-06 AO issue-doc archive sweep.
...
- [x] ✅ [DATA] P3. Audit whether OTHER already-`phase="live"` DeFi venues have the same PUFFER-style declared-vs-actual
      ...
      /plans/archive/issues/defi_protocol_capabilities_lst_rates_audit_2026_08_05.md with findings: **Finding A** — 13
...
- **slot-7 2026-08-05 (data_engineering craft)**: completed todo 2 (P3 audit). Cross-referenced all 101 live DeFi
  ...
  /plans/archive/issues/defi_protocol_capabilities_lst_rates_audit_2026_08_05.md with 3 findings (A: 13 venues/6
