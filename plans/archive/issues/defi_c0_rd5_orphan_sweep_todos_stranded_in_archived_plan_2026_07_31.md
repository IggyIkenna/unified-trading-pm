...
source: >-
  ...
  ("outside every plan → plans/archive/2026_08/issues/<slug>_<date>.md") rather than chased to full resolution, since
  resolving it requires a live-GCS orphan sweep this audit's scope doesn't cover.
context_scope:
  [
    /plans/archive/2026_07/defi_manifest_canonicalisation_2026_06_01.md,
    /plans/archive/2026_07/defi_dedicated_bucket_shared_migration_2026_07_13.md,
...
- **na-eligibility-audit 2026-08-03 (reclassify pass)**: RECLASSIFY -> planning, the sole remaining todo is a bounded,
  ...
  `plans/archive/2026_08/*.md` + `plans/archive/2026_08/issues/*.md` for "C0-RD5" — the only other hit
