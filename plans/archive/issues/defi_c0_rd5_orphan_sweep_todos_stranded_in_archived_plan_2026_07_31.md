...
> archive-on-resolve rule. All 4 todos [x] with shipped evidence: live scan found 1,042 legacy-FORM objects, 205 true
> CURVE orphans backfilled to manifest (0 orphan candidates remain), ticks_migrated writer audited as a frozen artifact,
> and the only residual (deleting legacy copies) is explicitly tracked as a todo in the LIVE sibling doc
> defi_legacy_precanonical_composite_venue_objects_2026_07_24.md. Moved by the 2026-08-06 AO issue-doc archive sweep.
