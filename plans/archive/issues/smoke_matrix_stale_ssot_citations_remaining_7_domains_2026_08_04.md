...
- `plans/archive/2026_08/institutional_smoke_matrix_2026_04_20.plan.md` (archived) →
  `/codex/15-runbooks/smoke-testing-playbook.md`
...
- [x] ✅ [DOC] P3. Fix stale SSOT citations in the 7 remaining e2e-testing smoke_matrix.py files (calendar,
      ...
      `plans/archive/2026_08/institutional_smoke_matrix_2026_04_20.plan.md` →
      `/codex/15-runbooks/smoke-testing-playbook.md`. Repo: e2e-testing. Done when: all 7 files cite only current, live
      docs and `quality-gates.sh` green — e2e-testing@2bee452
