...
> archive-on-resolve rule. Both todos done: closer bar extended + 162 FIXTURE_EVENTS cells folded in
> (instruments-service@a24b7f2f) and SPOT `--provisioning-model` flag added to launch-sports-is-gap-fill.sh
> (deployment-service@d683f80); no prose-only open item or DO-NOT-ARCHIVE guard remains. Moved by the 2026-08-06 AO
