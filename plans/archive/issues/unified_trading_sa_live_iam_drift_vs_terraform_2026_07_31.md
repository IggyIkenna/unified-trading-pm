...
> archive-on-resolve rule. P0 audit done (unified-trading-pm@7b2ea5656), P1 operator RULED KEEP both roles, P2 imported
> all 28 undeclared roles (deployment-service@bd47dd8, 0-diff tofu plan), P3 cross-ref done; no open work. Moved by the
