...
**2026-08-21 — slot 14 exact rerun terminal evidence.** Driver `pipeline-e2e-check-mtds-20260821-053311-24ca62` enumerated exactly the four generator rows and completed at `2026-08-21T06:01:33Z` with exit `1`: 12 leg cells, 0 passed, 8 failed, 0 ambiguous, 4 skipped. The report retained venue-scoped parquet/manifest paths, genuine skip proofs for both trades rows, live-only classifications for both `book_snapshot_5` rows, and canonical-index checks for all four rows. Failures were `no_parquet_under`, `canonical_no_matching_rows`, or `noncanonical-instrument_type:'None'`; no cross-venue sample occurred. Evidence: `gs://deployment-scripts-central-element-323112/pipeline-e2e-check-reports/data_pipeline_e2e_check_mtds/2026-08-20/data_pipeline_e2e_check_mtds_2026_08_20_prediction.md`. The issue is resolved for the sampler defect; the smoke outcome remains RED for the underlying data/canonical findings.
