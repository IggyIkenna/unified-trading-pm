...
depends_on: []
resolved_by: superseded by /plans/active/mtds_venue_key_casing_reverify_then_execute_ao_dispatch_2026_08_16.md (na-eligibility-audit 2026-08-17)
locked_by:
...
> **🟡 ARCHIVED 2026-08-17 (superseded, not resolved)** — the diagnostic finding is complete and fully extracted; the
> actual fix now lives in and will ship via
> `/plans/active/mtds_venue_key_casing_reverify_then_execute_ao_dispatch_2026_08_16.md` (assigned_vm: planning). This
> doc is a closed historical record of the investigation, not evidence the underlying canonicalization has shipped yet.
...
- [x] ✅ [CODE] P2. Extracted verbatim to `mtds_venue_key_casing_reverify_then_execute_ao_dispatch_2026_08_16.md` (status: active, assigned_vm: planning; na-eligibility-audit 2026-08-17 stale-checkbox correction). Canonicalize every key in `WS_FEED_CONNECTOR_FACTORIES` to UPPERCASE (and every producer of a venue
...
- **na-eligibility-audit 2026-08-17** [body-hash:c9cc656d56df8709]: KEEP-NA-STALE (already-duplicated) -- the sole open item was extracted verbatim into the active mtds_venue_key_casing_reverify_then_execute_ao_dispatch_2026_08_16.md (assigned_vm: planning, related: cites this doc back); checkbox citation fixed, not reclassified. Cross-cutting tranche audit.
