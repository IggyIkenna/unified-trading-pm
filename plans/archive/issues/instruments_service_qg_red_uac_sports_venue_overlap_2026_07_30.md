...
> **ARCHIVED (2026-07-30) — resolved.** FOOTYSTATS moved out of UAC's `VENUES_BY_ASSET_GROUP["sports"]` into
> `SPORTS_ODDS_API_ACCEPTED_NONCANONICAL_BOOKMAKERS` (`unified-api-contracts@c022a60e`); sports golden fixture
> regenerated (`instruments-service@5f7b8136`). Repo-blocker `RB-ecfc50de` resolved.
