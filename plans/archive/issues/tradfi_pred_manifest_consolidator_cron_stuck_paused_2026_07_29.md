...
> archive-on-resolve rule. All 3 todos [x] and verified complete: crons resumed (both ENABLED, 130-shard catch-up), P2
> root-caused (not a broken coordinator — sanctioned plan-tracked pause, premise corrected), and P3 auto-resume
> implemented via unified-trading-library@b7e5e554 + deployment-service@b2ec819 with _try_auto_resume live in
> consolidator_liveness.py — the 'Not implemented in this pass' note is a stale 2026-07-30 narrative superseded by those
> commits. Moved by the 2026-08-06 AO issue-doc archive sweep.
