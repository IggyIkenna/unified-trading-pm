...
resolved_by: operator (via main), 2026-08-11 -- retired, no probe design spec needed (see Todos)
locked_by:
...
> **🟢 ARCHIVED 2026-08-17** — retired 2026-08-11 (operator ruling via main): original motivating incident (Tardis
> rate-limiting) already solved via the 1-concurrent-VM cap + larger boot disk; no probe design spec needed. Archived
> now to execute the 2026-08-11 `archive_exempt: true` bridge note's own "revisit in a dedicated plan-hygiene pass"
> instruction (na-eligibility-audit 2026-08-17).
