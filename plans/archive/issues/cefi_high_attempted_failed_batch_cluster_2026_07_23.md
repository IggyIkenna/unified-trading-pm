...
run.log or a live symbol-level replay). No existing open issue doc found in this workspace
(`plans/archive/2026_08/issues/`, `codex/`) tracks this specific DERIBIT/COINBASE-FUTURES/BITFINEX-FUTURES/OKX-FUTURES
recurrence -- flagged as a genuinely new, smaller finding, not a duplicate of anything read.
