...
> archive-on-resolve rule. All 6 todos done with shipped evidence (alerting static-backlog fix alerting-service@bb76cae,
> staleness labeling deployment-service@6f464325, expiry_date recurrence confirmed same fix 2ddc6d4a, VENUE_FETCH_FAILED
> attribution closed 08-05); residual backlog is explicitly machine-gated to
> cefi_track2_coverage_backfill_checkpoints_2026_07_25.md, a different plan. Moved by the 2026-08-06 AO issue-doc
> archive sweep.
