...
> archive-on-resolve rule. Every todo closed with commit evidence (coverage-summary, artifactregistry dep, repo-ci
> overview, deployments pagination, UI mock, frozen fixtures, parity-gate decision, mock-endpoint crash-smoke gate);
> Progress Log slot-5 2026-08-03 explicitly states 'Every todo in this doc is now done — archival-eligible'. Moved by
