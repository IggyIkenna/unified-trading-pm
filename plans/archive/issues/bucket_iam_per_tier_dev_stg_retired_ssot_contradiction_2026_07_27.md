...
context_scope:
  [
    ...
    /codex/05-infrastructure/bucket-isolation-model.md,
    /plans/active/bucket_iam_write_protection_per_tier_2026_06_09.md,
    deployment-service/terraform/gcp/canonical_buckets.tf,
  ]
---

> **🟢 ARCHIVED 2026-08-06** — `status: resolved` with zero open todos; archived per
> [`/codex/11-project-management/issue-doc-lifecycle.md`](/codex/11-project-management/issue-doc-lifecycle.md)'s
> archive-on-resolve rule. All 8 todos done - design resolved via operator ruling BLK-4b104acc, tofu apply landed
> deployment-service@44002342 (uts-test-sa + 9 live bindings), CEL-conditions codex §8.1 added, P3 CI-read shipped
> 08-04; context-scout 08-05 confirms 'doc pending archival'. Moved by the 2026-08-06 AO issue-doc archive sweep.
...
- [x] ✅ [DOCS] P2. **DONE 2026-07-28** — Cross-referenced `bucket_iam_write_protection_per_tier_2026_06_09.md` and the
      ...
      (`/plans/archive/issues/bucket_iam_per_tier_dev_stg_retired_ssot_contradiction_2026_07_27.md`) to the same list —
...
- [x] ✅ [TERRAFORM] P3. **DONE 2026-08-04** — `deployment-service@4de0784`. If the operator wants CI to read the 5
      tier-scoped buckets (matching bucket-isolation-model.md §8's "CI/CD SA read-only on prod"), add a literal-email
...
- **context-scout 2026-08-03**: refreshed context_scope (4 entries, unchanged) — verified all still accurate and
  resolve; the doc is nearly fully resolved (only the optional, non-blocking P3 CI-read todo remains), so the existing
  entries (terraform SAs, the codex SSOT, and both parent plans) remain the right minimal set.
- **context-scout 2026-08-05**: re-scouted; context_scope unchanged (4 entries), still accurate — all todos now `[x]`
  done (P3 CI-read shipped 2026-08-04), doc pending archival.
