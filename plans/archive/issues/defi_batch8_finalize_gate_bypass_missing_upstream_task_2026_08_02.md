...
> archive-on-resolve rule. All 4 todos [x] (2026-08-05 slot-9): batch8's real todo completed, gate verified correct,
> source-doc reconciliation effective; doc's own Progress Log states 'All 4 todos in this issue doc are now [x]; the doc
> is eligible for archival (no locked_by)'. Moved by the 2026-08-06 AO issue-doc archive sweep.
