...
> archive-on-resolve rule. Single todo [x]: root-cause complete — stale-tarball backfill VM, not a resolver gap/code
> regression; P1 fix (91ac1caa) already covers it, no code change needed, 354 rows are harmless legacy strays that won't
> recur. Moved by the 2026-08-06 AO issue-doc archive sweep.
