...
superseded_by:
resolved_by:
  "market-tick-data-service@0fddb95e (write_defi_rows() leaf fix, 2026-07-27, expedited per option (c)); census
  plans/audit/results/defi_bare_symbol_leaf_census_2026_07_28.md confirms violation rate collapsed to ~0-1% the day the
  fix shipped; codex updates (canonical-cutover-register.md §5, four-surface-reconciliation-procedure.md,
  reconciliation-finding-taxonomy.md) covered by defi_satellite_ao_dispatch_batch1_2026_07_25.md. Sequencing decision
  closed 2026-07-28 (workspace stale-gate audit)."
source:
