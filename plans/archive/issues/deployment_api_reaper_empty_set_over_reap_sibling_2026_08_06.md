...
> archive-on-resolve rule. Todo [x] with fix shipped deployment-api@3e1d3fa (list_running_vm_names returns set|None on
> failure, both callers pass running_vm_names=None, 4 regression tests, QG green 85/85); created 2026-08-06 by slot-4 as
> sibling finding, fixed by slot-8 — genuinely complete, 0 open todos, no locked_by. Moved by the 2026-08-06 AO
