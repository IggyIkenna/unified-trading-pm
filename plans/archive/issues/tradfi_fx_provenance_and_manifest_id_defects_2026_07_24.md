...
> archive-on-resolve rule. Every todo [x] and the doc's own text closes the loop: write-path fixed
> (unified-trading-library@f237b75a), 1,141-row provenance re-stamp executed + verified 0 remaining, FX instrument_id
> re-stamp completed via sibling tradfi_fx_phantom_row_premise_contradicted_2026_08_04.md
> (market-tick-data-service@c86016f6), billing-guard question closed by operator ruling; phantom/duplicate residuals
> tracked in the archived+resolved sibling tradfi_fx_manifest_phantom_and_duplicate_rows_2026_08_03.md. Moved by the
