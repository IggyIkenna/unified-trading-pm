...
related:
  [
    ...
    /plans/archive/issues/cross_instrument_delta_one_listing_recurring_hang_2026_08_03.md,
    /plans/archive/issues/multi_timeframe_phantom_captured_manifest_rows_on_universal_write_failure_2026_08_03.md,
  ]
created: 2026-07-27
author: unknown
priority: P0
...
> archive-on-resolve rule. All todos [x] with FINAL CONSOLIDATED VERDICT: all 7 shards hold genuine verdicts, root
> causes B/C/D/E fixed (87e39bc7/9ed3d59e/e51bbab/commodity rewrite), A + the remaining real failures tracked in sibling
> active issue docs; EIA re-enable is a decision-closed, operator-gated BLOCKED-CREDENTIALS deferral, not unfinished
> dispatchable work. Moved by the 2026-08-06 AO issue-doc archive sweep.
