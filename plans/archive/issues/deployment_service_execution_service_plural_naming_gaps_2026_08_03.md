...
> archive-on-resolve rule. Both todos [x] with shipped evidence: shard_builder.py dict key fixed + regression test
> (deployment-service@138c82d), and both fleet-sweep scripts confirmed dead with zero referrers and deleted
> (deployment-service@3d1d817); no open work. Moved by the 2026-08-06 AO issue-doc archive sweep.
