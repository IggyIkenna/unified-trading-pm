...
- [x] ✅ [INFRA] P0. **DONE 2026-08-01T15:18Z, deployment-service@aa146bc verification run.** Manually relaunched
      ...
      deletes-first). New instance `mtds-live-cefi-consolidated-20260801-151833` booted clean (`VM SETUP COMPLETE`, all
      17 shards started, exit 0) and was left running ~15h alongside the old instance before this session resumed (a
