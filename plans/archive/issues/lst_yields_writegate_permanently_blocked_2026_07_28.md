...
> archive-on-resolve rule. Both writegate/emission bugs fixed + verified via real GCS writes (14/16/16 rows/day); all
> recommended follow-up todos [x] (UAC@8f1c11c8, MTDS _EVM_EXTENDED_RATE_CONFIGS removal, PARTIAL_OK adoption). Moved by
