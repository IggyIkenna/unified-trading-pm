...
context_scope:
  [
    ...
    /plans/active/issues/cefi_hl_aster_batch_data_gaps_2026_06_22.md,
    /plans/archive/issues/coverage_floor_new_backfill_gaps_found_2026_07_27.md,
  ]
---
...
comment referencing `plans/archive/2026_08/prediction_venue_perps_and_live_clob_depth_2026_06_20.md` in both files —
that plan was split + archived 2026-07-24 per the plan line-cap remediation; the KALSHI-PERP/POLYMARKET-PERP venue-add
content now lives in `plans/archive/2026_07/prediction_perps_kalshi_polymarket_parked_2026_07_24.md`.)
...
- [x] ✅ [DATA] P1. HYPERLIQUID gap ROOT-CAUSED + backfill CONFIRMED already in progress (2026-07-27, slot-11).
      ...
      **2023-02-27** (as of 2026-07-27T08:37:45Z) advancing at ~88s/day — climbing toward and through the
      ...
      `plans/archive/2026_08/issues/cefi_hl_aster_batch_data_gaps_2026_06_22.md` (the live parent doc already tracking +
...
- [x] ✅ [DATA] P2. **DONE 2026-08-02 (slot-9, duplicate of the same finding in
      `/plans/archive/issues/coverage_floor_new_backfill_gaps_found_2026_07_27.md`, synced here to avoid a stale
