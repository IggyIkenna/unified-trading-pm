...
> archive-on-resolve rule. All 3 todos `[x]` and verified durable: script constant fix @b8a8fa7a, operator-authorized
> straggler removal executed (rounds 1-3, ~869k stragglers removed), and the real live-websocket root cause fixed
> @12992663 with 'a fresh read ~7 minutes and several consolidator cycles later shows 0 null instrument_type rows' —
> durable. Moved by the 2026-08-06 AO issue-doc archive sweep.
