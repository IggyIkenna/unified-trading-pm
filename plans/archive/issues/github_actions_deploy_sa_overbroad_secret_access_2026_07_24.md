...
resolved_by:
  IAM bindings scoped + project-wide grant removed, re-tested via impersonation (exits 0); P3 delegated to
  ci_satellite_ao_dispatch_batch1_2026_07_26.md
locked_by:
depends_on: []
---

> **🟢 RESOLVED 2026-07-24 -- least-privilege restored and verified; remaining scope tracked elsewhere. Archived per
> issue-doc-lifecycle.**
