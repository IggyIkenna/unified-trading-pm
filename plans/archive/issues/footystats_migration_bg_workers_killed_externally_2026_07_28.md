...
resolved_by:
  "both todos DONE: forensic auditd/journalctl check ruled out kernel OOM (operator-ruled 2026-07-29); supervised-resume
  wrapper shipped unified-trading-pm@caa33217b + async-wait-and-poll-discipline.md item 6"
locked_by:
context_scope:
  [
    /plans/archive/issues/pkill_broad_pattern_cross_slot_qg_kill_2026_07_28.md,
