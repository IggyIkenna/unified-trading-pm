...
> archive-on-resolve rule. Path A shipped 2026-08-02 (instruments-service@942e0808 + unified-api-contracts@28c7102d)
> with byte-identical zero completeness_pct delta verified against the real enumerate_v2(); Path B marked
> MOOT/SUPERSEDED; 4h discrepancy covered by defi_satellite_ao_dispatch_batch1_2026_07_25.md; all 4 todos [x]. Moved by
