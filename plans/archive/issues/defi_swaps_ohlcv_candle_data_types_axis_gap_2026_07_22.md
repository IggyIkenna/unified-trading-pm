...
related:
  [
    ...
    plans/archive/2026_08/issues/defi_perp_daily_ctx_manifest_gap_reader_risk_2026_07_22.md,
...
7. **A directly analogous failure already happened and was patched — for tradfi, not defi.**
   ...
   finding 3) exists SPECIFICALLY because two data_types in `DATA_TYPES_BY_ASSET_GROUP["tradfi"]`
...
(`plans/archive/2026_08/issues/defi_perp_daily_ctx_manifest_gap_reader_risk_2026_07_22.md`), which the
AUTONOMOUS_AGENT_RULES for this dispatch explicitly cite as the model for when stopping short is the right call.
...
- **`perp_daily_ctx`/`perp_mark_price`** — already investigated + stopped-short by a sibling agent this session; see
  `plans/archive/2026_08/issues/defi_perp_daily_ctx_manifest_gap_reader_risk_2026_07_22.md`. Not re-touched.
