...
> archive-on-resolve rule. All 3 todos [x] with evidence: catalog.parquet confirmed clean (0 GMX rows), 4 stale manifest
> rows pruned (42,192,496->42,192,492, 0 venue=GMX remain, captured preserved), DRIFT/PACIFICA residue check clean;
> Progress Log explicitly states 'all todos now done; doc is archival-eligible'. Moved by the 2026-08-06 AO issue-doc
> archive sweep.
