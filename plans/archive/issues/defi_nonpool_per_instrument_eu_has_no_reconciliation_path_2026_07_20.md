...
assigned_vm: NA
resolved_by:
  5-repo operator decision shipped; items 2-3 DONE 2026-07-26 (slot-14) with commit SHAs; item 4 measured CELL-level
  backlog = ZERO; item 5 self-superseded by instruments-service@a516bd01
---

> **🟢 RESOLVED 2026-07-20 -- all 5 follow-on items shipped-and-verified or self-superseded. Archived per
> issue-doc-lifecycle.**
