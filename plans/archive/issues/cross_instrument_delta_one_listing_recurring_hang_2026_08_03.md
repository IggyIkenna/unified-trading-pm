...
> archive-on-resolve rule. Hang root-caused to unbounded blob.reload() and bounded (unified-trading-library@680bbafb),
> test-bucket-pattern diagnostic closed, reload()-elimination shipped (649fd8e1 + features-service@5275fef1), and
> stale-prefix pruning shipped (features-service@45a52cd7); all 4 todos [x] with commit evidence, final Progress Log
> shows no open work. Moved by the 2026-08-06 AO issue-doc archive sweep.
