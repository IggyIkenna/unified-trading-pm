...
> archive-on-resolve rule. All 3 todos [x] with shipped evidence (T-18h horizon market-data-processing-service@814ead6,
> scraper NOT fixture-count-gated audit, 20-date bm_minutes audit confirming dead zone is real but not the weekday
> driver); diagnosis complete with no remaining follow-up. Moved by the 2026-08-06 AO issue-doc archive sweep.
