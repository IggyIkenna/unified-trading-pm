...
> archive-on-resolve rule. Fix shipped mtds@df3d55dd reading the success key + P3 blast-radius audit complete 2026-08-05
> (ZERO production impact, 12-venue catalog all CLEAN), duplicate todo absorbed; Progress Log shows no open follow-up.
