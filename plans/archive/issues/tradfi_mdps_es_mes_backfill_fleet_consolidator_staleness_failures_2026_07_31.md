...
> archive-on-resolve rule. Staleness-budget fix (unified-trading-library@75b5735) validated in-flight, all 14 shards
> relaunched on the fixed tarball with real candle output verified (RUN_TS 023743), and the es3 ownership, 011358-wave
> provenance (answered 2026-08-05), and weekend dependency-check (c861fd0) todos all closed with commit evidence. Moved
