...
summary: Citadel-grade manual trade booking across all instrument types (CeFi, DeFi, TradFi, Sports, Prediction) with two
  UI surfaces (back-office + in-context), record-only fills for OTC/missed trades, reconciliation accept/reject workflow,
