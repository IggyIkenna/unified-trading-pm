...
> **UPDATE 2026-06-24:** `deployment-service` (listed below at 33 files) was **manually force-synced / drained to
> `main`** to ship the data-pipeline auto-kill monitor fix — its starvation is **CLEARED** (now a single version-line
> behind). The remaining ~19 repos still starve; systemic fix + the post-drain manifest-hygiene reconciliation live in
> the consolidated SSOT **WS-B (bumped P0)** → `plans/active/cicd_consolidated_remaining_2026_06_24.md`.
