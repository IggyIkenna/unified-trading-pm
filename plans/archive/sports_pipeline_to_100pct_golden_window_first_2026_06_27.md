...
> **Archived 2026-07-25** — status was already superseded.
...
`plans/archive/issues/plan_reconciliation_operator_decisions_2026_07_11.md` §A2 "50 reclassified" blanket ruling.)_
...
| ------------------------------------------ | ----- | -------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P0 sourcing+honest-coverage correctness    | 0     | R1,R5    | —           | ✅ complete — instruments-service@4ce8a21+@860daca+@3d4f1a1+@edebc6b, unified-api-contracts@c7494a2a+@c75101be (all 5 todos `[x]`, forward phantom dry-run ≈0, ~258 phantoms healed) (was: ⬜ not started — corrected 2026-07-12, finding id 282, §A2 B-queue ruling)                   |
| P1a golden-window apifootball              | 1     | R1       | P0          | ✅ complete — af-backfill-20260627-182057 SPOT, 2903/2904 shards resolved via re-fetch, Gate ALL PASS (attempted_failed=0, unattempted=0, blank_reason=0) (was: ⬜ not started — corrected 2026-07-12, finding id 283)                                                                  |
| P1b golden-window reference sources        | 1     | R1,R3    | P0          | ✅ complete — weather/SFI/transfermarkt/understat/footystats all `[x]`, no-blank-reason invariant DONE slot-2 2026-06-28 (was: ⬜ not started — corrected 2026-07-12, finding id 284)                                                                                                   |
| P1c golden-window MTDS odds                | 1     | R1,R5    | P0          | ✅ complete — MTDS sports odds 100% honest coverage on 2025-09-01..2025-11-30 for the odds-api-covered subset of the 94 universe (was: ⬜ not started — corrected 2026-07-12, finding id 285)                                                                                           |
