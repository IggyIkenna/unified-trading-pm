...
related:
  [
    ...
    /plans/archive/mvp_backfill_defi_onchain_v10_operational_log_part5_2026_07_24.md,
...
> `plans/archive/issues/plan_line_cap_remediation_2026_07_23.md` row 21 ("pure hygiene split, no todo/gate/state
...
> filename), Part 2 (`plans/archive/mvp_backfill_defi_onchain_v10_operational_log_part2_2026_07_24.md`), and Part 3
> (`plans/archive/mvp_backfill_defi_onchain_v10_operational_log_part3_2026_07_24.md`) — pure mechanical division, no
...
**MIGRATED TO:** `plans/active/issues/solana_dex_pool_swaps_indexer_scope_2026_07_12.md` (the filed P2 todo for the
Solana swap-event indexer capability) and `plans/active/mvp_backfill_defi_onchain_v10_2026_06_27.md` (this log's live
parent plan — this is Part 1 of 6 of its extracted operational history; any other still-open thread here continues
there).
