...
related: []
created: '2026-04-16'
overview: Unified client/account identity, UAC strategy registry SSOT, shard-enriched records across all services and UI, SCE mode enforcement
type: code
...
- {id: uac-enrich-schemas, content: '- [x] [AGENT] P0. UAC: Add shard dimensions to CanonicalOrder, CanonicalFill, all Position models (PARALLEL)
