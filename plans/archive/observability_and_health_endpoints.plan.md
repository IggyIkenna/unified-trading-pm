...
todos:
  - id: obs-readiness-audit
    ...
    notes: |
      Audit findings: execution-results-api (done), market-data-api (done), client-reporting-api (done),
  ...
  - id: obs-prometheus-all-services
    ...
    completedAt: "2026-03-08"
    notes: |
      Added metrics.py (RECORDS_PROCESSED Counter + PROCESSING_LATENCY Histogram) and wired /metrics endpoint
  ...
  - id: obs-compliance-events
    ...
    completedAt: "2026-03-08"
    notes: |
      Added AUTH_FAILURE + SECRET_ACCESSED log_event() calls:
  ...
  - id: obs-pre-crash-checkpoint
    ...
    completedAt: "2026-03-08"
    notes: |
      Created pre_crash_checkpoint.py in 4 services with register_pre_crash_handlers():
  ...
  - id: obs-grafana-verify
    ...
    completedAt: "2026-03-08"
    notes: |
      trading-overview.json: added 6 new panels (was 5 → now 11):
  ...
  - id: obs-correlation-id-e2e
    ...
    completedAt: "2026-03-08"
    notes: |
      Created execution-service/tests/unit/test_correlation_propagation.py (4 tests):
  ...
  - id: obs-opentelemetry-rollout
    ...
    completedAt: "2026-03-08"
    notes: |
      Added OTel dependencies (opentelemetry-api, opentelemetry-sdk, opentelemetry-exporter-otlp-proto-grpc,
  ...
  - id: obs-lifecycle-event-test-mandate
    ...
    completedAt: "2026-03-08"
    notes: |
      Created tests/unit/test_lifecycle_events.py in 5 services (STARTED/STOPPED/FAILED coverage):
