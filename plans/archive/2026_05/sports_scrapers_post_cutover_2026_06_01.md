...
> **POST-CUTOVER — 2026-06-01+. BLOCKED-OPERATOR-DECISION on account provisioning. This plan activates when operator
> acks Phase 1 (account + credential provisioning). No agent work until then.**
...
- [x] **[BLOCKED-OPERATOR-DECISION — account provisioning gate; this plan re-activates when operator acks]** [HUMAN] P0.
      ...
      subscription + API credentials; vaults in Secret Manager under `sports-scrapers-{book}-{credential_type}`.
...
- [x] **[DEFERRED-POST-CUTOVER-2026-06-01+ — gated on Phase 3]** [AGENT] P2. Per-book account-balance monitor (refill
      ...
      `interface-credential-convention.md` § Sports books.
