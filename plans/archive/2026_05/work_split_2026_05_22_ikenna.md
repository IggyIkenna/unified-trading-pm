...
All items in this work split have been executed or explicitly deferred with named successor plans:

- Prediction bucket naming mismatch (P1) → `bucket_name_ssot_canonicalisation_2026_05_10.md`
- Kalshi Phases 3-4 (BLOCKED-CREDENTIALS) → `kalshi_api_migration_to_elections_subdomain_2026_05_20.md`
- Remaining backfill items → `features_backfill_phase3_2026_05_22.md`, `instruments_backfill_phase3_2026_05_22.md`, etc.
