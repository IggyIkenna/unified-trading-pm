...
- MDPS-3.3.CeFi + MDPS-3.3.CeFi-V (gated on MTDS-3.2.A-V not yet GREEN when plan was locked) →
  `plans/epics/mtds_mdps_master.md` P2 block — launch once CeFi MTDS FullFleetRelaunch batch completes (**MIGRATED
  FROM:** mdps_backfill_phase3_2026_05_22)
- MDPS-3.3.DeFi-DexSwaps-V (mtds-dex-swaps-backfill VM-RUNNING) → `plans/epics/mtds_mdps_master.md` P2 block — verify
  once VM completes (**MIGRATED FROM:** mdps_backfill_phase3_2026_05_22)
- MDPS-3.3.TradFi-V (7 VMs mdps-tradfi-{2020..2026} ETA ~66h — operator to verify once 2025 VM reaches 2025-12-31) →
  `plans/epics/mtds_mdps_master.md` P2 block (**MIGRATED FROM:** mdps_backfill_phase3_2026_05_22)
- MDPS-3.3.Sports-V (7 VMs mdps-sports-{2020..2026} Relaunch11 RUNNING — operator to verify once complete) →
  `plans/epics/mtds_mdps_master.md` P2 block (**MIGRATED FROM:** mdps_backfill_phase3_2026_05_22)
- MDPS-3.3.Pred-V full verify (partial verify done 2026-05-23, full verify pending VM completion) →
  `plans/epics/mtds_mdps_master.md` P2 block (**MIGRATED FROM:** mdps_backfill_phase3_2026_05_22)
