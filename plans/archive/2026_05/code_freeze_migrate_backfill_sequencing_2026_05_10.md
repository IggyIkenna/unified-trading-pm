...
- [x] ✅ [DOC] P0. **gap-2.6.E** — Operator runbook section in `codex/05-infrastructure/` documenting the 7-wave gating
      ...
      `/codex/15-runbooks/phase-2-6-bucket-name-cutover-runbook.md` — full 7-wave protocol (T-1h → T+27h) with
      ...
      `/codex/15-runbooks/recursive-leverage-receiver-deploy-runbook.md` (`runbook_metadata:` → `execution:` key
