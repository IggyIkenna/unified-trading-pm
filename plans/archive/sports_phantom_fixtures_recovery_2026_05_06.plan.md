...
related: []
created: '2026-05-06'
overview: Recover Category A leagues (AUSTRIAN_BUNDESLIGA / GREEK_SUPER_LEAGUE / ~36 others) from phantom-captured FIXTURES rows, then re-run dependent enrichments (PLAYER_STATS / FIXTURE_*) under the writer fix shipped in instruments-service `f36651c`.
type: code
