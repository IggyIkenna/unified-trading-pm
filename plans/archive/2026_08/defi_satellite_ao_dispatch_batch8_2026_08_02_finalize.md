...
- [x] ✅ [DOC] P1. Archive `defi_satellite_ao_dispatch_batch8_2026_08_02.md` via the standard 6-step ritual. **(1)
      ...
      codify. **(5) Referrers updated** — `plans/archive/2026_08/INDEX.md` lines updated to archive paths; issue-doc
      referrers are informational (not execution dependencies) and remain valid pointing at the archived path. **(6)
      Moved** to `plans/archive/2026_08/`. Evidence: batch8 is now at
