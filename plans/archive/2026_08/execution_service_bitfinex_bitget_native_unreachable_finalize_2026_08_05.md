...
related:
  [
    /plans/archive/2026_08/issues/execution_service_bitfinex_bitget_native_unreachable_2026_07_28.md,
...
> **🟢 ARCHIVED 2026-08-05.** Both todos complete. Source doc
> `execution_service_bitfinex_bitget_native_unreachable_2026_07_28.md` archived to `/plans/archive/2026_08/issues/` via
> the standard 6-step ritual: ceremonial lock cleared, 0 deferred items, no new codex contract,
> `cefi_consolidated_closeout_2026_07_18.md` referrer repointed.
...
- [x] ✅ [DOC] P2. **Archive the source doc via the standard 6-step ritual** — unified-trading-pm@<SHA> — but the doc
      carries `locked_by:     live-defi-rollout` (`locked_since: 2026-05-21`), which blocks archival under
...
- **2026-08-05** (slot 2, data_engineering): Todo 2 complete. 6-step archival ritual executed: (0) cleared ceremonial
  `locked_by: live-defi-rollout` / `locked_since: 2026-05-21` — lock predates doc creation by >2 months, clearly a
  template carryover; (1) 0 deferred items to migrate (sole todo done 2026-08-03); (2) archive banner added; (3) codex
  check — no new durable contract, wiring change confirmed in execution-service@0f37ec8a +
  unified-api-contracts@1ee4dbd5; (4) no CLAUDE.md/codex update needed; (5) one external referrer repointed —
  `cefi_consolidated_closeout_2026_07_18.md` L302 → `/plans/archive/2026_08/issues/...`; (6) lock cleared, `git mv` both
  docs to `plans/archive/2026_08/`.
