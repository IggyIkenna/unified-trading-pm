...
- [x] ✅ [SCRIPT] P1. **DONE 2026-08-09 (slot-19).** **Cross-cutting data-completion prep residuals —
      ...
      scaffolded from scratch — `market-tick-data-service@acf40de5`, `unified-api-contracts@7d01034c` for the
      ...
      Odds-API half already has creds; added 21 mocked unit tests, `market-tick-data-service@acf40de5`, since the
