...
title:
  ...
  cadence tracker"
summary:
  "Four correctness gaps in perp funding: UAC/UTL cadence registries disagree, `funding_timestamp` is off by one
  settlement for most venues, no historical tracker, and DERIBIT can't be derived from scratch — a P0 net-carry input."
status: resolved
nature: process
...
resolved_by: main-agent (blocked-question BLK-00e5bdf7, 2026-08-13) -- 20/20 todos [x], no open work
locked_by:
context_scope:
  [
...
> **ARCHIVED 2026-08-13** — all 20 todos [x], no open work. Archived via
...
- [x] ✅ [DATA] P2. **Genesis is PER-(venue, data_type), not per-venue — encoded. VERIFIED 2026-08-03** directly against
      ...
      `trades: 2023-07-22`, `derivative_ticker: 2023-07-22`, `book_snapshot_5: null` (honest live-capture-only absence),
      `liquidations: 2024-10-01` — four distinct per-data_type genesis values, not one per-venue value. Every
