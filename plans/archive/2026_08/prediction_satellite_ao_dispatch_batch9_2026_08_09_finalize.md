...
> batch9's 3 not-extracted items, and the archival itself (this doc + `prediction_satellite_ao_dispatch_batch9_2026_08_09.md`,
> moved to `plans/archive/2026_08/` in the same commit as this banner). Every active-corpus referrer repointed to the
> archive path; no deferred item needed migrating. No codex staleness found. Successor: none.
