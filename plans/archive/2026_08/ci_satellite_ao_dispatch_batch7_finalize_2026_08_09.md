...
> Source doc reconciled (`unified-trading-pm@d938e9275`); batch-7 archived alongside this doc in the same commit set.
> Successor: none.
...
- [x] ✅ [REVIEW] P1. **Reconcile batch-7 todo 1's source doc.** Batch-7 todo 1 ends with `Source:` naming
      ...
      codex docs"). Flipped that doc's item to `[x]` citing `unified-trading-pm@d938e9275` (the batch-7 commit that
