...
> `/plans/archive/2026_08/issues/deepseek_flash_spend_235_residual_2026_08_10.md` before archival (per the
> archival-discipline ritual, never let a prose deferral evaporate). Archived by the batch12-finalize plan (2026-08-10).
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| Todo 2 — unit test proving the ~50/50 pro/flash split ratio + reproducibility                                                                          | **Done 2026-08-10** — via batch12 todo 1 (`agent-orchestrator@4d27bc1`); see todo 2's own entry above                                                                                           | —                                                                 |
| Todo 4 — Playwright regression spec for the new filter toggle                                                                                          | **Done 2026-08-10** — via batch12 todo 2 (`agent-orchestrator@26f8a49`); see todo 4's own entry above                                                                                           | —                                                                 |
...
| Todo 17b — unverified thinking-flag meaning for DeepSeek slots (17a done — pro/flash variant now shown)                                                | **Done 2026-08-10** — via batch12 todo 4 (`agent-orchestrator@64a0291`); flag confirmed inert on adaptive-reasoning models for both providers; see todo 17b's own entry above                   | —                                                                 |
