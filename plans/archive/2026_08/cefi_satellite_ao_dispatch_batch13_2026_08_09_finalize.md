...
> `/plans/archive/2026_08/issues/cefi_depth_of_book_10_sink_matrix_contract_gap_2026_08_10.md`. No deferred items.
...
- [x] ✅ [DOC] P1. **Archive `cefi_satellite_ao_dispatch_batch13_2026_08_09.md`** via the standard 6-step ritual: add
      ...
      `plans/archive/2026_08/issues/cefi_depth_of_book_10_sink_matrix_contract_gap_2026_08_10.md`;
...
- **2026-08-10 (slot-6, data_engineering, todo 3)** — Executed the batch13 archival per the 6-step ritual: (1) no
  ...
  filed as `plans/archive/2026_08/issues/cefi_depth_of_book_10_sink_matrix_contract_gap_2026_08_10.md`
  (AO-dispatchable). (4) No new CLAUDE.md rule. (5) Corpus-wide referrer sweep: repointed
  `plans/epics/strategy_master.md` (4 refs) + archived batch11 (1 related ref) + archived depth_of_book issue (3 path
  refs) to the archive paths; INDEX.md auto-regenerated by the hygiene sweep. (6) `locked_by` already empty (confirmed);
  both docs `git mv`'d to `plans/archive/2026_08/`. `run_hygiene_sweep.sh` green.
