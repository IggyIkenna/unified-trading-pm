...
> **🟢 ARCHIVED 2026-08-03.** All todos resolved and cross-verified (FX-via-Yahoo wave-launcher wiring —
> `deployment-service@eab5aeb`; ICE descoped by operator 2026-07-14, served by Yahoo DXY per
> `venue_to_data_provider['ICE']`; VIX cash-index DELETE + Databento universe floor-clip landed 2026-06-23
> (`instruments-service@814b14a`) + 2026-07-13 straggler cleanup; BUG 3 DP_VM_GONE_NO_CAPTURE fixed
> `deployment-service@04942d5`; phantom-audit P0 items applied + re-verified <0.5%). Unlocked (was
> `locked_by: live-defi-rollout` since 2026-06-22 — operator-approved unlock, no remaining dependent work found). Moved
> to `/plans/archive/2026_08/tradfi_multisource_backfill_2026_06_22.md`; corpus referrers updated. **Codex-alignment
> check**: `venue_to_data_provider['FX']='yahoo_finance'` (KRW/USD via Yahoo) was undocumented in
> `/codex/02-data/tradfi-databento-sourcing-ssot.md`'s Yahoo-sourced-venues section (only KRX+ICE were listed) — added
> as the third venue.
