...
source: >-
  ...
  plans/archive/2026_08/issues/plan_line_cap_remediation_2026_07_23.md (bucket-(c) split #11: "Extract Strategy/PnL
  index + 1800-line historical log"). Content moved verbatim, no rewrite — see the parent's Progress Log / this
  remediation job's evidence for the split rationale.
context_scope:
  [
    /plans/active/defi_consolidated_closeout_2026_07_18.md,
    /plans/active/lst_rate_honest_coverage_2026_07_21.md,
