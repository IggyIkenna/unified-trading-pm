...
doc_type: issue
title:
  Fleet-wide QG capacity crisis (continues-day2 doc) — Progress Log history (2026-07-29 through 2026-08-01 corroboration
  waves)
summary:
  Line-cap remediation extraction from plans/active/issues/fleet_wide_qg_capacity_crisis_continues_day2_2026_07_29.md's
  Progress Log — every per-repo corroboration + fix entry from 2026-07-29 through the 2026-08-01 na-eligibility-audit
  entry (instruments-service, client-reporting-api, features-service, unified-api-contracts, market-tick-data-service,
  deployment-service, and others; the plan_health escalation-queue root-cause diagnosis; the P1 cost-quantification data
  pull; the main-backmerge-to-ldr `Promoted-From-LDR` trailer `-e`/pipefail fix), moved verbatim so the live doc stays
  under the 1000-line hard cap (was 995 lines, no headroom left for new entries). Mirrors the identical remediation
  already applied once to this doc's own predecessor
  (`/plans/archive/2026_07/fleet_wide_qg_self_hosted_runner_capacity_crisis_progress_log_history_2026_07_29.md`). Fully
  superseded by the live doc's Evidence/Todos sections; read this only if a deeper citation on a specific repo's
  corroboration entry is needed.
status: archived
nature: notes
asset_group: [ci]
stage: [meta]
...
related:
  [
    ...
    /plans/archive/2026_07/fleet_wide_qg_self_hosted_runner_capacity_crisis_progress_log_history_2026_07_29.md,
  ]
created: 2026-08-02
...
# Fleet-wide QG capacity crisis continues day 2 — Progress Log history (2026-07-29 → 2026-08-01)

Extracted verbatim from `fleet_wide_qg_capacity_crisis_continues_day2_2026_07_29.md` at 995 lines (0 lines of headroom
under the 1000-line hard cap) to make room for ongoing corroboration entries. No content changed, only relocated — see
the live doc for the current Todos/Evidence and any entries dated after 2026-08-02.
