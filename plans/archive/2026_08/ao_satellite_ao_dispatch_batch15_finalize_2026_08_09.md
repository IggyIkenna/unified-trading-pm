...
related:
  [
    /plans/archive/2026_08/ao_satellite_ao_dispatch_batch15_2026_08_09.md,
...
> **Machine-gated on `/plans/archive/2026_08/ao_satellite_ao_dispatch_batch15_2026_08_09.md`** (`depends_on` +
...
- [x] ✅ [INFRA] P0. **DONE 2026-08-16 (plan_reconciler, ao tranche)** — ran the 6-step archival ritual on
      `ao_satellite_ao_dispatch_batch15_2026_08_09.md`: 3/3 todos verified `[x]` with hard evidence, no Deferred content,
      ...
      `populate_epic_bodies_2026_05_21.py --apply` + `regenerate_active_plan_inventory.py`); both source docs'
      `related:` entries repointed to the archive path. This finalize plan's own `related:`/`depends_on:` repointed in
...
- **2026-08-16 (plan_reconciler, ao tranche)**: todo 4 done — ran the archival ritual on batch15. This finalize doc
