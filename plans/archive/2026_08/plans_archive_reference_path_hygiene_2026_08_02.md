...
> **🟢 ARCHIVED 2026-08-03.** All 6 todos done. Reconciled + archived via
> `/plans/archive/2026_08/plans_archive_reference_path_hygiene_finalize_2026_08_02.md` (one of three independently
> authored gated finalize plans for this doc — see that finalize doc's own banner for the duplicate-finalize-plan
> finding and disposition). Moved to `/plans/archive/2026_08/`. No new durable contract — codex alignment check: nothing
> to update (this plan only ran an existing script + hand-fixed reference paths over the existing corpus).
