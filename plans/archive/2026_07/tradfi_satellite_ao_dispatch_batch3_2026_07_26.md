...
- [x] ✅ [BACKEND] P0. **RESCOPED (slot-3, 2026-07-26): Finding 1's write-path root cause fixed + verified; historical
      ...
      **NOT DONE — untouched this pass, a fully separate write path.** Repos: market-tick-data-service,
      unified-api-contracts. Source: `plans/archive/issues/tradfi_fx_provenance_and_manifest_id_defects_2026_07_24.md`.
...
- **`plans/archive/issues/tradfi_mvp_mode_unreachable_dead_gate_2026_07_08.md`**: Not a fresh finding — already triaged
