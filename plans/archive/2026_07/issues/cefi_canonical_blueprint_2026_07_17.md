---
doc_type: issue
title: CeFi Canonical-Completeness — Final Execution Blueprint
summary: >-
  Full execution blueprint (code fixes, migration scripts, drain runbook, 19 open design questions, reviewer verdict)
  for making cefi tick data canonical across all four surfaces (GCS filename, parquet instrument_id column, manifest
  instrument_id key, reader resolution) by keying every surface off the instruments-service catalogue's
  (venue, instrument_type, raw_symbol) 3-tuple map. Execution ran to completion via the forked child plan
  `cefi_migration_cutover_and_track8_completion_2026_07_25.md` (archived, all 5 apply/verify todos closed, residual
  gap CLOSED 2026-07-28 with cited live-verified proof) — this document is the historical design record, not an
  in-flight plan.
status: resolved
nature: record
asset_group: [cefi]
stage: [data]
repos: [market-tick-data-service, instruments-service, features-service, market-data-processing-service]
scope: [engineer]
tags: [cefi, canonical, instrument-id, migration, blueprint, historical]
related:
  [
...
source: >-
  Original design blueprint, 2026-07-17. Renamed from `_cefi_canonical_blueprint_2026_07_17.md` (dropped the
  underscore-prefix, added missing frontmatter — the doc predated the current schema) and archived 2026-08-19 after
  confirming 0 open todos: its sole todo is [x] resolved-by-reference to the completed forked plan, and §4's 19
  "OPEN QUESTIONS" are the original 2026-07-17 design questions, not live tracked work — they were resolved during
  the actual execution documented in the forked plan.
assigned_vm: NA
execution_scope: local-only
priority: P3
estimate_class: research
resolved_by: cefi_migration_cutover_and_track8_completion_2026_07_25 (archived, all 5 apply/verify todos closed,
  residual gap CLOSED 2026-07-28 with cited live-verified proof)
locked_by:
locked_since:
...
> **📦 ARCHIVED 2026-08-19** — renamed from `_cefi_canonical_blueprint_2026_07_17.md` and given a `parent_epic` at the
> operator's request (was previously a pre-schema doc with no frontmatter at all). 0 open todos; execution completed
> via the forked child plan cited below. Kept as historical design record.
