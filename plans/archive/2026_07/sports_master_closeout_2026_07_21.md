...
> **ARCHIVED 2026-07-24.** This doc is no longer in `plans/active/` — operator ruling: fold this doc's 6 open todos into
> the canonical `/plans/active/sports_consolidated_closeout_2026_07_19.md` (the 19th, the single live sports execution
> surface) and archive this one entirely. Its 6 open todos moved verbatim (or were folded into an existing equivalent
> todo where one already existed) into that doc — see its Track C / Track S / Track X sections and the "Operator
> decisions — ANSWERED 2026-07-20" section. Everything else below (the 2020-06 data-floor ruling narrative, the
> landmine-contradiction resolution history, the themed issue-doc catalogue, the floor-enforcement-surface checklist,
> the coverage-gaps/risks list, the MOOT-AFTER-WIPE triage, the `/autonomous` prompt template, and the Progress Log) is
> preserved here verbatim as historical/reference record — nothing was deleted. The codex SSOT for the 2020-06 floor
> ruling itself is `/codex/02-data/sports-2020-06-data-floor.md`.
...
- [x] [DATA] P0. ✅ **Pre-floor GCS WIPE DONE + VERIFIED (2026-07-21).** `deployment-service@78a0aa4`
      ...
      **MANIFEST prune = separate deferred task** (see below): index has an ACTIVE consolidator lock + is rebuilt from
      ...
      `/plans/archive/issues/sports_legacy_duplicate_triage_2026_07_22.md` §2 — pruning this manifest set resolves that
