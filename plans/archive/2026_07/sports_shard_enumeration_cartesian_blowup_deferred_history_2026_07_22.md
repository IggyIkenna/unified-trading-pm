...
| **4.5** — issue-doc corrections (strike the false "no per-(venue,league) coverage declaration" line; fix the reason-split figures to the measured `606,772 / 459,459 / 200,864 / 94,127 / 385,402` values)             | ✅ DONE 2026-07-27 — `unified-trading-pm@836202a79`                           | N/A — struck the false claim inline at the parent doc's "Why it is wrong" bullet 5 (matching its existing correction-banner convention) and condensed the §4.5 section itself to a done-state; the reason-split figures were already correctly cited as wrong in §4.5's own text, no live mis-citation found elsewhere in the doc.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
