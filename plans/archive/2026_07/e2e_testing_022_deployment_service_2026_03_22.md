...
> — tracked as a new gap in `plans/archive/2026_07/e2e_coverage_gaps_alerting_deployment_trading_agent_2026_07_27.md`
> (archived 2026-07-30, all 3 todos done — a real harness now exists, see that doc).
