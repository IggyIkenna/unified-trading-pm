...
> **🟢 ARCHIVED 2026-07-27** — completed decision record kept for provenance; Appendix-4 open items are an explicit
> reference checklist, not dispatch todos. Verified via fresh /ag-closeout-audit classification pass.
