...
- [x] [DATA] P0. **Understat history → zero-missing** 2014→present for the 5 native leagues; non-native leagues in the
      ...
      `plans/archive/issues/manifest_atexit_drain_races_asyncio_shutdown_2026_07_09.md` (both filed with follow-up todos
...
(`plans/archive/issues/manifest_record_expected_empty_blank_source_2026_07_08.md`) re-verification todo raised by
...
**Filed** `plans/archive/issues/manifest_record_expected_empty_blank_source_2026_07_08.md` (P0) — the other 14 callsites
...
`plans/archive/issues/manifest_atexit_drain_races_asyncio_shutdown_2026_07_09.md` (the atexit/asyncio race, unfixed at
