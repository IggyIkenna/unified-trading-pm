...
- [x] [DOC] P2. ✅ Verify `sports-data-source-coverage-matrix.md`'s body isn't stale-under-banner (check every claim
      ...
      link in `/plans/archive/2026_07/active_plan_inventory_dashboard_2026_07_24.md` (confirmed pre-existing on a clean
      tree before fixing) — someone else regenerated it concurrently with the identical fix, no separate commit needed
      from me.
