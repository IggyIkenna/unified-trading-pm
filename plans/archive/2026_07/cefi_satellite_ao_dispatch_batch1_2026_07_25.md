...
- [x] ✅ [PM] P1. **DONE 2026-07-27 (slot 5)** — Verified + archived
      ...
      checkbox + 5 stale corpus referrers (old `active/issues/` path) hadn't been fixed:
...
- **2026-07-30 (slot-11, `data_engineering`, `cefi_satellite_ao_dispatch_batch1_finalize_2026_07_25.md` todo 4 —
  ...
  literal `plans/active/...` path) repointed to the new archive location in the same commit.
