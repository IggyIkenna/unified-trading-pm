...
| DeFi     | Non-canonical path: `day/venue=AAVEV3-ETHEREUM/ticks.parquet` — chain embedded in venue, no `instrument_type` or `data_type` partitions, everything bundled.                                                                                                                                                                                |
...
- [ ] [AGENT] P0. New script `migrate_defi_canonical.py`:
  ...
  2. Parse venue (`AAVEV3-ETHEREUM` → venue=`AAVE_V3`, chain=`ETHEREUM`)
