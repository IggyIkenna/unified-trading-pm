...
todos:
  - id: p3-1-execution-order-mutation
    content: |
      - [x] [AGENT] P0. Added order mutation endpoints to unified-trading-api:
  ...
  - id: p3-2-sports-execution-endpoints
    content: |
      - [x] [AGENT] P0. Sports bet endpoints verified — all 3 already existed in execution.py:
  ...
  - id: p3-3-defi-execution-endpoints
    content: |
      - [x] [AGENT] P0. DeFi execute endpoint verified — already existed:
  ...
  - id: p3-4-analytics-gap-fill
    content: |
      - [x] [AGENT] P1. Analytics routes verified + 1 added:
  ...
  - id: p3-5-risk-gap-fill
    content: |
      - [x] [AGENT] P1. Risk routes verified + enhanced:
  ...
  - id: p3-6-strategy-all-37
    content: |
      - [x] [AGENT] P0. Verified all strategies accessible:
  ...
  - id: p3-7-ml-monitoring-governance
    content: |
      - [x] [AGENT] P1. Added 3 ML endpoints to ml.py:
  ...
  - id: p3-8-response-pagination-wrapper
    content: |
      - [x] [AGENT] P0. Standardised ALL endpoint responses across unified-trading-api:
  ...
  - id: p3-9-instrument-registry-endpoint
    content: |
      - [x] [AGENT] P1. Enhanced `/instruments/registry`:
  ...
  - id: p3-10-config-endpoints
    content: |
      - [x] [AGENT] P2. Added 4 config endpoints to config.py:
  ...
  - id: p3-11-position-update-flow
    content: |
      - [x] [AGENT] P0. Position update flow verified — already working:
