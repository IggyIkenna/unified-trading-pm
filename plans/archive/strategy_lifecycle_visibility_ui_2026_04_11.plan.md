...
overview: Strategy lifecycle enforcement, paper trading comparison, ML dashboard, feature lineage, composable strategies, auto-retuning, research shell, risk attribution UI
type: code
