...
- Does not record _which specific spec_ a code file was built against
...
_For questions or to propose changes to this design, update this doc and bump `doc_version`._
