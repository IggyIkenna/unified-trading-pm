---
name: plan-readiness-gates-overhaul
overview:
  Introduce 3-tier readiness gates (Code/Deployment/Business) into every plan; add ai/ vs active/ split; propagate rules
  to all agent contexts
type: infra
epic: none
status: active
...
todos:
  - id: phase-0-self-register
    content: Create this plan file in active/
    status: done
  ...
  - id: phase-1b-ai-readme
    content: Create unified-trading-pm/plans/ai/README.md (explain ai/ vs active/)
    status: in_progress
    note: ""
