...
related: []
created: '2026-04-17'
overview: Wire all standalone backtest engines into the unified pipeline. Batch=live same code path — strategy interacts with execution-service (matching engine), position-balance-monitor, risk-and-exposure, pnl-attribution in BOTH modes. Delete inline settlement. Covers sports (backtest_engine.py, sports_backtest_runner.py) and DeFi (colocated_engine.py).
type: code
