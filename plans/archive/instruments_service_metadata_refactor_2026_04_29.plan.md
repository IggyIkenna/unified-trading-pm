...
related: []
created: '2026-04-29'
overview: Extend InstrumentRecord with optional DeFi metadata fields, populate them in instruments-service adapters, refactor MTDS DeFi handlers to consume instruments-store-defi parquets instead of re-querying The Graph subgraphs each cycle.
type: code
