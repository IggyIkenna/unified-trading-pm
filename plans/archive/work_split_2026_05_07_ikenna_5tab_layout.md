...
- [`/codex/15-runbooks/alerting/alert-code-taxonomy.md`](/codex/15-runbooks/alerting/alert-code-taxonomy.md) (codex SSOT
  expects the StrEnum to land at the spec'd location)
