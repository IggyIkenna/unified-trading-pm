...
| Count | Type | Location |
|-------|------|----------|
| **~25** | Production code | `unified-cloud-services/` (config.py, client_factory.py, market_category.py, gcp_clients.py, secret_manager.py, dependency_checker.py, gcsfuse_helper.py, cloud_data_provider.py) |
...
| unified-cloud-services | ❌ Missing |
| unified-domain-services | ❌ Missing |
| unified-feature-calculator-library | ❌ Missing |
| unified-trading-codex | ❌ Missing |
| unified-trading-pm | ❌ Missing |
| **31 others** | ✅ Has |
...
| ❌ Missing (expected) | 17 | UIs (React/Vue), api-contracts, matching-engine-library, unified-defi-execution-interface, unified-domain-services, unified-feature-calculator-library, unified-trading-codex, unified-trading-pm |
...
| unified-cloud-services | 632 | 739 | 85.5% |
...
|----------|------|------|-------|
| Config: no os.getenv in production | 0 | 2 | unified-cloud-services, market-tick-data-handler |
...
2. **Replace os.getenv in production code**
   - `unified-cloud-services`: config.py, client_factory.py, market_category.py, gcp_clients.py, secret_manager.py, dependency_checker.py, gcsfuse_helper.py, cloud_data_provider.py
...
3. **Add LICENSE to 9 repos**
   - alerting-system, api-contracts, execution-services, unified-cloud-services, unified-domain-services, unified-feature-calculator-library, unified-trading-codex, unified-trading-pm
