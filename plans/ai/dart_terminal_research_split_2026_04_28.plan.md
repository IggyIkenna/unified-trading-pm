...
- [x] [HUMAN] P0. Codex SSOT written at `/codex/14-customer-journeys/dart/dart-terminal-vs-research.md` — full route
      inventory, tile ownership, persona × tile × view matrix, instrument-type derivation chain, FOMO mode behavior.
      Sourced from actual code, not 2026-03-21 wishlist.
...
- SSOT codex doc: `/codex/14-customer-journeys/dart/dart-terminal-vs-research.md`
