...
amended: 2026-04-22
depends_on:
  - /codex/16-strategy-playbooks/infra-spec/stage-3e-refactor-plan.md §2.11
...
- **Codex:** `/codex/14-customer-journeys/demo-ops/account-intelligence-record.md`,
  `/codex/14-customer-journeys/_ssot-rules/09-internal-commercial-oneliners.md`

## Mandatory read-set

1. `/codex/16-strategy-playbooks/infra-spec/stage-3e-refactor-plan.md` §2.11
2. `/codex/14-customer-journeys/demo-ops/account-intelligence-record.md`
3. `/codex/14-customer-journeys/_ssot-rules/09-internal-commercial-oneliners.md`
4. `/codex/14-customer-journeys/_ssot-rules/06-show-dont-show-discipline.md` — §Enforcement #5
...
ls /codex/14-customer-journeys/demo-ops/account-intelligence-record.md
```
