...
> **Canonical playbook SSOT**: see [codex/14-playbooks/](/codex/14-customer-journeys/README.md) for the playbook
> families, environments, and auth tiers this plan integrates with. Ticket #12 (staging Firebase) and ticket #4
> (/briefings hub) are referenced from
> [/codex/14-customer-journeys/roadmap/next-waves.md](/codex/14-customer-journeys/roadmap/next-waves.md).
