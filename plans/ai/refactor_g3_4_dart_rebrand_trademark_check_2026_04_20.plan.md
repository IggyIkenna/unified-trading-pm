...
depends_on:
  - /codex/16-strategy-playbooks/infra-spec/stage-3e-refactor-plan.md §3.4
...
- **Codex:** `/codex/14-customer-journeys/experience/marketing-journey.md`
- **Memory:** 2026-04-19 DART naming + HSBC non-competing note

## Mandatory read-set

1. `/codex/16-strategy-playbooks/infra-spec/stage-3e-refactor-plan.md` §3.4
2. `/codex/14-customer-journeys/experience/marketing-journey.md`
...
- `/codex/14-customer-journeys/experience/marketing-journey.md` — MODIFY (DART framing)
