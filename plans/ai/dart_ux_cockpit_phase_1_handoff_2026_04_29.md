...
2. `unified-trading-pm/plans/ai/dart_ux_cockpit_executing_agent_prompt_2026_04_29.md` (the broader 9-phase brief, with
   the 5 per-phase test gates and 23 agent guardrails)
3. `unified-trading-pm/plans/archive/dart_ux_cockpit_refactor_2026_04_29.plan.md` (the canonical plan-of-record — read
   §0 → §26 in full)
