...
| **unified-cloud-services** | Expose `InstrumentsDomainClient.get_aggregated_instruments(category)` — reads latest `aggregated/aggregated_instruments_*.parquet` |
...
Current violations:
- ❌ 4 corporate actions handlers import `unified_cloud_services` inside functions
