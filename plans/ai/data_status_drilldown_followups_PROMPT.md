...
- `unified-trading-pm/plans/archive/manifest_429_per_vm_sharding_2026_04_25.plan.md` — parent for F + G + H + I. Read
  the pre-audit manifest of writer/reader call sites before touching G.
