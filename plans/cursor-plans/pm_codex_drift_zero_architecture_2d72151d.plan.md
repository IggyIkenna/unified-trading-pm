...
2. **Codex** reflects the architecture *after* plans are implemented. It cannot merge to main without incorporating the latest PM and active plans. It has no contradicting statements. Services implement against Codex, not raw plans.
