...
Classify the 28 unresolved issue docs under `plans/archive/issues/` against the mega-audit framework in
...
Walk the 24 archived plans listed. For each open DEFERRED item: identify successor in `plans/archive/2026_08/`, add
