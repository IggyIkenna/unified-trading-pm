...
| `(template placeholder — not a real file)`                                              | FALSE-POSITIVE   | `plans/active/issues/strategy_archetype_logic_audit_2026_05_20.md`                                                             | Template placeholder in issues doc, not a real path. No action needed.                                                             |
