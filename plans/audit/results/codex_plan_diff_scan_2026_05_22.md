...
| `codex/04-architecture/allocator-pipeline-contract.md`       | CODEX-MISSING P1 | `plans/active/issues/strategy_archetype_logic_audit_2026_05_20.md`                                                             | Codex stub needed: allocator pipeline contract spec                                                                                |
| `codex/04-architecture/instrument-type-leverage-matrix.md`   | CODEX-MISSING P1 | `plans/active/issues/strategy_archetype_logic_audit_2026_05_20.md`                                                             | Codex stub needed: instrument type × leverage matrix                                                                               |
| `codex/04-architecture/strategy-execution-runtime.md`        | CODEX-MISSING P1 | `plans/active/issues/strategy_archetype_logic_audit_2026_05_20.md`                                                             | Codex stub needed: strategy→execution runtime contract                                                                             |
| `codex/04-architecture/treasury-trading-wallet-invariant.md` | CODEX-MISSING P1 | `plans/active/issues/strategy_archetype_logic_audit_2026_05_20.md`                                                             | Codex stub needed: treasury / trading wallet invariant                                                                             |
| `codex/04-architecture/universe-enumeration-contract.md`     | CODEX-MISSING P1 | `plans/active/issues/strategy_archetype_logic_audit_2026_05_20.md`                                                             | Codex stub needed: universe enumeration contract                                                                                   |
...
## After-Counts (to be updated at Phase 4)

| Category                          | Before | After | Delta |
| --------------------------------- | ------ | ----- | ----- |
| BROKEN-REF (real)                 | 5      | TBD   | —     |
| SUPERSEDED-with-dead-forward-link | ~6     | TBD   | —     |
| CODEX-MISSING stubs written       | 0      | TBD   | —     |
| Delta boxes added                 | 0      | TBD   | —     |
| "post-May-23" markers resolved    | 0/12   | TBD   | —     |
| Open P0 findings                  | TBD    | TBD   | —     |
