...
created: 2026-06-18
audited_scope:
  every SERVICE repo's scripts/ (~820 .py+.sh across 21 repos, excludes unified-trading-pm) — per-script lifecycle
  classification (KEEP-PERMANENT/KEEP-ONEOFF/DELETE/DEPRECATE/PROMOTE-TO-CLI) + cloud-discipline red-flag grep +
  dead-checker sweep
date: 2026-06-18
