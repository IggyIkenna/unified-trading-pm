...
title: "Pipeline E2E Check — data_pipeline_e2e_check_mdps (2026-08-01)"
summary: "data_pipeline_e2e_check_mdps pipeline-e2e-check 2026-08-01: total=8 passed=0 failed=4 ambiguous=0 skipped=4"
status: fail
nature: record
asset_group: [sports]
stage: [data]
...
related: []
created: 2026-08-02
audited_scope: "data_pipeline_e2e_check_mdps real-VM force/skip/live pipeline check for day=2026-08-01, legs=force,skip"
date: 2026-08-02
...
run_date: 2026-08-01
generated_at: 2026-08-02T16:23:26.120935+00:00
---

# Pipeline E2E Check — data_pipeline_e2e_check_mdps (2026-08-01)

**Legs:** force, skip **Started:** 2026-08-02T16:14:11.542012+00:00 **Finished:** 2026-08-02T16:23:26.120719+00:00
...
| -------------------------------- | ----- | ------- | -------------- | ---- | ------- | -------- | ----------- | -------------------------------------------------------- |
| SPORTS:*:odds_horizon_bucket:15m | force | failed  | not_applicable | 1    | 0       | -        | not_checked | vm_not_success:vm_exit_nonzero=1                         |
| SPORTS:*:odds_horizon_bucket:1h  | force | failed  | not_applicable | 1    | 0       | -        | not_checked | vm_not_success:vm_exit_nonzero=1                         |
...
| SPORTS:*:odds_horizon_bucket:15m | skip  | skipped | genuine        | 1    | 0       | -        | not_checked | no_force_candle_object_to_fingerprint (honest-empty tf?) |
| SPORTS:*:odds_horizon_bucket:1h  | skip  | skipped | genuine        | 1    | 0       | -        | not_checked | no_force_candle_object_to_fingerprint (honest-empty tf?) |
| SPORTS:*:odds_horizon_bucket:4h  | skip  | skipped | genuine        | 1    | 0       | -        | not_checked | no_force_candle_object_to_fingerprint (honest-empty tf?) |
| SPORTS:*:odds_horizon_bucket:24h | skip  | skipped | genuine        | 1    | 0       | -        | not_checked | no_force_candle_object_to_fingerprint (honest-empty tf?) |
...
| SPORTS:*:odds_horizon_bucket:4h  | skip  | `market-data-tick-sports-test-central-element-323112` | `market-data-tick-sports-test-central-element-323112` | yes          |
| SPORTS:*:odds_horizon_bucket:24h | skip  | `market-data-tick-sports-test-central-element-323112` | `market-data-tick-sports-test-central-element-323112` | yes          |
