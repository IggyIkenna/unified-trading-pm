...
The mega-audit Phase A1 promised 10 checks; below are the ones where existing QG enforcement is partial or absent. These slot into the **Cross-cutting QG ratchet plan** referenced from the mega-audit tracker (no new SSOT — extend existing plan).
