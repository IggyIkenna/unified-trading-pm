...
summary:
  ...
  merge_pipeline_e2e_report.py): total=14 passed=0 failed=3 ambiguous=0 skipped=7"
status: fail
nature: record
asset_group: [cross-cutting, defi, prediction, tradfi]
stage: [data]
...
**Summary:** total=14 passed=0 failed=3 ambiguous=0 skipped=7
