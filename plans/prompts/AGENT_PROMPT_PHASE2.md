...
**Step A** — Deploy structure: verify `cloudbuild.yaml`, `quality-gates.sh`, `setup.sh`, `pyproject.toml`, `workspace-manifest.json` present and correct. Run `bash scripts/setup.sh --check`. No old names anywhere.
