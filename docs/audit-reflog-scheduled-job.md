...
**Ignore list (manual):** For repos you've verified but can't/won't recover (e.g. intentional discard), add to `audit-reflog-ignore.txt` (one per line). Reflog entries persist ~90 days; ignore is permanent until you remove it.
