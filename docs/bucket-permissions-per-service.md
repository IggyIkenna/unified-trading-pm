...
| **market-data-processing-service**   | `market-data-tick-{category}-{project_id}`, `instruments-store-{category}-{project_id}`                                                                                        | `market-data-tick-{category}-{project_id}` (processed_candles/ — candles co-located under MTDS; separate market-data-candles-\* buckets retired 2026-04-18) |
