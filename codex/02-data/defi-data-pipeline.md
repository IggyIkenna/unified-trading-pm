...
| `collect-perp-funding`                                                                                                                  | `perp_funding`                                                  | Hyperliquid (GMX REMOVED 2026-07-25 — synthetic OI-imbalance proxy, not real funding-rate data, see `/plans/archive/2026_07/defi_gmx_venue_removal_2026_07_25.md`; Drift removed 2026-07-16 -- operator ruling, all Solana perp DEXes dropped except Jupiter, not integrated; see `/codex/04-architecture/solana-defi-coverage.md`)                                                                                 |
...
| `perp_funding`      | DeFi-perp funding/mark               | `protocol, symbol, funding_rate(24h/7d/30d), oracle_px, mark_px, open_interest, oi_long/short`                                                               | Hyperliquid (GMX REMOVED 2026-07-25; Drift removed 2026-07-16) |
...
| DeFi perps         | Hyperliquid (own L1), Aster (GMX REMOVED 2026-07-25; Drift removed 2026-07-16, operator ruling)                                    | `perp_funding` (+ liquidations)                                                                                                     | `carry_staked_basis` hedge leg         |
