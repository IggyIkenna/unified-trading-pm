...
| defi   | GMX (REMOVED 2026-07-25) · perp_funding · perpetual                  | `GMX:PERPETUAL:BTC-USD`                                           | worked example of the DEX-pool perp → defi rule (**no chain suffix**); GMX itself is REMOVED, see `defi_gmx_venue_removal_2026_07_25.md` — pattern kept for any future DEX-pool perp venue |
...
- **DEX-pool-shaped perps → `asset_group=defi`**: traders trade against an AMM/liquidity pool, oracle-priced.
  ...
  2026-07-25 — see `defi_gmx_venue_removal_2026_07_25.md`; no DEX-pool-shaped perp venue is currently live, but the
  classification + id-shape rule is kept for any future venue.
