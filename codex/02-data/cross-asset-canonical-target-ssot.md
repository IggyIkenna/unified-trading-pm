...
| tradfi | ICE · ohlcv_24h · index (DXY)                                        | `ICE:INDEX:DXY-USD`                                               | Yahoo daily (`DX-Y.NYB`); added 2026-08-09, no canonical-id row existed before despite the instrument being registered since 2026-06-25                                                                           |
...
| defi   | GMX (REMOVED 2026-07-25) · perp_funding · perpetual                  | `GMX:PERPETUAL:BTC-USD`                                           | worked example of the DEX-pool perp → defi rule (**no chain suffix**); GMX itself is REMOVED, see `/plans/archive/2026_07/defi_gmx_venue_removal_2026_07_25.md` — pattern kept for any future DEX-pool perp venue |
