...
| DeFi       | `raw_tick_data/by_date/day=YYYY-MM-DD/venue=GMX/chain=ARBITRUM/instrument_type=perpetual/data_type=derivative_ticker/`                   | `(defi, perpetual, derivative_ticker)` (added 2026-07-15) | Canonical raw-funding home for defi-axis perps (GMX on defi axis, **GMX REMOVED 2026-07-25** — captured funding was a synthetic OI-imbalance proxy, not real data, operator ruling; DRIFT-SOLANA removed 2026-07-16, operator ruling); funding_rate + ts_event mandatory, open_interest/mark_price/index_price nullable (GMX's native subgraph query never returned a real OI field) — see `defi-data-types-catalog.md` §4a |
...
| `derivative_ticker` (defi-axis: GMX, added 2026-07-15; **GMX REMOVED 2026-07-25** — synthetic funding proxy, operator ruling; DRIFT-SOLANA removed 2026-07-16) | `market-data-tick-defi-*` | features-onchain raw | ❌ BYPASS |
