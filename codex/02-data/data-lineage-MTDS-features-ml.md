...
- Sports paths SSOT: UAC `unified_api_contracts.sports.gcs_paths` (`candidate_parquet_paths`, `SPORTS_DATA_TYPE_TO_FOLDER`, `SPORTS_DATA_TYPE_LAYOUT`); bucket layout: `per-asset-group-bucket-layouts.md` (sports section)
