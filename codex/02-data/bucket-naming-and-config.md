...
| `INSTRUMENTS_BUCKET_PREFIX_TRADFI`     | Instruments bucket prefix | `instruments-store-tradfi`     |
| `INSTRUMENTS_BUCKET_PREFIX_DEFI`       | Instruments bucket prefix | `instruments-store-defi`       |
| `INSTRUMENTS_BUCKET_PREFIX_SPORTS`     | Instruments bucket prefix | `instruments-store-sports`     |
| `INSTRUMENTS_BUCKET_PREFIX_PREDICTION` | Instruments bucket prefix | `instruments-store-prediction` |
