...
| **Shard key**       | venue × chain × date                                                                                                                                                                                                                                                                                                                                             |
| **Instrument type** | `perpetual`                                                                                                                                                                                                                                                                                                                                                      |
| **Status**          | Production (GMX/Drift/Hyperliquid/Aster/Pacifica/Extended/Lighter all wired). MANGO-SOLANA/ZETA-SOLANA/FLASH-SOLANA — DELETED 2026-07-15 (operator ruling): all 3 declared API hosts dead, ~$0 DeFiLlama TVL, zero MTDS capture ever wired (not derivative_ticker-specific — no adapter exists at all now). See `codex/04-architecture/solana-defi-coverage.md`. |
