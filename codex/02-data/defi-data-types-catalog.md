...
> see `defi_gmx_venue_removal_2026_07_25.md`; Drift removed 2026-07-16). Note: `dex_pool_state` is the **EVM + Solana
> union** (EVM `instrument_type=pool`; Solana `solana_amm_pool`/`solana_vault`) — discriminate by instrument_type +
> chain, NOT a separate data_type. Shipped: migration mtds@6a8372b2; writer/reader alignment uac@dad96e42 +
> mtds@0a3a7071 + features-service@dec1b687 + mdps@4b9e6e5. References below to `dex_pools`/ `dex_swaps` as the
> canonical data_type are SUPERSEDED by this banner.
...
| **Sources**         | 16 protocols total (`dex_pools_handler._DEFAULT_PROTOCOLS`, verified against code 2026-07-24; `gmx` REMOVED 2026-07-25, see `defi_gmx_venue_removal_2026_07_25.md`) — **EVM via The Graph** (12): `uniswap_v3`, `pancakeswap_v3`, `sushiswap_v3`, `aerodrome_v3`, `camelot_v3`, `balancer`, `curve`, `sushiswap`, `velodrome_v2`, `trader_joe_v2`, `uniswap_v4`, `uniswap_v2`; **Solana via `_collect_solana_dex`** (4, routed by `_solana_defi_fetch.SOLANA_DEX_PROTOCOLS`, bypassing the subgraph cascade): `kamino`→`SOLANA_VAULT`, `orca`/`raydium`/`phoenix`→`SOLANA_AMM_POOL`. (`solana_defi_handler.py`'s separate `collect-solana-defi` CLI command additionally writes `dex_pool_state` for `meteora`/`lifinity` — a DIFFERENT dispatch path, not part of this `_DEFAULT_PROTOCOLS` list.) |
| **Shard key**       | venue × chain × date                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Instrument type** | `spot_asset`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Status**          | Production                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Field               | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **CLI operation**   | `collect-perp-funding` (perp_funding_handler) — was GMX's operation, GMX REMOVED 2026-07-25 (see `defi_gmx_venue_removal_2026_07_25.md`); no venue currently writes via this operation. (`solana-defi` / `_collect_drift` for DRIFT-SOLANA removed 2026-07-16 -- operator ruling, all Solana perp DEXes dropped except Jupiter, not integrated.)                                                                                                                                                |
...
| **Status**          | No venue currently active — GMX (the sole `perp_funding` writer) REMOVED 2026-07-25, see `defi_gmx_venue_removal_2026_07_25.md`. Drift removed 2026-07-16 -- operator ruling, all Solana perp DEXes dropped except Jupiter, not integrated.                                                                                                                                                                                                                                                     |
...
| Field               | Value                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **CLI operation**   | UMI tick-provider batch-live (Hyperliquid/Aster/Extended-Starknet, native REST/S3) · Tardis (Lighter-ZKSYNC, `date >= 2026-04-17` only). (`collect-perp-funding` GMX dual-write REMOVED 2026-07-25, see `defi_gmx_venue_removal_2026_07_25.md`; Drift `solana-defi`/UMI batch-live + Pacifica-Solana removed 2026-07-16 -- operator ruling.)                                                                                     |
...
(GMX REMOVED 2026-07-25, see `defi_gmx_venue_removal_2026_07_25.md`), and Aster/Extended similarly omit it at this grain
(Drift/Pacifica removed 2026-07-16); only Hyperliquid (S3 archive) and Lighter (Tardis) genuinely have real OI.
`funding_rate` + `ts_event` are mandatory. No venue-specific raw-layer aggregation (that's what §4's `perp_funding`
divergence-removal above is about) — aggregation windows belong downstream in features, not in either raw capture
data_type. Full per-venue coverage-table evidence (file:line, verified 2026-07-15):
