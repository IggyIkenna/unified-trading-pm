...
- `/plans/active/issues/sports_phantom_audits_reference_not_marketdata_2026_07_14.md` and
  ...
  phantom auditor and, separately, `/data-pipeline-reconciliation`'s own governing codex
  (`four-surface-reconciliation-procedure.md` §4.2/§6) each independently conflated the two buckets before being
  corrected.
