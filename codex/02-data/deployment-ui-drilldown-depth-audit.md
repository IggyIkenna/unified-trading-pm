...
referenced_by:
  - plans/active/infrastructure_master_2026_05_07.plan.md
...
> as the drilldown alignment plan is executed.
...
- **Plan(s) implementing this:** [`infrastructure_master`](../../plans/active/infrastructure_master_2026_05_07.plan.md), [`data_status_drilldown_shard_atom_alignment`](../../plans/ai/data_status_drilldown_shard_atom_alignment_2026_05_07.plan.md).
- **Related codex SSOTs:** [`availability-manifest-and-data-status`](./availability-manifest-and-data-status.md), `shard-granularity-ssot` (TBD lift from CLAUDE.md).
...
- Do we surface partial-bundle status at the bundled-shard leaf? (e.g. options_chain ES.OPT shows 8/11 clusters captured)
