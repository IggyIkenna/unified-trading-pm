...
| readers       | ✅ layout-tolerant across the cutover (day-scoped listing matched on the venue-tail): `cloud_data_provider.py`, `instrument_lifecycle_loader.py`, `manifest_writer/*`, `options_cluster_lookup.py`, `tradfi_live.py`, and MTDS's `_instruments_metadata.py` (added 2026-08-13, found via blocked-question BLK-d59ebc8e — a 7th, cross-repo reader separately discovered broken and separately fixed: `market-tick-data-service@b94259a0` + `@cd8ce74e2`, 2026-07-26; this row previously omitted it, which would mislead a reader judging cutover completeness from this row alone).                                                                                                                                                                  |
