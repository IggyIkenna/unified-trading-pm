...
summary: Catalog of the 10 MTDS TradFi data types (ohlcv_1s/1m/15m/24h; tbbo/trades/mbp_10 DEFERRED;
...
| **Sources**         | Yahoo Finance via `yfinance_corporate_actions_adapter.py` (dividends/splits); the former Polygon.io/Massive adapter was removed 2026-08-20 under the fleet-wide vendor ban. |
...
| **Requires**        | None — Yahoo Finance adapter is keyless                                                                                                                                     |
...
| YFINANCE | corporate_action_confirmed | Production | Dividends/splits via `YFinanceCorporateActionsAdapter`; keyless Yahoo Finance source. |
...
| _(none — keyless)_  | corporate_action_confirmed (dividends/splits) + earnings_result (earnings actuals/estimates via yfinance) |
