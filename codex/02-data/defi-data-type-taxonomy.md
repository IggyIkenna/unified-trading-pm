...
REMOVED 2026-07-25 (see `/plans/archive/2026_07/defi_gmx_venue_removal_2026_07_25.md`); DRIFT-SOLANA was the other
defi-axis perp venue here until removed 2026-07-16, same ruling.
...
| -------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------ | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ~~GMX-ARBITRUM / GMX-AVALANCHE~~ | ~~defi~~ | ~~The Graph `fundingRateChangedEvents` (event-driven, dual-written alongside `perp_funding` from the SAME fetch)~~ | —                   | **REMOVED 2026-07-25** (synthetic OI-imbalance proxy, not real funding-rate data; see `/plans/archive/2026_07/defi_gmx_venue_removal_2026_07_25.md`). Native query had no OI field at all. |
