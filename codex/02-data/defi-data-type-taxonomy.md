...
| -------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `lending_indices`    | TheGraph subgraph (EVM) / Solana RPC (Kamino)                  | `(asset_group=defi, chain, venue, data_type, instrument_type=a_token/debt_token, instrument_id, day)` | per-day per-reserve min row count | symbol, ts_event, venue, chain, supply_apy, borrow_apy, utilization_rate, total_supply, total_borrow, liquidityIndex, variableBorrowIndex                                                               |
...
`venue=` is the bare canonical PROTOCOL (`AAVE_V3`, `UNISWAP_V3`, `GMX` — never `AAVEV3`/`AAVE`) and `chain=` is a
