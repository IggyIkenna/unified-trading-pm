...
| **issue**             | `parent_epic`, `priority`, `source`                                                                                                                         | `assigned_vm`, `resolved_by` (req when `resolved`), `locked_by`, `context_scope` (elective)                                                                                                                          | `open·blocked·resolved·false-positive·superseded`                                                                                                                                                                                                                                                                                                                                                                                             |
