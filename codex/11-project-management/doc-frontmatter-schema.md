...
| **issue**             | `parent_epic`, `priority`, `source`, `assigned_vm` (registry ∪ `NA`)                                                                                       | `resolved_by` (req when `resolved`), `locked_by`, `author` (elective — worker.md §4.5 HARD RULE; backfill P3 pending), `context_scope` (elective)                                                                    | `open·blocked·resolved·false-positive·superseded`                                                                                                                                                                                                                                                                                                                                                                                             |
