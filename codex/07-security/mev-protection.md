...
>
> **Canonical location**: [`codex/04-architecture/mev-protection.md`](../04-architecture/mev-protection.md).
>
...
> [`codex/09-strategy/architecture-v2/cross-cutting/mev-protection.md`](../09-strategy/architecture-v2/cross-cutting/mev-protection.md)
...
- **Per-chain RPC + MEV endpoint + Tenderly + gas oracle matrix** →
  [`05-infrastructure/chain-rpc-mev-tenderly.md`](../05-infrastructure/chain-rpc-mev-tenderly.md).
