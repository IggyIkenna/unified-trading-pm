...
| Manifest schema + gap registries | `unified_api_contracts/internal/architecture_v2/`        | UAC@6f31f59 — capability_manifest + sim/fund-structures/order-semantics/agent-capability (honest-empty); collateral BACKFILLED (UAC@2026-06-12, `collateral_registry.py`); fees BACKFILLED (UAC@2026-06-13, `fees_registry.py` — exchange+gas cited, broker/clearing/tier still honest-empty) |
