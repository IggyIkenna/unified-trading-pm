...
| Fund structure: pooled / SMA / prop? How many investors/pools now; planned migration (e.g. 2 pooled → 1 SMA next year)? | fund-administration subscription/redemption state machines; `architecture_v2.fund_structures.OFFERED_FUND_STRUCTURES` (POOLED + SMA cited; PROP honestly omitted — no documented external offering) | partial  |
