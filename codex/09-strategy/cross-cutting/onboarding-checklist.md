...
"strategy instance" is a `(strategy_id, client_id, config)` tuple — the atomic unit of execution in the system (see
[config-architecture.md](config-architecture.md) section 5).
