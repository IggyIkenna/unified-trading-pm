...
summary:
  "Pre-v2: typed StrategyInstruction bus (StrategyInstructionType enum) decoupling strategy intent from execution —
  execution-service decomposes each instruction into atomic steps via the instruction adapter."
status: superseded
nature: ssot
asset_group: [meta]
stage: [meta]
