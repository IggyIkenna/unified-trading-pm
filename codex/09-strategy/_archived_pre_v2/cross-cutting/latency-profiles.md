...
summary:
  "Pre-v2: per-archetype latency profiles (no global SLA) with 3-segment tick-to-signal/signal-to-order/order-to-fill
  budgets, venue baselines, and circuit-breaker thresholds."
status: superseded
nature: ssot
asset_group: [meta]
stage: [meta]
