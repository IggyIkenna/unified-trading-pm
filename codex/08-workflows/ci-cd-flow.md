...
>
> **In-flight refactor SSOT: `plans/active/cicd_mvp_ldr_to_main_pipeline_2026_06_30.md`** (it supersedes the WS-L
> complex pipeline plan family; full forensic history lives in its Progress Log + its `issues/` docs). This codex doc is
> the durable SSOT for the resulting model.
>
...
| In-flight MVP pipeline refactor    | `plans/active/cicd_mvp_ldr_to_main_pipeline_2026_06_30.md`                |
