...
summary:
  Operator runbook for satellite / no-signal SEV0 fallback (Garmin inReach Mini 2 over Iridium, webhook to
  alerting-service) plus backup-human rota when travelling; end-to-end test required before departure.
status: current
nature: process
asset_group: [meta]
stage: [meta]
...
tags: [runbook, alerting, incident, on-call, escalation, satellite]
...
last_executed: never
code_refs:
authoritative_for: [RB-ALERT-003 operator runbook]
referenced_by:
  [
