...
summary:
  Operator runbook for internal messaging lag (Pub/Sub / Kafka / Redis) exceeding the dependency_health_policy threshold
  — scale consumers / replay DLQ / fail over; live-trading topics blocked escalates SEV1 → SEV0.
status: current
nature: process
asset_group: [meta]
stage: [meta]
