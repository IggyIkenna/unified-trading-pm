...
portal sliced to match. See [cross-cutting/visibility-slicing.md](../playbook-concepts/visibility-slicing.md) for the
full mechanism.
...
- [../cross-cutting/visibility-slicing.md](../playbook-concepts/visibility-slicing.md) — what sliced entitlements look
  like in the UI
