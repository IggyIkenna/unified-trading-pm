...
| **GMX**                             | CARRY_BASIS_PERP only (no LST collateral)                                                                         | $3,000              | +$0                                                      | DEX perp; needs different adapter pattern (GMX removed 2026-07-25 — see `plans/active/defi_gmx_venue_removal_2026_07_25.md`; no longer offered) |
