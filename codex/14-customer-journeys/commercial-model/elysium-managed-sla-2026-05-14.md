...
- **Strategy families NEVER in scope for Elysium** (e.g. ARBITRAGE*\*, MARKET_MAKING*_, ML*DIRECTIONAL*_, EVENT*DRIVEN,
  VOL_TRADING_OPTIONS, STAT_ARB*_, RULES*DIRECTIONAL*_, LIQUIDATION*CAPTURE, DEFI_LP*\*) — operating these is unaffected
  by Art. 6.2 because they fall outside the strategy types described.
