...
1. **[backfill-completion-playbook.md](../../15-runbooks/backfill-completion-playbook.md)** — operational SSOT. Cutoffs,
   MVP target, bundling/schema invariants, special cases (VIX, sports odds-API), credentials policy, known gotchas.
