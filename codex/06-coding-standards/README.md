...
| Forbidden code patterns                                                            | See TL;DR above (banned patterns) + [adapter-dead-code-and-fallback-ban.md](adapter-dead-code-and-fallback-ban.md) for the adapter-specific dead-code/fallback/duplicate-implementation rule (was a broken link to non-existent `STANDARDS.md`, fixed 2026-07-24) |
