...
summary: >-
  ...
  `ApiKeyReloader` key hot-reload (incl. per-wallet custody rebuild on `signing_surface` flip),
  `StrategyDirectiveReloader`, and the QG-enforced STEP 5.61 `ServiceBootstrap` / 5.62 `make_health_router` / UAC
