...
| **Cloud-agnostic**      | `05-infrastructure/cloud-agnostic-migration.md`               | Use `get_storage_client()`, `get_secret_client()` abstractions, never `from google.cloud import storage`                        | BASE-30, INF-02                   |
