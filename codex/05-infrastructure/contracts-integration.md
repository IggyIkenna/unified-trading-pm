...
**Active repos contribute cassettes to AC’s `mocks/` via PR** so one canonical location is used for replay and by all
consumers. **SSOT:** [02-data/vcr-cassette-ownership.md](../02-data/vcr-cassette-ownership.md).
