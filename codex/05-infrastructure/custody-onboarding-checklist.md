...
- [ ] **B.2.1** Create CMK per asset_group via Terraform or
      `aws kms create-key --description "trading-${ag}-master-v1" --key-usage ENCRYPT_DECRYPT --customer-master-key-spec     SYMMETRIC_DEFAULT --origin AWS_CLOUDHSM --region ap-northeast-1`.
