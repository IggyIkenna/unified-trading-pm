...
step 3. The parent dir was renamed to `14-customer-journeys/` and split into three: `14-customer-journeys/` (audience
flows), `15-runbooks/` (on-call runbooks), `16-strategy-playbooks/` (this dir, domain strategy + infra playbooks).
