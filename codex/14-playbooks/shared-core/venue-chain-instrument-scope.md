...
Authoritative list in [`../../02-venues/`](../../02-venues/). Not re-listed here (would drift). Experience playbooks
reference the venues that appear in the prospect's declared scope; not every venue appears in every demo.
