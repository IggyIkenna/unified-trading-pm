...
| 04  | `04-architecture/`       | Architecture       | System architecture: tier diagram, service topology, ADRs for cross-cutting decisions                                                                              | New architectural pattern or cross-cutting decision | TIER-ARCHITECTURE.md, ADRs                                              |
...
| 14  | _(deleted 2026-03-03)_   | Testing Guides     | **Deleted.** Content relocated: 7-layer pipeline → `04-architecture/pipeline-service-layers.md` (Mermaid source); CLI reference → `deployment-service/docs/cli.md` | —                                                   | —                                                                       |
