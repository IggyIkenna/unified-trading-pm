...
| `notify_spawn_recovered` / `notify_slot_recovered` / `notify_git_staleness_resolved` / `notify_escalation_resolved` / `notify_agent_stuck_respawned`                                                                                                                                                                                                                                                                                           | summary                   | recovery/closure bookends                                                   |
