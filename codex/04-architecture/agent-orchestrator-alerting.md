...
- `notify_slot_recovered`, `notify_spawn_recovered`, `notify_escalation_resolved` — recovery/closure bookends (a
  dispatched CI/CD wall confirmed clear: PR merged/superseded or `quality-gates-v2` green).
...
| `notify_spawn_recovered` / `notify_slot_recovered` / `notify_escalation_resolved` / `notify_agent_stuck_respawned`                                                                                                                                                                                                                                                                                                | summary                   | recovery/closure bookends                                                                                                                                                                  |
...
| `notify_git_staleness_red`                                                                                                                                                                                                                                                                                                                                                                                        | **PAGE**                  | repo red ≥30 min sustained (operator 2026-07-14; state-transition dedup: once per episode, 4h re-remind)                                                                                   |
| `notify_git_staleness_resolved`                                                                                                                                                                                                                                                                                                                                                                                   | **PAGE**                  | closes the RED page in-channel with the episode summary (operator 2026-07-14)                                                                                                              |
