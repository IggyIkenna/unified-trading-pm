...
| ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| **instruments-service** (reference data — formerly URDI, **Retired 2026 — merged into instruments-service**)           | Connectivity to venue APIs. Auth management. Calling `normalize_*()` from UAC. Returning `InstrumentRecord`.                                   | Domain data storage. Scheduling. Venue schemas (those are in UAC).                                                                         |
...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| **instruments-service**            | Calls reference-data adapters (formerly URDI/USRI, now in-service) to discover instruments for a date. Joins reference data (fixtures) with market instruments. Validates. | Instruments via DataSink (Parquet, by venue/date). |
