...
#
# NOTE: Run this standalone when you want to sync workspace rules into the PM repo.
# This is NOT called automatically by quickmerge.
#
# What it does:
...
# Show what changed
echo ""
echo "${BOLD}Changes staged for commit:${NC}"
cd "$PM_ROOT"
