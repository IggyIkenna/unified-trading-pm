...
#   sudo bash scripts/orchestrator/install_qg_baseline_daily_promote.sh --uninstall
#
...
SERVICE_NAME="qg-baseline-daily-promote"
...
echo "Installing ${SERVICE_NAME} systemd timer (daily, 03:11 UTC)..."
