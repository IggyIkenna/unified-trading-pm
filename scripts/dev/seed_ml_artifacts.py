...
STRATEGIES: list[dict[str, object]] = [
    {
        ...
        "features": ["return_1", "return_5", "rsi_14", "realised_vol_20", "bb_bandwidth", "is_us_market_hours"],
    ...
    },
    {
        ...
        "features": ["return_1", "rsi_14", "bb_bandwidth", "realised_vol_20", "day_of_week", "is_us_market_hours"],
        "n_classes": 3,
