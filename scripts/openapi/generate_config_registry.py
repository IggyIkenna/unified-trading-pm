...
CONFIG_REGISTRY: list[tuple[str, str, str]] = [
    ...
    ("unified-config-interface", "unified_trading_library.config_interface.cloud_config", "UnifiedCloudConfig"),
    ("unified-config-interface", "unified_trading_library.config_interface.base_config", "BaseConfig"),
    ("unified-config-interface", "unified_trading_library.config_interface.ml_config", "MLTrainingConfig"),
    ("unified-config-interface", "unified_trading_library.config_interface.domain_configs", "InstrumentDomainConfig"),
    ("unified-config-interface", "unified_trading_library.config_interface.domain_configs", "StrategyDomainConfig"),
    ("unified-config-interface", "unified_trading_library.config_interface.domain_configs", "ClientDomainConfig"),
    ("unified-config-interface", "unified_trading_library.config_interface.domain_configs", "VenueDomainConfig"),
    (
        "unified-config-interface",
        "unified_trading_library.config_interface.domain_configs",
        "StrategyRiskSubscriptionConfig",
    ),
    ("unified-config-interface", "unified_trading_library.config_interface.domain_configs", "CustomRiskScenarioConfig"),
