...
CONFIG_REGISTRY: list[tuple[str, str, str]] = [
    ...
    ("unified-trading-library (config_interface/)", "unified_trading_library.config_interface.cloud_config", "UnifiedCloudConfig"),
    ("unified-trading-library (config_interface/)", "unified_trading_library.config_interface.base_config", "BaseConfig"),
    ("unified-trading-library (config_interface/)", "unified_trading_library.config_interface.ml_config", "MLTrainingConfig"),
    ("unified-trading-library (config_interface/)", "unified_trading_library.config_interface.domain_configs", "InstrumentDomainConfig"),
    ("unified-trading-library (config_interface/)", "unified_trading_library.config_interface.domain_configs", "StrategyDomainConfig"),
    ("unified-trading-library (config_interface/)", "unified_trading_library.config_interface.domain_configs", "ClientDomainConfig"),
    ("unified-trading-library (config_interface/)", "unified_trading_library.config_interface.domain_configs", "VenueDomainConfig"),
    (
    ...
    ("unified-trading-library (config_interface/)", "unified_trading_library.config_interface.domain_configs", "CustomRiskScenarioConfig"),
