...
DESCRIPTIONS: dict[str, str] = {
    ...
    "strategy-validation-service": "Strategy T+1 backtest vs live reconciliation",
    ...
    "market-data-api": "Market data API — FastAPI + OAuth; proxies market-data-processing-service",
    ...
    "features-multi-timeframe-service": "Multi-timeframe feature service — tf_momentum | tf_structure | tf_vol | tf_session",
}
