...
# Sets branch protection on all service/api repos requiring the "agent-audit"
# status check to pass before merge, and enables auto-merge.
#
# Usage:
#   bash scripts/repo-management/set-branch-protection.sh [--dry-run]
#
