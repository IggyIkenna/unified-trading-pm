...
#
# CLAUDE.md + AGENTS.md: these are committed relative symlinks in each repo
#   (via rollout-agent-symlinks.sh) — no action needed here, already resolved.
echo ""
...
echo "Ephemeral cursor rules cleaned up"
CLEANUP
