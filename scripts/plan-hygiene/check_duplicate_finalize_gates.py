...
def main(argv: list[str] | None = None) -> int:
    ...
    pm_root = Path(__file__).resolve().parents[2] if pm_root is None else pm_root.resolve()
    ...
    print(f"❌ Duplicate finalize-plan gate(s) found — {len(duplicates)} parent slug(s) gated by >1 plan:")
