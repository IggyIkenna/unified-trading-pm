...
# corrupted into `unified-trading-/codex/09-strategy/...` (confirmed incident, plan_health
# gate remediation 2026-07-28: fixed 2 files this way before the bug was caught).
