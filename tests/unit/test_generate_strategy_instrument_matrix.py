...
class TestInstrumentFormat:
    def test_valid_formats(self) -> None:
        ...
        assert MOD.validate_instrument_format("AAVE_V3_ETHEREUM:A_TOKEN:AUSDT@ETHEREUM") is True
...
class TestInstrumentParsing:
    def test_extract_venue(self) -> None:
        ...
        assert MOD.extract_instrument_venue("AAVE_V3_ETHEREUM:A_TOKEN:AUSDT") == "AAVE_V3_ETHEREUM"
