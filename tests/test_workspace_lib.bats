...
# NOTE: count_rules_local, count_rules_repo, get_last_sync, update_last_sync
# were removed when rules switched from copy-based sync to symlinks.
# See _workspace-lib.sh and setup-cursor-rules-symlink.sh.
